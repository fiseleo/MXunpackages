...
public struct TacticEntityEffectFilterExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.TacticEntityEffectFilterExcel> CreateTacticEntityEffectFilterExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.TacticEntityEffectFilterExcel> EndTacticEntityEffectFilterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TacticEntityEffectFilterExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TacticEntityEffectFilterExcel> Pack(FlatBufferBuilder builder, TacticEntityEffectFilterExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TacticEntityEffectFilterExcel>);
