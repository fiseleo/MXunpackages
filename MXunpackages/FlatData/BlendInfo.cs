...
public struct BlendInfo : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BlendInfo> CreateBlendInfo(FlatBufferBuilder builder,
      int From = 0,
      int To = 0,
      float Blend = 0.0f) {
  ...
  public static Offset<Plana.FlatData.BlendInfo> EndBlendInfo(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BlendInfo>(o);
  }
  ...
  public void UnPackTo(BlendInfoT _o) {
        byte[] key = TableEncryptionService.CreateKey("BlendInfoT");
  ...
  public static Offset<Plana.FlatData.BlendInfo> Pack(FlatBufferBuilder builder, BlendInfoT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BlendInfo>);
