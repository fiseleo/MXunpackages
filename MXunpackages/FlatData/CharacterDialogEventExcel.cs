...
public struct CharacterDialogEventExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CVCollectionType CVCollectionType { get { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CVCollectionType.CVNormal; } }
  public Plana.FlatData.CVUnlockScenarioType CVUnlockScenarioType { get { int o = __p.__offset(42); return o != 0 ? (Plana.FlatData.CVUnlockScenarioType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CVUnlockScenarioType.Main; } }
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, Plana.FlatData.CVCollectionType cVCollectionType) { builder.AddInt(18, (int)cVCollectionType, 0); }
  public static void AddCVUnlockScenarioType(FlatBufferBuilder builder, Plana.FlatData.CVUnlockScenarioType cVUnlockScenarioType) { builder.AddInt(19, (int)cVUnlockScenarioType, 0); }
...
static public class CharacterDialogEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 40 /*CVCollectionType*/, 4 /*Plana.FlatData.CVCollectionType*/, 4, false)
      && verifier.VerifyField(tablePos, 42 /*CVUnlockScenarioType*/, 4 /*Plana.FlatData.CVUnlockScenarioType*/, 4, false)
