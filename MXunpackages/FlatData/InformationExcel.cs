...
public struct InformationExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.InformationExcel> CreateInformationExcel(FlatBufferBuilder builder,
      long GroupID = 0,
  ...
  public static Offset<Plana.FlatData.InformationExcel> EndInformationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.InformationExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.InformationExcel> Pack(FlatBufferBuilder builder, InformationExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.InformationExcel>);
