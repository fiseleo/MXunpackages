...
public struct EventContentCurrencyItemExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentItemType EventContentItemType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EventContentItemType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentItemType.EventPoint; } }
  ...
  public static Offset<Plana.FlatData.EventContentCurrencyItemExcel> CreateEventContentCurrencyItemExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.EventContentItemType EventContentItemType = Plana.FlatData.EventContentItemType.EventPoint,
      long ItemUniqueId = 0) {
  ...
  public static void AddEventContentItemType(FlatBufferBuilder builder, Plana.FlatData.EventContentItemType eventContentItemType) { builder.AddInt(1, (int)eventContentItemType, 0); }
...
public class EventContentCurrencyItemExcelT
{
  ...
  public Plana.FlatData.EventContentItemType EventContentItemType { get; set; }
  public long ItemUniqueId { get; set; }

  public EventContentCurrencyItemExcelT() {
    this.EventContentId = 0;
    this.EventContentItemType = Plana.FlatData.EventContentItemType.EventPoint;
    this.ItemUniqueId = 0;
  }
}
...
static public class EventContentCurrencyItemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EventContentItemType*/, 4 /*Plana.FlatData.EventContentItemType*/, 4, false)
