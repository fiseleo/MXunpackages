...
public struct RecipeSelectionGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.RecipeSelectionGroupExcel> CreateRecipeSelectionGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.RecipeSelectionGroupExcel> EndRecipeSelectionGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RecipeSelectionGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RecipeSelectionGroupExcel> Pack(FlatBufferBuilder builder, RecipeSelectionGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RecipeSelectionGroupExcel>);
