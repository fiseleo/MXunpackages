...
public struct LimitedStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.LimitedStageRewardExcel> CreateLimitedStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.LimitedStageRewardExcel> EndLimitedStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.LimitedStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.LimitedStageRewardExcel> Pack(FlatBufferBuilder builder, LimitedStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.LimitedStageRewardExcel>);
