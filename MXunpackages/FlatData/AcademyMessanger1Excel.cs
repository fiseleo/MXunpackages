...
public struct AcademyMessanger1Excel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AcademyMessanger1Excel> CreateAcademyMessanger1Excel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.AcademyMessanger1Excel> EndAcademyMessanger1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AcademyMessanger1Excel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AcademyMessanger1Excel> Pack(FlatBufferBuilder builder, AcademyMessanger1ExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AcademyMessanger1Excel>);
