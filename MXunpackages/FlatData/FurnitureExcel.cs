...
public struct FurnitureExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.FurnitureFunctionType FurnitureFunctionType_ { get { int o = __p.__offset(66); return o != 0 ? (Plana.FlatData.FurnitureFunctionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.FurnitureFunctionType.None; } }
  ...
  public static Offset<Plana.FlatData.FurnitureExcel> CreateFurnitureExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.FurnitureFunctionType FurnitureFunctionType_ = Plana.FlatData.FurnitureFunctionType.None,
  ...
  public static void AddFurnitureFunctionType_(FlatBufferBuilder builder, Plana.FlatData.FurnitureFunctionType furnitureFunctionType_) { builder.AddInt(31, (int)furnitureFunctionType_, 0); }
...
public class FurnitureExcelT
{
  ...
  public Plana.FlatData.FurnitureFunctionType FurnitureFunctionType_ { get; set; }
  ...
  public FurnitureExcelT() {
    ...
    this.FurnitureFunctionType_ = Plana.FlatData.FurnitureFunctionType.None;
...
static public class FurnitureExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 66 /*FurnitureFunctionType_*/, 4 /*Plana.FlatData.FurnitureFunctionType*/, 4, false)
