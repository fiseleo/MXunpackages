...
public struct FurnitureExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ProductionStep ProductionStep { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ProductionStep)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ProductionStep.ToDo; } }
  ...
  public Plana.FlatData.FurnitureCategory Category { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.FurnitureCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.FurnitureCategory.Furnitures; } }
  public Plana.FlatData.FurnitureSubCategory SubCategory { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.FurnitureSubCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.FurnitureSubCategory.Table; } }
  ...
  public Plana.FlatData.Tag Tags(int j) { int o = __p.__offset(56); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(56); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(56, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(56); }
#endif
  public Plana.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(56); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.FurnitureFunctionType FurnitureFunctionType { get { int o = __p.__offset(66); return o != 0 ? (Plana.FlatData.FurnitureFunctionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.FurnitureFunctionType.None; } }
  ...
  public static Offset<Plana.FlatData.FurnitureExcel> CreateFurnitureExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Plana.FlatData.FurnitureCategory Category = Plana.FlatData.FurnitureCategory.Furnitures,
      Plana.FlatData.FurnitureSubCategory SubCategory = Plana.FlatData.FurnitureSubCategory.Table,
      ...
      Plana.FlatData.FurnitureFunctionType FurnitureFunctionType = Plana.FlatData.FurnitureFunctionType.None,
  ...
  public static void AddProductionStep(FlatBufferBuilder builder, Plana.FlatData.ProductionStep productionStep) { builder.AddInt(1, (int)productionStep, 0); }
  public static void AddRarity(FlatBufferBuilder builder, Plana.FlatData.Rarity rarity) { builder.AddInt(2, (int)rarity, 0); }
  public static void AddCategory(FlatBufferBuilder builder, Plana.FlatData.FurnitureCategory category) { builder.AddInt(3, (int)category, 0); }
  public static void AddSubCategory(FlatBufferBuilder builder, Plana.FlatData.FurnitureSubCategory subCategory) { builder.AddInt(4, (int)subCategory, 0); }
  ...
  public static void AddFurnitureFunctionType(FlatBufferBuilder builder, Plana.FlatData.FurnitureFunctionType furnitureFunctionType) { builder.AddInt(31, (int)furnitureFunctionType, 0); }
  ...
  public static Offset<Plana.FlatData.FurnitureExcel> EndFurnitureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FurnitureExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FurnitureExcel> Pack(FlatBufferBuilder builder, FurnitureExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FurnitureExcel>);
...
public class FurnitureExcelT
{
  ...
  public Plana.FlatData.FurnitureCategory Category { get; set; }
  public Plana.FlatData.FurnitureSubCategory SubCategory { get; set; }
  ...
  public Plana.FlatData.FurnitureFunctionType FurnitureFunctionType { get; set; }
  ...
  public FurnitureExcelT() {
    ...
    this.Category = Plana.FlatData.FurnitureCategory.Furnitures;
    this.SubCategory = Plana.FlatData.FurnitureSubCategory.Table;
    ...
    this.FurnitureFunctionType = Plana.FlatData.FurnitureFunctionType.None;
...
static public class FurnitureExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ProductionStep*/, 4 /*Plana.FlatData.ProductionStep*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*Rarity*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*Category*/, 4 /*Plana.FlatData.FurnitureCategory*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*SubCategory*/, 4 /*Plana.FlatData.FurnitureSubCategory*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 56 /*Tags*/, 4 /*Plana.FlatData.Tag*/, false)
      ...
      && verifier.VerifyField(tablePos, 66 /*FurnitureFunctionType*/, 4 /*Plana.FlatData.FurnitureFunctionType*/, 4, false)
