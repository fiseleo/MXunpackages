...
public struct FarmingDungeonLocationManageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ContentType ContentType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ContentType.None; } }
  public Plana.FlatData.WeekDungeonType WeekDungeonType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeekDungeonType.None; } }
  public Plana.FlatData.SchoolDungeonType SchoolDungeonType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.SchoolDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.SchoolDungeonType.SchoolA; } }
  ...
  public static Offset<Plana.FlatData.FarmingDungeonLocationManageExcel> CreateFarmingDungeonLocationManageExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.SchoolDungeonType SchoolDungeonType = Plana.FlatData.SchoolDungeonType.SchoolA,
      long Order = 0,
  ...
  public static void AddContentType(FlatBufferBuilder builder, Plana.FlatData.ContentType contentType) { builder.AddInt(1, (int)contentType, 0); }
  public static void AddWeekDungeonType(FlatBufferBuilder builder, Plana.FlatData.WeekDungeonType weekDungeonType) { builder.AddInt(2, (int)weekDungeonType, 0); }
  public static void AddSchoolDungeonType(FlatBufferBuilder builder, Plana.FlatData.SchoolDungeonType schoolDungeonType) { builder.AddInt(3, (int)schoolDungeonType, 0); }
...
public class FarmingDungeonLocationManageExcelT
{
  ...
  public Plana.FlatData.SchoolDungeonType SchoolDungeonType { get; set; }
  ...
  public FarmingDungeonLocationManageExcelT() {
    ...
    this.SchoolDungeonType = Plana.FlatData.SchoolDungeonType.SchoolA;
    this.Order = 0;
...
static public class FarmingDungeonLocationManageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ContentType*/, 4 /*Plana.FlatData.ContentType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*WeekDungeonType*/, 4 /*Plana.FlatData.WeekDungeonType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*SchoolDungeonType*/, 4 /*Plana.FlatData.SchoolDungeonType*/, 4, false)
