...
public struct ConstConquestExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConstConquestExcel> CreateConstConquestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ConstConquestExcel> EndConstConquestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConstConquestExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConstConquestExcel> Pack(FlatBufferBuilder builder, ConstConquestExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConstConquestExcel>);
