...
public struct VoiceCommonExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.VoiceEvent VoiceEvent { get { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.VoiceEvent)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.VoiceEvent.OnTSA; } }
  ...
  public static Offset<Plana.FlatData.VoiceCommonExcel> CreateVoiceCommonExcel(FlatBufferBuilder builder,
      Plana.FlatData.VoiceEvent VoiceEvent = Plana.FlatData.VoiceEvent.OnTSA,
      long Rate = 0,
  ...
  public static void AddVoiceEvent(FlatBufferBuilder builder, Plana.FlatData.VoiceEvent voiceEvent) { builder.AddInt(0, (int)voiceEvent, 0); }
...
{
  public Plana.FlatData.VoiceEvent VoiceEvent { get; set; }
  public long Rate { get; set; }
  public List<uint> VoiceHash { get; set; }

  public VoiceCommonExcelT() {
    this.VoiceEvent = Plana.FlatData.VoiceEvent.OnTSA;
    this.Rate = 0;
    this.VoiceHash = null;
  }
}
...
static public class VoiceCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*VoiceEvent*/, 4 /*Plana.FlatData.VoiceEvent*/, 4, false)
