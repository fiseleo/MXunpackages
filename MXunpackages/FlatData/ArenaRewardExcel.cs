...
public struct ArenaRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ArenaRewardType ArenaRewardType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ArenaRewardType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ArenaRewardType.None; } }
  ...
  public static Offset<Plana.FlatData.ArenaRewardExcel> CreateArenaRewardExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Plana.FlatData.ArenaRewardType ArenaRewardType = Plana.FlatData.ArenaRewardType.None,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static void AddArenaRewardType(FlatBufferBuilder builder, Plana.FlatData.ArenaRewardType arenaRewardType) { builder.AddInt(1, (int)arenaRewardType, 0); }
...
public class ArenaRewardExcelT
{
  ...
  public Plana.FlatData.ArenaRewardType ArenaRewardType { get; set; }
  ...
  public ArenaRewardExcelT() {
    this.UniqueId = 0;
    this.ArenaRewardType = Plana.FlatData.ArenaRewardType.None;
    this.RankStart = 0;
    this.RankEnd = 0;
...
static public class ArenaRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ArenaRewardType*/, 4 /*Plana.FlatData.ArenaRewardType*/, 4, false)
