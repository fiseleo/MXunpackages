...
public struct WorldRaidConditionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MultipleConditionCheckType.And; } }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Plana.FlatData.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(6, (int)multipleConditionCheckType, 0); }
...
static public class WorldRaidConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*MultipleConditionCheckType*/, 4 /*Plana.FlatData.MultipleConditionCheckType*/, 4, false)
