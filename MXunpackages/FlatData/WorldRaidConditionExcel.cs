...
public struct WorldRaidConditionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MultipleConditionCheckType MultipleConditionCheckType_ { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Plana.FlatData.WorldRaidConditionExcel> CreateWorldRaidConditionExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    WorldRaidConditionExcel.AddMultipleConditionCheckType_(builder, MultipleConditionCheckType_);
  ...
  public static void AddMultipleConditionCheckType_(FlatBufferBuilder builder, Plana.FlatData.MultipleConditionCheckType multipleConditionCheckType_) { builder.AddInt(6, (int)multipleConditionCheckType_, 0); }
  ...
  public static Offset<Plana.FlatData.WorldRaidConditionExcel> EndWorldRaidConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WorldRaidConditionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.WorldRaidConditionExcel> Pack(FlatBufferBuilder builder, WorldRaidConditionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WorldRaidConditionExcel>);
...
static public class WorldRaidConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*MultipleConditionCheckType_*/, 4 /*Plana.FlatData.MultipleConditionCheckType*/, 4, false)
