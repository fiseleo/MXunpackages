...
public struct DefaultMailExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MailType MailType_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.MailType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MailType.System; } }
  ...
  public static void AddMailType_(FlatBufferBuilder builder, Plana.FlatData.MailType mailType_) { builder.AddInt(2, (int)mailType_, 0); }
...
static public class DefaultMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*MailType_*/, 4 /*Plana.FlatData.MailType*/, 4, false)
