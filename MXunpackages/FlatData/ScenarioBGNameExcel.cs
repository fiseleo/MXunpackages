...
public struct ScenarioBGNameExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ScenarioBGType BGType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ScenarioBGType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ScenarioBGType.None; } }
  ...
  public static Offset<Plana.FlatData.ScenarioBGNameExcel> CreateScenarioBGNameExcel(FlatBufferBuilder builder,
      uint Name = 0,
      ...
      Plana.FlatData.ScenarioBGType BGType = Plana.FlatData.ScenarioBGType.None,
  ...
  public static void AddBGType(FlatBufferBuilder builder, Plana.FlatData.ScenarioBGType bGType) { builder.AddInt(3, (int)bGType, 0); }
  ...
  public static Offset<Plana.FlatData.ScenarioBGNameExcel> EndScenarioBGNameExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ScenarioBGNameExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ScenarioBGNameExcel> Pack(FlatBufferBuilder builder, ScenarioBGNameExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ScenarioBGNameExcel>);
...
public class ScenarioBGNameExcelT
{
  ...
  public Plana.FlatData.ScenarioBGType BGType { get; set; }
  ...
  public ScenarioBGNameExcelT() {
    ...
    this.BGType = Plana.FlatData.ScenarioBGType.None;
...
static public class ScenarioBGNameExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*BGType*/, 4 /*Plana.FlatData.ScenarioBGType*/, 4, false)
