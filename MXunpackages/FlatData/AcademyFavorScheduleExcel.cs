...
public struct AcademyFavorScheduleExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AcademyFavorScheduleExcel> CreateAcademyFavorScheduleExcel(FlatBufferBuilder builder,
      long Id = 0,
      long CharacterId = 0,
  ...
  public static Offset<Plana.FlatData.AcademyFavorScheduleExcel> EndAcademyFavorScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AcademyFavorScheduleExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AcademyFavorScheduleExcel> Pack(FlatBufferBuilder builder, AcademyFavorScheduleExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AcademyFavorScheduleExcel>);
