...
public struct EventContentBoxGachaElementExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaElementExcel> CreateEventContentBoxGachaElementExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaElementExcel> EndEventContentBoxGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentBoxGachaElementExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaElementExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaElementExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentBoxGachaElementExcel>);
