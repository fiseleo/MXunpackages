...
public struct CharacterTranscendenceExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterTranscendenceExcel> CreateCharacterTranscendenceExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Plana.FlatData.CharacterTranscendenceExcel> EndCharacterTranscendenceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterTranscendenceExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterTranscendenceExcel> Pack(FlatBufferBuilder builder, CharacterTranscendenceExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterTranscendenceExcel>);
