...
public struct FieldTutorialExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.FieldTutorialType TutorialType(int j) { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.FieldTutorialType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.FieldTutorialType)0; }
  public int TutorialTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.FieldTutorialType> GetTutorialTypeBytes() { return __p.__vector_as_span<Plana.FlatData.FieldTutorialType>(6, 4); }
#else
  public ArraySegment<byte>? GetTutorialTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Plana.FlatData.FieldTutorialType[] GetTutorialTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.FieldTutorialType[] a = new Plana.FlatData.FieldTutorialType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.FieldTutorialType)__p.bb.GetInt(p + i * 4); } return a; }
  public Plana.FlatData.FieldConditionType ConditionType(int j) { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<Plana.FlatData.FieldConditionType>(8, 4); }
#else
  ...
  public static Offset<Plana.FlatData.FieldTutorialExcel> CreateFieldTutorialExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static VectorOffset CreateTutorialTypeVector(FlatBufferBuilder builder, Plana.FlatData.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.FieldTutorialType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.FieldTutorialType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.FieldTutorialExcel> EndFieldTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FieldTutorialExcel>(o);
  }
  ...
  public void UnPackTo(FieldTutorialExcelT _o) {
    ...
    _o.TutorialType = new List<Plana.FlatData.FieldTutorialType>();
  ...
  public static Offset<Plana.FlatData.FieldTutorialExcel> Pack(FlatBufferBuilder builder, FieldTutorialExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FieldTutorialExcel>);
...
public class FieldTutorialExcelT
{
  ...
  public List<Plana.FlatData.FieldTutorialType> TutorialType { get; set; }
...
static public class FieldTutorialExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*TutorialType*/, 4 /*Plana.FlatData.FieldTutorialType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*ConditionType*/, 4 /*Plana.FlatData.FieldConditionType*/, false)
