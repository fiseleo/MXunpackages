...
public struct DefaultParcelExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ParcelType { get { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static void AddParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType parcelType) { builder.AddInt(0, (int)parcelType, 0); }
...
static public class DefaultParcelExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*ParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
