...
public struct AudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AudioAnimatorExcel> CreateAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.AudioAnimatorExcel> EndAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AudioAnimatorExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AudioAnimatorExcel> Pack(FlatBufferBuilder builder, AudioAnimatorExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AudioAnimatorExcel>);
