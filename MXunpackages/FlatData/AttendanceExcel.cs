...
public struct AttendanceExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.AttendanceType Type { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.AttendanceType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.AttendanceType.Basic; } }
  ...
  public Plana.FlatData.AccountState AccountType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.AccountState)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.AccountState.WaitingSignIn; } }
  ...
  public Plana.FlatData.AttendanceCountRule CountRule { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.AttendanceCountRule)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.AttendanceCountRule.Accumulation; } }
  public Plana.FlatData.AttendanceResetType CountReset { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.AttendanceResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.AttendanceResetType.User; } }
  ...
  public Plana.FlatData.MailType MailType { get { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.MailType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MailType.System; } }
  public Plana.FlatData.DialogCategory DialogCategory { get { int o = __p.__offset(36); return o != 0 ? (Plana.FlatData.DialogCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DialogCategory.Cafe; } }
  ...
  public static Offset<Plana.FlatData.AttendanceExcel> CreateAttendanceExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.AttendanceType Type = Plana.FlatData.AttendanceType.Basic,
      ...
      Plana.FlatData.AttendanceCountRule CountRule = Plana.FlatData.AttendanceCountRule.Accumulation,
      Plana.FlatData.AttendanceResetType CountReset = Plana.FlatData.AttendanceResetType.User,
      long BookSize = 0,
      ...
      long ExpiryDate = 0,
      Plana.FlatData.MailType MailType = Plana.FlatData.MailType.System,
  ...
  public static void AddType(FlatBufferBuilder builder, Plana.FlatData.AttendanceType type) { builder.AddInt(1, (int)type, 0); }
  ...
  public static void AddAccountType(FlatBufferBuilder builder, Plana.FlatData.AccountState accountType) { builder.AddInt(4, (int)accountType, 0); }
  ...
  public static void AddCountRule(FlatBufferBuilder builder, Plana.FlatData.AttendanceCountRule countRule) { builder.AddInt(8, (int)countRule, 0); }
  public static void AddCountReset(FlatBufferBuilder builder, Plana.FlatData.AttendanceResetType countReset) { builder.AddInt(9, (int)countReset, 0); }
  ...
  public static void AddMailType(FlatBufferBuilder builder, Plana.FlatData.MailType mailType) { builder.AddInt(15, (int)mailType, 0); }
  public static void AddDialogCategory(FlatBufferBuilder builder, Plana.FlatData.DialogCategory dialogCategory) { builder.AddInt(16, (int)dialogCategory, 0); }
  ...
  public static Offset<Plana.FlatData.AttendanceExcel> EndAttendanceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AttendanceExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AttendanceExcel> Pack(FlatBufferBuilder builder, AttendanceExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AttendanceExcel>);
...
public class AttendanceExcelT
{
  ...
  public Plana.FlatData.AttendanceType Type { get; set; }
  ...
  public Plana.FlatData.AttendanceCountRule CountRule { get; set; }
  public Plana.FlatData.AttendanceResetType CountReset { get; set; }
  public long BookSize { get; set; }
  public string StartDate { get; set; }
  public string StartableEndDate { get; set; }
  public string EndDate { get; set; }
  public long ExpiryDate { get; set; }
  public Plana.FlatData.MailType MailType { get; set; }
  ...
  public AttendanceExcelT() {
    this.Id = 0;
    this.Type = Plana.FlatData.AttendanceType.Basic;
    ...
    this.CountRule = Plana.FlatData.AttendanceCountRule.Accumulation;
    this.CountReset = Plana.FlatData.AttendanceResetType.User;
    this.BookSize = 0;
    this.StartDate = null;
    this.StartableEndDate = null;
    this.EndDate = null;
    this.ExpiryDate = 0;
    this.MailType = Plana.FlatData.MailType.System;
...
static public class AttendanceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Type*/, 4 /*Plana.FlatData.AttendanceType*/, 4, false)
      && verifier.VerifyString(tablePos, 8 /*CountdownPrefab*/, false)
      && verifier.VerifyField(tablePos, 10 /*DisplayOrder*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*AccountType*/, 4 /*Plana.FlatData.AccountState*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*CountRule*/, 4 /*Plana.FlatData.AttendanceCountRule*/, 4, false)
      && verifier.VerifyField(tablePos, 22 /*CountReset*/, 4 /*Plana.FlatData.AttendanceResetType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 34 /*MailType*/, 4 /*Plana.FlatData.MailType*/, 4, false)
      && verifier.VerifyField(tablePos, 36 /*DialogCategory*/, 4 /*Plana.FlatData.DialogCategory*/, 4, false)
