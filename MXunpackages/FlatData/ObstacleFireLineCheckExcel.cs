...
public struct ObstacleFireLineCheckExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ObstacleFireLineCheckExcel> CreateObstacleFireLineCheckExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ObstacleFireLineCheckExcel> EndObstacleFireLineCheckExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ObstacleFireLineCheckExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ObstacleFireLineCheckExcel> Pack(FlatBufferBuilder builder, ObstacleFireLineCheckExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ObstacleFireLineCheckExcel>);
