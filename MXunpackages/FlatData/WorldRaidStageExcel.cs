...
public struct WorldRaidStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.WorldRaidDifficulty WorldRaidDifficulty_ { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.WorldRaidDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WorldRaidDifficulty.None; } }
  ...
  public static Offset<Plana.FlatData.WorldRaidStageExcel> CreateWorldRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Plana.FlatData.WorldRaidDifficulty WorldRaidDifficulty_ = Plana.FlatData.WorldRaidDifficulty.None,
    ...
    WorldRaidStageExcel.AddEchelonExtensionType_(builder, EchelonExtensionType_);
    ...
    WorldRaidStageExcel.AddWorldRaidDifficulty_(builder, WorldRaidDifficulty_);
  ...
  public static void AddWorldRaidDifficulty_(FlatBufferBuilder builder, Plana.FlatData.WorldRaidDifficulty worldRaidDifficulty_) { builder.AddInt(9, (int)worldRaidDifficulty_, 0); }
  ...
  public static Offset<Plana.FlatData.WorldRaidStageExcel> EndWorldRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WorldRaidStageExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidStageExcelT _o) {
    ...
    _o.WorldRaidDifficulty_ = TableEncryptionService.Convert(this.WorldRaidDifficulty_, key);
  ...
  public static Offset<Plana.FlatData.WorldRaidStageExcel> Pack(FlatBufferBuilder builder, WorldRaidStageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WorldRaidStageExcel>);
...
public class WorldRaidStageExcelT
{
  ...
  public Plana.FlatData.WorldRaidDifficulty WorldRaidDifficulty_ { get; set; }
  ...
  public WorldRaidStageExcelT() {
    ...
    this.WorldRaidDifficulty_ = Plana.FlatData.WorldRaidDifficulty.None;
...
static public class WorldRaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*WorldRaidDifficulty_*/, 4 /*Plana.FlatData.WorldRaidDifficulty*/, 4, false)
