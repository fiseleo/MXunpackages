...
public struct EmoticonSpecialExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EmoticonSpecialExcel> CreateEmoticonSpecialExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Plana.FlatData.EmoticonSpecialExcel> EndEmoticonSpecialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EmoticonSpecialExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EmoticonSpecialExcel> Pack(FlatBufferBuilder builder, EmoticonSpecialExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EmoticonSpecialExcel>);
