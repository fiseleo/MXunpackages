...
public struct EventContentFortuneGachaExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentFortuneGachaExcel> CreateEventContentFortuneGachaExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentFortuneGachaExcel> EndEventContentFortuneGachaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentFortuneGachaExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentFortuneGachaExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentFortuneGachaExcel>);
