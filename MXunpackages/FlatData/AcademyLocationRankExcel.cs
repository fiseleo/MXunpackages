...
public struct AcademyLocationRankExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AcademyLocationRankExcel> CreateAcademyLocationRankExcel(FlatBufferBuilder builder,
      long Rank = 0,
      long RankExp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Plana.FlatData.AcademyLocationRankExcel> EndAcademyLocationRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AcademyLocationRankExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AcademyLocationRankExcel> Pack(FlatBufferBuilder builder, AcademyLocationRankExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AcademyLocationRankExcel>);
