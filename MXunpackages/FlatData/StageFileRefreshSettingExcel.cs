...
public struct StageFileRefreshSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.StageFileRefreshSettingExcel> CreateStageFileRefreshSettingExcel(FlatBufferBuilder builder,
      long GroundId = 0,
  ...
  public static Offset<Plana.FlatData.StageFileRefreshSettingExcel> EndStageFileRefreshSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.StageFileRefreshSettingExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.StageFileRefreshSettingExcel> Pack(FlatBufferBuilder builder, StageFileRefreshSettingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.StageFileRefreshSettingExcel>);
