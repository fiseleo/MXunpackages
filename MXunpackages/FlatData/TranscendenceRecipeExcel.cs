...
public struct TranscendenceRecipeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CurrencyTypes CostCurrencyType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CurrencyTypes.Invalid; } }
  public long CostCurrencyAmount { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.ParcelType ParcelType_(int j) { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int ParcelType_Length { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetParcelType_Bytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(12, 4); }
#else
  public ArraySegment<byte>? GetParcelType_Bytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Plana.FlatData.ParcelType[] GetParcelType_Array() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.TranscendenceRecipeExcel> CreateTranscendenceRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
      StringOffset DevNameOffset = default(StringOffset),
      Plana.FlatData.CurrencyTypes CostCurrencyType = Plana.FlatData.CurrencyTypes.Invalid,
  ...
  public static void AddCostCurrencyType(FlatBufferBuilder builder, Plana.FlatData.CurrencyTypes costCurrencyType) { builder.AddInt(2, (int)costCurrencyType, 0); }
  ...
  public static Offset<Plana.FlatData.TranscendenceRecipeExcel> EndTranscendenceRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TranscendenceRecipeExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TranscendenceRecipeExcel> Pack(FlatBufferBuilder builder, TranscendenceRecipeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TranscendenceRecipeExcel>);
...
public class TranscendenceRecipeExcelT
{
  ...
  public Plana.FlatData.CurrencyTypes CostCurrencyType { get; set; }
  ...
  public TranscendenceRecipeExcelT() {
    this.Id = 0;
    this.DevName = null;
    this.CostCurrencyType = Plana.FlatData.CurrencyTypes.Invalid;
...
static public class TranscendenceRecipeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CostCurrencyType*/, 4 /*Plana.FlatData.CurrencyTypes*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*CostCurrencyAmount*/, 8 /*long*/, 8, false)
      && verifier.VerifyVectorOfData(tablePos, 12 /*ParcelType_*/, 4 /*Plana.FlatData.ParcelType*/, false)
