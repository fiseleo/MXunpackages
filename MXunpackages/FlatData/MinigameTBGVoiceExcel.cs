...
public struct MinigameTBGVoiceExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TBGVoiceCondition VoiceCondition { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.TBGVoiceCondition)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TBGVoiceCondition.None; } }
  public uint VoiceId { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }

  public static Offset<Plana.FlatData.MinigameTBGVoiceExcel> CreateMinigameTBGVoiceExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      Plana.FlatData.TBGVoiceCondition VoiceCondition = Plana.FlatData.TBGVoiceCondition.None,
      uint VoiceId = 0) {
  ...
  public static void AddVoiceCondition(FlatBufferBuilder builder, Plana.FlatData.TBGVoiceCondition voiceCondition) { builder.AddInt(2, (int)voiceCondition, 0); }
  public static void AddVoiceId(FlatBufferBuilder builder, uint voiceId) { builder.AddUint(3, voiceId, 0); }
  public static Offset<Plana.FlatData.MinigameTBGVoiceExcel> EndMinigameTBGVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameTBGVoiceExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameTBGVoiceExcel> Pack(FlatBufferBuilder builder, MinigameTBGVoiceExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameTBGVoiceExcel>);
...
public class MinigameTBGVoiceExcelT
{
  ...
  public Plana.FlatData.TBGVoiceCondition VoiceCondition { get; set; }
  public uint VoiceId { get; set; }

  public MinigameTBGVoiceExcelT() {
    this.EventContentId = 0;
    this.UniqueId = 0;
    this.VoiceCondition = Plana.FlatData.TBGVoiceCondition.None;
    this.VoiceId = 0;
  }
}
...
static public class MinigameTBGVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*VoiceCondition*/, 4 /*Plana.FlatData.TBGVoiceCondition*/, 4, false)
