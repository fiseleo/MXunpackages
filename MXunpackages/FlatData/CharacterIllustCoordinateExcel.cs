...
public struct CharacterIllustCoordinateExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterIllustCoordinateExcel> CreateCharacterIllustCoordinateExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.CharacterIllustCoordinateExcel> EndCharacterIllustCoordinateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterIllustCoordinateExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterIllustCoordinateExcel> Pack(FlatBufferBuilder builder, CharacterIllustCoordinateExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterIllustCoordinateExcel>);
