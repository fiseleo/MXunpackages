...
public struct ShopInfoExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopCategoryType.General; } }
  ...
  public Plana.FlatData.ParcelType DisplayParcelType { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.ShopInfoExcel> CreateShopInfoExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.ParcelType DisplayParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Plana.FlatData.ShopCategoryType categoryType) { builder.AddInt(0, (int)categoryType, 0); }
  ...
  public static void AddDisplayParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType displayParcelType) { builder.AddInt(11, (int)displayParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.ShopInfoExcel> EndShopInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ShopInfoExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ShopInfoExcel> Pack(FlatBufferBuilder builder, ShopInfoExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ShopInfoExcel>);
...
public class ShopInfoExcelT
{
  ...
  public Plana.FlatData.ParcelType DisplayParcelType { get; set; }
  ...
  public ShopInfoExcelT() {
    ...
    this.DisplayParcelType = Plana.FlatData.ParcelType.None;
...
static public class ShopInfoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*CategoryType*/, 4 /*Plana.FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*DisplayParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
