...
public struct MiniGameDreamEndingRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.DreamMakerEndingRewardType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DreamMakerEndingRewardType.None; } }
  public Plana.FlatData.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DreamMakerEndingType.None; } }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamEndingRewardExcel> CreateMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long EndingId = 0,
      uint LocalizeEtcId = 0,
      Plana.FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType = Plana.FlatData.DreamMakerEndingRewardType.None,
  ...
  public static void AddDreamMakerEndingRewardType(FlatBufferBuilder builder, Plana.FlatData.DreamMakerEndingRewardType dreamMakerEndingRewardType) { builder.AddInt(3, (int)dreamMakerEndingRewardType, 0); }
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, Plana.FlatData.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(4, (int)dreamMakerEndingType, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamEndingRewardExcel> EndMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamEndingRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamEndingRewardExcel> Pack(FlatBufferBuilder builder, MiniGameDreamEndingRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamEndingRewardExcel>);
...
public class MiniGameDreamEndingRewardExcelT
{
  ...
  public Plana.FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType { get; set; }
  ...
  public MiniGameDreamEndingRewardExcelT() {
    ...
    this.DreamMakerEndingRewardType = Plana.FlatData.DreamMakerEndingRewardType.None;
...
static public class MiniGameDreamEndingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*DreamMakerEndingRewardType*/, 4 /*Plana.FlatData.DreamMakerEndingRewardType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*DreamMakerEndingType*/, 4 /*Plana.FlatData.DreamMakerEndingType*/, 4, false)
