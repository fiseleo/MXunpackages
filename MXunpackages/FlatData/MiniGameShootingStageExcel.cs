...
public struct MiniGameShootingStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Difficulty Difficulty { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Difficulty.Normal; } }
  ...
  public static Offset<Plana.FlatData.MiniGameShootingStageExcel> CreateMiniGameShootingStageExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Plana.FlatData.Difficulty difficulty) { builder.AddInt(3, (int)difficulty, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameShootingStageExcel> EndMiniGameShootingStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameShootingStageExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameShootingStageExcelT _o) {
    ...
    for (var _j = 0; _j < this.BgmIdLength; ++_j) {_o.BgmId.Add(TableEncryptionService.Convert(this.BgmId(_j), key));}
  ...
  public static Offset<Plana.FlatData.MiniGameShootingStageExcel> Pack(FlatBufferBuilder builder, MiniGameShootingStageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameShootingStageExcel>);
...
static public class MiniGameShootingStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Difficulty*/, 4 /*Plana.FlatData.Difficulty*/, 4, false)
