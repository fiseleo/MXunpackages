...
public struct MiniGameShootingStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Difficulty Difficulty_ { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Difficulty.Normal; } }
  ...
  public static Offset<Plana.FlatData.MiniGameShootingStageExcel> CreateMiniGameShootingStageExcel(FlatBufferBuilder builder,
    ...
    MiniGameShootingStageExcel.AddDifficulty_(builder, Difficulty_);
  ...
  public static void AddDifficulty_(FlatBufferBuilder builder, Plana.FlatData.Difficulty difficulty_) { builder.AddInt(3, (int)difficulty_, 0); }
...
static public class MiniGameShootingStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Difficulty_*/, 4 /*Plana.FlatData.Difficulty*/, 4, false)
