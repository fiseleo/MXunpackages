...
public struct MiniGameDreamScheduleResultExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.DreamMakerResult DreamMakerResult { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.DreamMakerResult)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DreamMakerResult.None; } }
  ...
  public Plana.FlatData.DreamMakerParameterType RewardParameter(int j) { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.DreamMakerParameterType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.DreamMakerParameterType)0; }
  public int RewardParameterLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.DreamMakerParameterType> GetRewardParameterBytes() { return __p.__vector_as_span<Plana.FlatData.DreamMakerParameterType>(14, 4); }
#else
  public ArraySegment<byte>? GetRewardParameterBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Plana.FlatData.DreamMakerParameterType[] GetRewardParameterArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.DreamMakerParameterType[] a = new Plana.FlatData.DreamMakerParameterType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.DreamMakerParameterType)__p.bb.GetInt(p + i * 4); } return a; }
  public Plana.FlatData.DreamMakerParamOperationType RewardParameterOperationType(int j) { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.DreamMakerParamOperationType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.DreamMakerParamOperationType)0; }
  public int RewardParameterOperationTypeLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.DreamMakerParamOperationType> GetRewardParameterOperationTypeBytes() { return __p.__vector_as_span<Plana.FlatData.DreamMakerParamOperationType>(16, 4); }
#else
  public ArraySegment<byte>? GetRewardParameterOperationTypeBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Plana.FlatData.DreamMakerParamOperationType[] GetRewardParameterOperationTypeArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.DreamMakerParamOperationType[] a = new Plana.FlatData.DreamMakerParamOperationType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.DreamMakerParamOperationType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType RewardParcelType { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamScheduleResultExcel> CreateMiniGameDreamScheduleResultExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Plana.FlatData.DreamMakerResult DreamMakerResult = Plana.FlatData.DreamMakerResult.None,
  ...
  public static void AddDreamMakerResult(FlatBufferBuilder builder, Plana.FlatData.DreamMakerResult dreamMakerResult) { builder.AddInt(2, (int)dreamMakerResult, 0); }
  ...
  public static VectorOffset CreateRewardParameterVector(FlatBufferBuilder builder, Plana.FlatData.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, Plana.FlatData.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.DreamMakerParameterType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.DreamMakerParameterType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateRewardParameterOperationTypeVector(FlatBufferBuilder builder, Plana.FlatData.DreamMakerParamOperationType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.DreamMakerParamOperationType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.DreamMakerParamOperationType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRewardParameterOperationTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.DreamMakerParamOperationType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType rewardParcelType) { builder.AddInt(8, (int)rewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamScheduleResultExcel> EndMiniGameDreamScheduleResultExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamScheduleResultExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamScheduleResultExcelT _o) {
    ...
    _o.RewardParameter = new List<Plana.FlatData.DreamMakerParameterType>();
    ...
    _o.RewardParameterOperationType = new List<Plana.FlatData.DreamMakerParamOperationType>();
  ...
  public static Offset<Plana.FlatData.MiniGameDreamScheduleResultExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleResultExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamScheduleResultExcel>);
...
public class MiniGameDreamScheduleResultExcelT
{
  ...
  public Plana.FlatData.DreamMakerResult DreamMakerResult { get; set; }
  public long DreamMakerScheduleGroup { get; set; }
  public int Prob { get; set; }
  public List<Plana.FlatData.DreamMakerParameterType> RewardParameter { get; set; }
  public List<Plana.FlatData.DreamMakerParamOperationType> RewardParameterOperationType { get; set; }
  ...
  public MiniGameDreamScheduleResultExcelT() {
    ...
    this.DreamMakerResult = Plana.FlatData.DreamMakerResult.None;
...
static public class MiniGameDreamScheduleResultExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*DreamMakerResult*/, 4 /*Plana.FlatData.DreamMakerResult*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*RewardParameter*/, 4 /*Plana.FlatData.DreamMakerParameterType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*RewardParameterOperationType*/, 4 /*Plana.FlatData.DreamMakerParamOperationType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 18 /*RewardParameterAmount*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 20 /*RewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
