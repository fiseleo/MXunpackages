...
public struct EchelonConstraintExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.WeaponType WeaponType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeaponType.None; } }
  public Plana.FlatData.School School { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.School)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.School.None; } }
  public Plana.FlatData.Club Club { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.Club)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Club.None; } }
  ...
  public static void AddWeaponType(FlatBufferBuilder builder, Plana.FlatData.WeaponType weaponType) { builder.AddInt(4, (int)weaponType, 0); }
  public static void AddSchool(FlatBufferBuilder builder, Plana.FlatData.School school) { builder.AddInt(5, (int)school, 0); }
  public static void AddClub(FlatBufferBuilder builder, Plana.FlatData.Club club) { builder.AddInt(6, (int)club, 0); }
...
static public class EchelonConstraintExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*WeaponType*/, 4 /*Plana.FlatData.WeaponType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*School*/, 4 /*Plana.FlatData.School*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*Club*/, 4 /*Plana.FlatData.Club*/, 4, false)
