...
public struct EchelonConstraintExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.WeaponType WeaponType_ { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeaponType.None; } }
  public Plana.FlatData.School School_ { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.School)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.School.None; } }
  public Plana.FlatData.Club Club_ { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.Club)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Club.None; } }
  public Plana.FlatData.TacticRole Role { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.TacticRole)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticRole.None; } }

  public static Offset<Plana.FlatData.EchelonConstraintExcel> CreateEchelonConstraintExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      bool IsWhiteList = false,
      VectorOffset CharacterIdOffset = default(VectorOffset),
      VectorOffset PersonalityIdOffset = default(VectorOffset),
      Plana.FlatData.WeaponType WeaponType_ = Plana.FlatData.WeaponType.None,
      Plana.FlatData.School School_ = Plana.FlatData.School.None,
      Plana.FlatData.Club Club_ = Plana.FlatData.Club.None,
      Plana.FlatData.TacticRole Role = Plana.FlatData.TacticRole.None) {
  ...
  public static void AddWeaponType_(FlatBufferBuilder builder, Plana.FlatData.WeaponType weaponType_) { builder.AddInt(4, (int)weaponType_, 0); }
  public static void AddSchool_(FlatBufferBuilder builder, Plana.FlatData.School school_) { builder.AddInt(5, (int)school_, 0); }
  public static void AddClub_(FlatBufferBuilder builder, Plana.FlatData.Club club_) { builder.AddInt(6, (int)club_, 0); }
  public static void AddRole(FlatBufferBuilder builder, Plana.FlatData.TacticRole role) { builder.AddInt(7, (int)role, 0); }
  public static Offset<Plana.FlatData.EchelonConstraintExcel> EndEchelonConstraintExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EchelonConstraintExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EchelonConstraintExcel> Pack(FlatBufferBuilder builder, EchelonConstraintExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EchelonConstraintExcel>);
...
public class EchelonConstraintExcelT
{
  ...
  public Plana.FlatData.WeaponType WeaponType_ { get; set; }
  public Plana.FlatData.School School_ { get; set; }
  public Plana.FlatData.Club Club_ { get; set; }
  public Plana.FlatData.TacticRole Role { get; set; }
  ...
  public EchelonConstraintExcelT() {
    ...
    this.WeaponType_ = Plana.FlatData.WeaponType.None;
    this.School_ = Plana.FlatData.School.None;
    this.Club_ = Plana.FlatData.Club.None;
    this.Role = Plana.FlatData.TacticRole.None;
  }
}
...
static public class EchelonConstraintExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*WeaponType_*/, 4 /*Plana.FlatData.WeaponType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*School_*/, 4 /*Plana.FlatData.School*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*Club_*/, 4 /*Plana.FlatData.Club*/, 4, false)
      && verifier.VerifyField(tablePos, 18 /*Role*/, 4 /*Plana.FlatData.TacticRole*/, 4, false)
