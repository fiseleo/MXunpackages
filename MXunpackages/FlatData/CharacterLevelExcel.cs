...
public struct CharacterLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterLevelExcel> CreateCharacterLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<Plana.FlatData.CharacterLevelExcel> EndCharacterLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterLevelExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterLevelExcel> Pack(FlatBufferBuilder builder, CharacterLevelExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterLevelExcel>);
