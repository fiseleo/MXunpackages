...
public struct CharacterSkillListExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterSkillListExcel> CreateCharacterSkillListExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.CharacterSkillListExcel> EndCharacterSkillListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterSkillListExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterSkillListExcel> Pack(FlatBufferBuilder builder, CharacterSkillListExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterSkillListExcel>);
