...
public struct RaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.RaidSeasonManageExcel> CreateRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Plana.FlatData.RaidSeasonManageExcel> EndRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RaidSeasonManageExcel> Pack(FlatBufferBuilder builder, RaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RaidSeasonManageExcel>);
