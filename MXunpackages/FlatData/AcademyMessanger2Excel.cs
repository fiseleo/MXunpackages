...
public struct AcademyMessanger2Excel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AcademyMessanger2Excel> CreateAcademyMessanger2Excel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.AcademyMessanger2Excel> EndAcademyMessanger2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AcademyMessanger2Excel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AcademyMessanger2Excel> Pack(FlatBufferBuilder builder, AcademyMessanger2ExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AcademyMessanger2Excel>);
