...
public struct CombatEmojiExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EmojiEvent EmojiEvent { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EmojiEvent)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmojiEvent.EnterConver; } }
  ...
  public static Offset<Plana.FlatData.CombatEmojiExcel> CreateCombatEmojiExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Plana.FlatData.EmojiEvent EmojiEvent = Plana.FlatData.EmojiEvent.EnterConver,
  ...
  public static void AddEmojiEvent(FlatBufferBuilder builder, Plana.FlatData.EmojiEvent emojiEvent) { builder.AddInt(1, (int)emojiEvent, 0); }
...
public class CombatEmojiExcelT
{
  ...
  public Plana.FlatData.EmojiEvent EmojiEvent { get; set; }
  ...
  public CombatEmojiExcelT() {
    this.UniqueId = 0;
    this.EmojiEvent = Plana.FlatData.EmojiEvent.EnterConver;
...
static public class CombatEmojiExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EmojiEvent*/, 4 /*Plana.FlatData.EmojiEvent*/, 4, false)
