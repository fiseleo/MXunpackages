...
public struct GuideMissionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MissionCategory Category { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.MissionCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCategory.Challenge; } }
  ...
  public Plana.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Plana.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(30); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(30, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public Plana.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public bool IsAutoClearForScenario { get { int o = __p.__offset(32); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public Plana.FlatData.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Plana.FlatData.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.GuideMissionExcel> CreateGuideMissionExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long Id = 0,
  ...
  public static void AddCategory(FlatBufferBuilder builder, Plana.FlatData.MissionCategory category) { builder.AddInt(2, (int)category, 0); }
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Plana.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(10, (int)completeConditionType, 0); }
  ...
  public static Offset<Plana.FlatData.GuideMissionExcel> EndGuideMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GuideMissionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GuideMissionExcel> Pack(FlatBufferBuilder builder, GuideMissionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GuideMissionExcel>);
...
static public class GuideMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Category*/, 4 /*Plana.FlatData.MissionCategory*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*CompleteConditionType*/, 4 /*Plana.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*CompleteConditionParameterTag*/, 4 /*Plana.FlatData.Tag*/, false)
      && verifier.VerifyField(tablePos, 32 /*IsAutoClearForScenario*/, 1 /*bool*/, 1, false)
      && verifier.VerifyVectorOfData(tablePos, 34 /*MissionRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
