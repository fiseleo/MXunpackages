...
public struct ConquestGroupBonusExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.School School_(int j) { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.School)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.School)0; }
  public int School_Length { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.School> GetSchool_Bytes() { return __p.__vector_as_span<Plana.FlatData.School>(6, 4); }
#else
  public ArraySegment<byte>? GetSchool_Bytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Plana.FlatData.School[] GetSchool_Array() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.School[] a = new Plana.FlatData.School[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.School)__p.bb.GetInt(p + i * 4); } return a; }
  public uint RecommandLocalizeEtcId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public Plana.FlatData.ParcelType BonusParcelType(int j) { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int BonusParcelTypeLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetBonusParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(10, 4); }
#else
  public ArraySegment<byte>? GetBonusParcelTypeBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public Plana.FlatData.ParcelType[] GetBonusParcelTypeArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.ConquestGroupBonusExcel> CreateConquestGroupBonusExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateSchool_Vector(FlatBufferBuilder builder, Plana.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateSchool_VectorBlock(FlatBufferBuilder builder, Plana.FlatData.School[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchool_VectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.School> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSchool_VectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.School>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateBonusParcelTypeVector(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBonusParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.ConquestGroupBonusExcel> EndConquestGroupBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestGroupBonusExcel>(o);
  }
  ...
  public void UnPackTo(ConquestGroupBonusExcelT _o) {
    ...
    _o.School_ = new List<Plana.FlatData.School>();
    ...
    _o.BonusParcelType = new List<Plana.FlatData.ParcelType>();
  ...
  public static Offset<Plana.FlatData.ConquestGroupBonusExcel> Pack(FlatBufferBuilder builder, ConquestGroupBonusExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestGroupBonusExcel>);
...
public class ConquestGroupBonusExcelT
{
  ...
  public List<Plana.FlatData.School> School_ { get; set; }
  public uint RecommandLocalizeEtcId { get; set; }
  public List<Plana.FlatData.ParcelType> BonusParcelType { get; set; }
...
static public class ConquestGroupBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*School_*/, 4 /*Plana.FlatData.School*/, false)
      && verifier.VerifyField(tablePos, 8 /*RecommandLocalizeEtcId*/, 4 /*uint*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 10 /*BonusParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
