...
public struct ConstEventCommonExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity CardShopProbWeightRarity { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Rarity.N; } }
  ...
  public static Offset<Plana.FlatData.ConstEventCommonExcel> CreateConstEventCommonExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.Rarity CardShopProbWeightRarity = Plana.FlatData.Rarity.N,
  ...
  public static void AddCardShopProbWeightRarity(FlatBufferBuilder builder, Plana.FlatData.Rarity cardShopProbWeightRarity) { builder.AddInt(5, (int)cardShopProbWeightRarity, 0); }
  ...
  public static Offset<Plana.FlatData.ConstEventCommonExcel> EndConstEventCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConstEventCommonExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConstEventCommonExcel> Pack(FlatBufferBuilder builder, ConstEventCommonExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConstEventCommonExcel>);
...
public class ConstEventCommonExcelT
{
  ...
  public Plana.FlatData.Rarity CardShopProbWeightRarity { get; set; }
  ...
  public ConstEventCommonExcelT() {
    ...
    this.CardShopProbWeightRarity = Plana.FlatData.Rarity.N;
...
static public class ConstEventCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*CardShopProbWeightRarity*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
