...
public struct WeekDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.WeekDungeonType DungeonType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeekDungeonType.None; } }
  ...
  public static Offset<Plana.FlatData.WeekDungeonRewardExcel> CreateWeekDungeonRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      Plana.FlatData.WeekDungeonType DungeonType = Plana.FlatData.WeekDungeonType.None,
  ...
  public static void AddDungeonType(FlatBufferBuilder builder, Plana.FlatData.WeekDungeonType dungeonType) { builder.AddInt(1, (int)dungeonType, 0); }
  ...
  public static Offset<Plana.FlatData.WeekDungeonRewardExcel> EndWeekDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WeekDungeonRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.WeekDungeonRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WeekDungeonRewardExcel>);
...
public class WeekDungeonRewardExcelT
{
  ...
  public Plana.FlatData.WeekDungeonType DungeonType { get; set; }
  ...
  public WeekDungeonRewardExcelT() {
    this.GroupId = 0;
    this.DungeonType = Plana.FlatData.WeekDungeonType.None;
...
static public class WeekDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*DungeonType*/, 4 /*Plana.FlatData.WeekDungeonType*/, 4, false)
