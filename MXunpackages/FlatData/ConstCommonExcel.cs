...
public struct ConstCommonExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType AcademyEnterCostType { get { int o = __p.__offset(80); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.ShopCategoryType TutorialShopCategoryType { get { int o = __p.__offset(134); return o != 0 ? (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopCategoryType.General; } }
  ...
  public Plana.FlatData.ParcelType RaidEnterCostType { get { int o = __p.__offset(204); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.ParcelType TimeAttackDungeonEnterCostType { get { int o = __p.__offset(214); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.Tag CommonFavorItemTags(int j) { int o = __p.__offset(224); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int CommonFavorItemTagsLength { get { int o = __p.__offset(224); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetCommonFavorItemTagsBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(224, 4); }
#else
  public ArraySegment<byte>? GetCommonFavorItemTagsBytes() { return __p.__vector_as_arraysegment(224); }
#endif
  public Plana.FlatData.Tag[] GetCommonFavorItemTagsArray() { int o = __p.__offset(224); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType BirthdayMailParcelType { get { int o = __p.__offset(292); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public long CafeRandomVisitMinComfortBonus { get { int o = __p.__offset(320); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public int CafeRandomVisitMinLastLogin { get { int o = __p.__offset(322); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int CafeTravelSyncIntervalByMillisec { get { int o = __p.__offset(324); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static void StartConstCommonExcel(FlatBufferBuilder builder) { builder.StartTable(161); }
  ...
  public static void AddAcademyEnterCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType academyEnterCostType) { builder.AddInt(38, (int)academyEnterCostType, 0); }
  ...
  public static void AddTutorialShopCategoryType(FlatBufferBuilder builder, Plana.FlatData.ShopCategoryType tutorialShopCategoryType) { builder.AddInt(65, (int)tutorialShopCategoryType, 0); }
  ...
  public static void AddRaidEnterCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType raidEnterCostType) { builder.AddInt(100, (int)raidEnterCostType, 0); }
  ...
  public static void AddTimeAttackDungeonEnterCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType timeAttackDungeonEnterCostType) { builder.AddInt(105, (int)timeAttackDungeonEnterCostType, 0); }
  ...
  public static void AddBirthdayMailParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType birthdayMailParcelType) { builder.AddInt(144, (int)birthdayMailParcelType, 0); }
  ...
  public static void AddCafeRandomVisitMinComfortBonus(FlatBufferBuilder builder, long cafeRandomVisitMinComfortBonus) { builder.AddLong(158, cafeRandomVisitMinComfortBonus, 0); }
  public static void AddCafeRandomVisitMinLastLogin(FlatBufferBuilder builder, int cafeRandomVisitMinLastLogin) { builder.AddInt(159, cafeRandomVisitMinLastLogin, 0); }
  public static void AddCafeTravelSyncIntervalByMillisec(FlatBufferBuilder builder, int cafeTravelSyncIntervalByMillisec) { builder.AddInt(160, cafeTravelSyncIntervalByMillisec, 0); }
  ...
  public void UnPackTo(ConstCommonExcelT _o) {
    ...
    _o.CafeRandomVisitMinComfortBonus = TableEncryptionService.Convert(this.CafeRandomVisitMinComfortBonus, key);
    _o.CafeRandomVisitMinLastLogin = TableEncryptionService.Convert(this.CafeRandomVisitMinLastLogin, key);
    _o.CafeTravelSyncIntervalByMillisec = TableEncryptionService.Convert(this.CafeTravelSyncIntervalByMillisec, key);
  }
...
static public class ConstCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 80 /*AcademyEnterCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 134 /*TutorialShopCategoryType*/, 4 /*Plana.FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 204 /*RaidEnterCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 214 /*TimeAttackDungeonEnterCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 224 /*CommonFavorItemTags*/, 4 /*Plana.FlatData.Tag*/, false)
      ...
      && verifier.VerifyField(tablePos, 292 /*BirthdayMailParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 320 /*CafeRandomVisitMinComfortBonus*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 322 /*CafeRandomVisitMinLastLogin*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 324 /*CafeTravelSyncIntervalByMillisec*/, 4 /*int*/, 4, false)
