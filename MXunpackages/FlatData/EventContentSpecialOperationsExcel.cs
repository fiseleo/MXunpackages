...
public struct EventContentSpecialOperationsExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentSpecialOperationsExcel> CreateEventContentSpecialOperationsExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentSpecialOperationsExcel> EndEventContentSpecialOperationsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentSpecialOperationsExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentSpecialOperationsExcel> Pack(FlatBufferBuilder builder, EventContentSpecialOperationsExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentSpecialOperationsExcel>);
