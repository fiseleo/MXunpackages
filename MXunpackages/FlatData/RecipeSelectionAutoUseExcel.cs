...
public struct RecipeSelectionAutoUseExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ParcelType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.RecipeSelectionAutoUseExcel> CreateRecipeSelectionAutoUseExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    RecipeSelectionAutoUseExcel.AddParcelType_(builder, ParcelType_);
  ...
  public static void AddParcelType_(FlatBufferBuilder builder, Plana.FlatData.ParcelType parcelType_) { builder.AddInt(1, (int)parcelType_, 0); }
  ...
  public static Offset<Plana.FlatData.RecipeSelectionAutoUseExcel> EndRecipeSelectionAutoUseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RecipeSelectionAutoUseExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RecipeSelectionAutoUseExcel> Pack(FlatBufferBuilder builder, RecipeSelectionAutoUseExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RecipeSelectionAutoUseExcel>);
...
static public class RecipeSelectionAutoUseExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ParcelType_*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
