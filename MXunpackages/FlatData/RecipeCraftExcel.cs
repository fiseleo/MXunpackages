...
public struct RecipeCraftExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RecipeType RecipeType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.RecipeType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RecipeType.None; } }
  ...
  public static void AddRecipeType(FlatBufferBuilder builder, Plana.FlatData.RecipeType recipeType) { builder.AddInt(2, (int)recipeType, 0); }
...
static public class RecipeCraftExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*RecipeType*/, 4 /*Plana.FlatData.RecipeType*/, 4, false)
