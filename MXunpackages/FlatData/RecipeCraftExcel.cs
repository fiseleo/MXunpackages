...
public struct RecipeCraftExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RecipeType RecipeType_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.RecipeType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RecipeType.None; } }
  ...
  public Plana.FlatData.ParcelType ParcelType_(int j) { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int ParcelType_Length { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetParcelType_Bytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(14, 4); }
#else
  public ArraySegment<byte>? GetParcelType_Bytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Plana.FlatData.ParcelType[] GetParcelType_Array() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.RecipeCraftExcel> CreateRecipeCraftExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRecipeType_(FlatBufferBuilder builder, Plana.FlatData.RecipeType recipeType_) { builder.AddInt(2, (int)recipeType_, 0); }
  ...
  public static Offset<Plana.FlatData.RecipeCraftExcel> EndRecipeCraftExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RecipeCraftExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RecipeCraftExcel> Pack(FlatBufferBuilder builder, RecipeCraftExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RecipeCraftExcel>);
...
static public class RecipeCraftExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*RecipeType_*/, 4 /*Plana.FlatData.RecipeType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*ParcelType_*/, 4 /*Plana.FlatData.ParcelType*/, false)
