...
public struct AniEventData : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AniEventData> CreateAniEventData(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.AniEventData> EndAniEventData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AniEventData>(o);
  }
  ...
  public void UnPackTo(AniEventDataT _o) {
        byte[] key = TableEncryptionService.CreateKey("AniEventDataT");
  ...
  public static Offset<Plana.FlatData.AniEventData> Pack(FlatBufferBuilder builder, AniEventDataT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AniEventData>);
