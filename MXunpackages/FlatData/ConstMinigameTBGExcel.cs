...
public struct ConstMinigameTBGExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConstMinigameTBGExcel> CreateConstMinigameTBGExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ConstMinigameTBGExcel> EndConstMinigameTBGExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConstMinigameTBGExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConstMinigameTBGExcel> Pack(FlatBufferBuilder builder, ConstMinigameTBGExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConstMinigameTBGExcel>);
