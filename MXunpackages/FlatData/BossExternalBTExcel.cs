...
public struct BossExternalBTExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ExternalBTNodeType ExternalBTNodeType_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ExternalBTNodeType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ExternalBTNodeType.Sequence; } }
  public Plana.FlatData.ExternalBTTrigger ExternalBTTrigger_ { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ExternalBTTrigger)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ExternalBTTrigger.None; } }
  ...
  public Plana.FlatData.ExternalBehavior ExternalBehavior_ { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ExternalBehavior)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ExternalBehavior.UseNextExSkill; } }
  ...
  public static Offset<Plana.FlatData.BossExternalBTExcel> CreateBossExternalBTExcel(FlatBufferBuilder builder,
      long ExternalBTId = 0,
      long AIPhase = 0,
      Plana.FlatData.ExternalBTNodeType ExternalBTNodeType_ = Plana.FlatData.ExternalBTNodeType.Sequence,
      Plana.FlatData.ExternalBTTrigger ExternalBTTrigger_ = Plana.FlatData.ExternalBTTrigger.None,
      StringOffset TriggerArgumentOffset = default(StringOffset),
      long BehaviorRate = 0,
      Plana.FlatData.ExternalBehavior ExternalBehavior_ = Plana.FlatData.ExternalBehavior.UseNextExSkill,
  ...
  public static void AddExternalBTNodeType_(FlatBufferBuilder builder, Plana.FlatData.ExternalBTNodeType externalBTNodeType_) { builder.AddInt(2, (int)externalBTNodeType_, 0); }
  public static void AddExternalBTTrigger_(FlatBufferBuilder builder, Plana.FlatData.ExternalBTTrigger externalBTTrigger_) { builder.AddInt(3, (int)externalBTTrigger_, 0); }
  ...
  public static void AddExternalBehavior_(FlatBufferBuilder builder, Plana.FlatData.ExternalBehavior externalBehavior_) { builder.AddInt(6, (int)externalBehavior_, 0); }
...
public class BossExternalBTExcelT
{
  ...
  public Plana.FlatData.ExternalBTNodeType ExternalBTNodeType_ { get; set; }
  public Plana.FlatData.ExternalBTTrigger ExternalBTTrigger_ { get; set; }
  public string TriggerArgument { get; set; }
  public long BehaviorRate { get; set; }
  public Plana.FlatData.ExternalBehavior ExternalBehavior_ { get; set; }
  public string BehaviorArgument { get; set; }

  public BossExternalBTExcelT() {
    this.ExternalBTId = 0;
    this.AIPhase = 0;
    this.ExternalBTNodeType_ = Plana.FlatData.ExternalBTNodeType.Sequence;
    this.ExternalBTTrigger_ = Plana.FlatData.ExternalBTTrigger.None;
    this.TriggerArgument = null;
    this.BehaviorRate = 0;
    this.ExternalBehavior_ = Plana.FlatData.ExternalBehavior.UseNextExSkill;
...
static public class BossExternalBTExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ExternalBTNodeType_*/, 4 /*Plana.FlatData.ExternalBTNodeType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*ExternalBTTrigger_*/, 4 /*Plana.FlatData.ExternalBTTrigger*/, 4, false)
      && verifier.VerifyString(tablePos, 12 /*TriggerArgument*/, false)
      && verifier.VerifyField(tablePos, 14 /*BehaviorRate*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 16 /*ExternalBehavior_*/, 4 /*Plana.FlatData.ExternalBehavior*/, 4, false)
