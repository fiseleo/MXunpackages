...
public struct AttendanceRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AttendanceRewardExcel> CreateAttendanceRewardExcel(FlatBufferBuilder builder,
      long AttendanceId = 0,
      long Day = 0,
  ...
  public static Offset<Plana.FlatData.AttendanceRewardExcel> EndAttendanceRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AttendanceRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AttendanceRewardExcel> Pack(FlatBufferBuilder builder, AttendanceRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AttendanceRewardExcel>);
