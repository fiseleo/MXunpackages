...
public struct EventContentExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentExcel> CreateEventContentExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.EventContentExcel> EndEventContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentExcel> Pack(FlatBufferBuilder builder, EventContentExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentExcel>);
