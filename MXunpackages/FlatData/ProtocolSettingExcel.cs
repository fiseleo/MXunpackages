...
public struct ProtocolSettingExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.OpenConditionContent OpenConditionContent { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.OpenConditionContent.Shop; } }
  ...
  public static void AddOpenConditionContent(FlatBufferBuilder builder, Plana.FlatData.OpenConditionContent openConditionContent) { builder.AddInt(1, (int)openConditionContent, 0); }
...
static public class ProtocolSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*OpenConditionContent*/, 4 /*Plana.FlatData.OpenConditionContent*/, 4, false)
