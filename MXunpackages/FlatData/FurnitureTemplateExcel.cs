...
public struct FurnitureTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.FurnitureTemplateExcel> CreateFurnitureTemplateExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.FurnitureTemplateExcel> EndFurnitureTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FurnitureTemplateExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FurnitureTemplateExcel> Pack(FlatBufferBuilder builder, FurnitureTemplateExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FurnitureTemplateExcel>);
