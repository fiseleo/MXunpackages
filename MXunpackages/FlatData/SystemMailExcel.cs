...
public struct SystemMailExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MailType MailType { get { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.MailType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MailType.System; } }
  ...
  public static void AddMailType(FlatBufferBuilder builder, Plana.FlatData.MailType mailType) { builder.AddInt(0, (int)mailType, 0); }
...
static public class SystemMailExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*MailType*/, 4 /*Plana.FlatData.MailType*/, 4, false)
