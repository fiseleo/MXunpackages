...
public struct MiniGameDreamScheduleExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameDreamScheduleExcel> CreateMiniGameDreamScheduleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.MiniGameDreamScheduleExcel> EndMiniGameDreamScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamScheduleExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamScheduleExcel> Pack(FlatBufferBuilder builder, MiniGameDreamScheduleExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamScheduleExcel>);
