...
public struct CharacterExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity Rarity { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Rarity.N; } }
  public bool IsNPC { get { int o = __p.__offset(28); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public Plana.FlatData.TacticEntityType TacticEntityType { get { int o = __p.__offset(30); return o != 0 ? (Plana.FlatData.TacticEntityType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticEntityType.None; } }
  ...
  public Plana.FlatData.TacticRole TacticRole { get { int o = __p.__offset(38); return o != 0 ? (Plana.FlatData.TacticRole)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticRole.None; } }
  public Plana.FlatData.WeaponType WeaponType { get { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeaponType.None; } }
  public Plana.FlatData.TacticRange TacticRange { get { int o = __p.__offset(42); return o != 0 ? (Plana.FlatData.TacticRange)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticRange.Back; } }
  public Plana.FlatData.BulletType BulletType { get { int o = __p.__offset(44); return o != 0 ? (Plana.FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.BulletType.Normal; } }
  public Plana.FlatData.ArmorType ArmorType { get { int o = __p.__offset(46); return o != 0 ? (Plana.FlatData.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ArmorType.LightArmor; } }
  public Plana.FlatData.AimIKType AimIKType { get { int o = __p.__offset(48); return o != 0 ? (Plana.FlatData.AimIKType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.AimIKType.None; } }
  public Plana.FlatData.School School { get { int o = __p.__offset(50); return o != 0 ? (Plana.FlatData.School)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.School.None; } }
  public Plana.FlatData.Club Club { get { int o = __p.__offset(52); return o != 0 ? (Plana.FlatData.Club)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Club.None; } }
  ...
  public Plana.FlatData.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(58); return o != 0 ? (Plana.FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatLevelUpType.Standard; } }
  public Plana.FlatData.SquadType SquadType { get { int o = __p.__offset(60); return o != 0 ? (Plana.FlatData.SquadType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.SquadType.None; } }
  ...
  public Plana.FlatData.EquipmentCategory EquipmentSlot(int j) { int o = __p.__offset(80); return o != 0 ? (Plana.FlatData.EquipmentCategory)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.EquipmentCategory)0; }
  public int EquipmentSlotLength { get { int o = __p.__offset(80); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.EquipmentCategory> GetEquipmentSlotBytes() { return __p.__vector_as_span<Plana.FlatData.EquipmentCategory>(80, 4); }
#else
  public ArraySegment<byte>? GetEquipmentSlotBytes() { return __p.__vector_as_arraysegment(80); }
#endif
  public Plana.FlatData.EquipmentCategory[] GetEquipmentSlotArray() { int o = __p.__offset(80); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.EquipmentCategory[] a = new Plana.FlatData.EquipmentCategory[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.EquipmentCategory)__p.bb.GetInt(p + i * 4); } return a; }
...
#endif
  public Plana.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(120); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.CharacterExcel> CreateCharacterExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      bool IsDummy = false,
      int SubPartsCount = 0,
      Plana.FlatData.TacticRole TacticRole = Plana.FlatData.TacticRole.None,
      Plana.FlatData.WeaponType WeaponType = Plana.FlatData.WeaponType.None,
      Plana.FlatData.TacticRange TacticRange = Plana.FlatData.TacticRange.Back,
      Plana.FlatData.BulletType BulletType = Plana.FlatData.BulletType.Normal,
      Plana.FlatData.ArmorType ArmorType = Plana.FlatData.ArmorType.LightArmor,
      Plana.FlatData.AimIKType AimIKType = Plana.FlatData.AimIKType.None,
      Plana.FlatData.School School = Plana.FlatData.School.None,
      Plana.FlatData.Club Club = Plana.FlatData.Club.None,
      int DefaultStarGrade = 0,
      int MaxStarGrade = 0,
      Plana.FlatData.StatLevelUpType StatLevelUpType = Plana.FlatData.StatLevelUpType.Standard,
      Plana.FlatData.SquadType SquadType = Plana.FlatData.SquadType.None,
      bool Jumpable = false,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Plana.FlatData.Rarity rarity) { builder.AddInt(11, (int)rarity, 0); }
  public static void AddIsNPC(FlatBufferBuilder builder, bool isNPC) { builder.AddBool(12, isNPC, false); }
  public static void AddTacticEntityType(FlatBufferBuilder builder, Plana.FlatData.TacticEntityType tacticEntityType) { builder.AddInt(13, (int)tacticEntityType, 0); }
  ...
  public static void AddTacticRole(FlatBufferBuilder builder, Plana.FlatData.TacticRole tacticRole) { builder.AddInt(17, (int)tacticRole, 0); }
  public static void AddWeaponType(FlatBufferBuilder builder, Plana.FlatData.WeaponType weaponType) { builder.AddInt(18, (int)weaponType, 0); }
  public static void AddTacticRange(FlatBufferBuilder builder, Plana.FlatData.TacticRange tacticRange) { builder.AddInt(19, (int)tacticRange, 0); }
  public static void AddBulletType(FlatBufferBuilder builder, Plana.FlatData.BulletType bulletType) { builder.AddInt(20, (int)bulletType, 0); }
  public static void AddArmorType(FlatBufferBuilder builder, Plana.FlatData.ArmorType armorType) { builder.AddInt(21, (int)armorType, 0); }
  public static void AddAimIKType(FlatBufferBuilder builder, Plana.FlatData.AimIKType aimIKType) { builder.AddInt(22, (int)aimIKType, 0); }
  public static void AddSchool(FlatBufferBuilder builder, Plana.FlatData.School school) { builder.AddInt(23, (int)school, 0); }
  public static void AddClub(FlatBufferBuilder builder, Plana.FlatData.Club club) { builder.AddInt(24, (int)club, 0); }
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Plana.FlatData.StatLevelUpType statLevelUpType) { builder.AddInt(27, (int)statLevelUpType, 0); }
  public static void AddSquadType(FlatBufferBuilder builder, Plana.FlatData.SquadType squadType) { builder.AddInt(28, (int)squadType, 0); }
  ...
  public static VectorOffset CreateEquipmentSlotVector(FlatBufferBuilder builder, Plana.FlatData.EquipmentCategory[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEquipmentSlotVectorBlock(FlatBufferBuilder builder, Plana.FlatData.EquipmentCategory[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public void UnPackTo(CharacterExcelT _o) {
    ...
    _o.EquipmentSlot = new List<Plana.FlatData.EquipmentCategory>();
  ...
  public static Offset<Plana.FlatData.CharacterExcel> Pack(FlatBufferBuilder builder, CharacterExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterExcel>);
...
public class CharacterExcelT
{
  ...
  public Plana.FlatData.TacticRole TacticRole { get; set; }
  public Plana.FlatData.WeaponType WeaponType { get; set; }
  public Plana.FlatData.TacticRange TacticRange { get; set; }
  public Plana.FlatData.BulletType BulletType { get; set; }
  public Plana.FlatData.ArmorType ArmorType { get; set; }
  public Plana.FlatData.AimIKType AimIKType { get; set; }
  public Plana.FlatData.School School { get; set; }
  public Plana.FlatData.Club Club { get; set; }
  public int DefaultStarGrade { get; set; }
  public int MaxStarGrade { get; set; }
  public Plana.FlatData.StatLevelUpType StatLevelUpType { get; set; }
  public Plana.FlatData.SquadType SquadType { get; set; }
  ...
  public List<Plana.FlatData.EquipmentCategory> EquipmentSlot { get; set; }
  ...
  public CharacterExcelT() {
    ...
    this.TacticRole = Plana.FlatData.TacticRole.None;
    this.WeaponType = Plana.FlatData.WeaponType.None;
    this.TacticRange = Plana.FlatData.TacticRange.Back;
    this.BulletType = Plana.FlatData.BulletType.Normal;
    this.ArmorType = Plana.FlatData.ArmorType.LightArmor;
    this.AimIKType = Plana.FlatData.AimIKType.None;
    this.School = Plana.FlatData.School.None;
    this.Club = Plana.FlatData.Club.None;
    this.DefaultStarGrade = 0;
    this.MaxStarGrade = 0;
    this.StatLevelUpType = Plana.FlatData.StatLevelUpType.Standard;
    this.SquadType = Plana.FlatData.SquadType.None;
    this.Jumpable = false;
...
static public class CharacterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*Rarity*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
      && verifier.VerifyField(tablePos, 28 /*IsNPC*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 30 /*TacticEntityType*/, 4 /*Plana.FlatData.TacticEntityType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 38 /*TacticRole*/, 4 /*Plana.FlatData.TacticRole*/, 4, false)
      && verifier.VerifyField(tablePos, 40 /*WeaponType*/, 4 /*Plana.FlatData.WeaponType*/, 4, false)
      && verifier.VerifyField(tablePos, 42 /*TacticRange*/, 4 /*Plana.FlatData.TacticRange*/, 4, false)
      && verifier.VerifyField(tablePos, 44 /*BulletType*/, 4 /*Plana.FlatData.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 46 /*ArmorType*/, 4 /*Plana.FlatData.ArmorType*/, 4, false)
      && verifier.VerifyField(tablePos, 48 /*AimIKType*/, 4 /*Plana.FlatData.AimIKType*/, 4, false)
      && verifier.VerifyField(tablePos, 50 /*School*/, 4 /*Plana.FlatData.School*/, 4, false)
      && verifier.VerifyField(tablePos, 52 /*Club*/, 4 /*Plana.FlatData.Club*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 58 /*StatLevelUpType*/, 4 /*Plana.FlatData.StatLevelUpType*/, 4, false)
      && verifier.VerifyField(tablePos, 60 /*SquadType*/, 4 /*Plana.FlatData.SquadType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 80 /*EquipmentSlot*/, 4 /*Plana.FlatData.EquipmentCategory*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 120 /*Tags*/, 4 /*Plana.FlatData.Tag*/, false)
