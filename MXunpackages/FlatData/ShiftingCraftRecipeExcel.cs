...
public struct ShiftingCraftRecipeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ResultParcel { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.Tag IngredientTag(int j) { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int IngredientTagLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetIngredientTagBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetIngredientTagBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Plana.FlatData.Tag[] GetIngredientTagArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public long IngredientExp { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Plana.FlatData.ShiftingCraftRecipeExcel> CreateShiftingCraftRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
      long DisplayOrder = 0,
      int NotificationId = 0,
      Plana.FlatData.ParcelType ResultParcel = Plana.FlatData.ParcelType.None,
      long ResultId = 0,
      long ResultAmount = 0,
  ...
  public static void AddResultParcel(FlatBufferBuilder builder, Plana.FlatData.ParcelType resultParcel) { builder.AddInt(3, (int)resultParcel, 0); }
  ...
  public static VectorOffset CreateIngredientTagVector(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateIngredientTagVectorBlock(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientTagVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIngredientTagVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.ShiftingCraftRecipeExcel> EndShiftingCraftRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ShiftingCraftRecipeExcel>(o);
  }
  ...
  public void UnPackTo(ShiftingCraftRecipeExcelT _o) {
    ...
    _o.IngredientTag = new List<Plana.FlatData.Tag>();
  ...
  public static Offset<Plana.FlatData.ShiftingCraftRecipeExcel> Pack(FlatBufferBuilder builder, ShiftingCraftRecipeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ShiftingCraftRecipeExcel>);
...
public class ShiftingCraftRecipeExcelT
{
  ...
  public Plana.FlatData.ParcelType ResultParcel { get; set; }
  ...
  public List<Plana.FlatData.Tag> IngredientTag { get; set; }
  ...
  public ShiftingCraftRecipeExcelT() {
    ...
    this.ResultParcel = Plana.FlatData.ParcelType.None;
    this.ResultId = 0;
    this.ResultAmount = 0;
...
static public class ShiftingCraftRecipeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ResultParcel*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*IngredientTag*/, 4 /*Plana.FlatData.Tag*/, false)
