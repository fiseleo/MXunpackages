...
public struct ConquestPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConquestPlayGuideExcel> CreateConquestPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.ConquestPlayGuideExcel> EndConquestPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestPlayGuideExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestPlayGuideExcel> Pack(FlatBufferBuilder builder, ConquestPlayGuideExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestPlayGuideExcel>);
