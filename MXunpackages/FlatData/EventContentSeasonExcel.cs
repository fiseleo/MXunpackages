...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentType EventContentType_ { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentType.Stage; } }
  public Plana.FlatData.OpenConditionContent OpenConditionContent_ { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.OpenConditionContent.Shop; } }
  ...
  public Plana.FlatData.SubEventType SubEventType_ { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.SubEventType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.SubEventType.None; } }
  ...
  public Plana.FlatData.EventContentReleaseType EventContentReleaseType_ { get { int o = __p.__offset(66); return o != 0 ? (Plana.FlatData.EventContentReleaseType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentReleaseType.None; } }
  public long EventContentStageRewardIdPermanent { get { int o = __p.__offset(68); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.RewardTag RewardTagPermanent { get { int o = __p.__offset(70); return o != 0 ? (Plana.FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RewardTag.Default; } }
  ...
  public static Offset<Plana.FlatData.EventContentSeasonExcel> CreateEventContentSeasonExcel(FlatBufferBuilder builder,
      ...
      int IconOrder = 0,
      Plana.FlatData.SubEventType SubEventType_ = Plana.FlatData.SubEventType.None,
      bool SubEvent = false,
      long EventItemId = 0,
      long MainEventId = 0,
      ...
      Plana.FlatData.EventContentReleaseType EventContentReleaseType_ = Plana.FlatData.EventContentReleaseType.None,
  ...
  public static void AddEventContentType_(FlatBufferBuilder builder, Plana.FlatData.EventContentType eventContentType_) { builder.AddInt(4, (int)eventContentType_, 0); }
  public static void AddOpenConditionContent_(FlatBufferBuilder builder, Plana.FlatData.OpenConditionContent openConditionContent_) { builder.AddInt(5, (int)openConditionContent_, 0); }
  ...
  public static void AddSubEventType_(FlatBufferBuilder builder, Plana.FlatData.SubEventType subEventType_) { builder.AddInt(8, (int)subEventType_, 0); }
  ...
  public static void AddEventContentReleaseType_(FlatBufferBuilder builder, Plana.FlatData.EventContentReleaseType eventContentReleaseType_) { builder.AddInt(31, (int)eventContentReleaseType_, 0); }
  ...
  public static void AddRewardTagPermanent(FlatBufferBuilder builder, Plana.FlatData.RewardTag rewardTagPermanent) { builder.AddInt(33, (int)rewardTagPermanent, 0); }
...
public class EventContentSeasonExcelT
{
  ...
  public Plana.FlatData.SubEventType SubEventType_ { get; set; }
  ...
  public Plana.FlatData.EventContentReleaseType EventContentReleaseType_ { get; set; }
  ...
  public EventContentSeasonExcelT() {
    ...
    this.IconOrder = 0;
    this.SubEventType_ = Plana.FlatData.SubEventType.None;
    this.SubEvent = false;
    this.EventItemId = 0;
    this.MainEventId = 0;
    ...
    this.EventContentReleaseType_ = Plana.FlatData.EventContentReleaseType.None;
...
static public class EventContentSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*EventContentType_*/, 4 /*Plana.FlatData.EventContentType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*OpenConditionContent_*/, 4 /*Plana.FlatData.OpenConditionContent*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*EventDisplay*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*IconOrder*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*SubEventType_*/, 4 /*Plana.FlatData.SubEventType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 66 /*EventContentReleaseType_*/, 4 /*Plana.FlatData.EventContentReleaseType*/, 4, false)
      && verifier.VerifyField(tablePos, 68 /*EventContentStageRewardIdPermanent*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 70 /*RewardTagPermanent*/, 4 /*Plana.FlatData.RewardTag*/, 4, false)
