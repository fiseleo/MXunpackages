...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentType EventContentType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentType.Stage; } }
  public Plana.FlatData.OpenConditionContent OpenConditionContent { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.OpenConditionContent.Shop; } }
  ...
  public Plana.FlatData.SubEventType SubEventType { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.SubEventType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.SubEventType.None; } }
  ...
  public Plana.FlatData.EventContentReleaseType EventContentReleaseType { get { int o = __p.__offset(68); return o != 0 ? (Plana.FlatData.EventContentReleaseType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentReleaseType.None; } }
  public long EventContentStageRewardIdPermanent { get { int o = __p.__offset(70); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.RewardTag RewardTagPermanent { get { int o = __p.__offset(72); return o != 0 ? (Plana.FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RewardTag.Default; } }
  ...
  public static Offset<Plana.FlatData.EventContentSeasonExcel> CreateEventContentSeasonExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.OpenConditionContent OpenConditionContent = Plana.FlatData.OpenConditionContent.Shop,
      bool EventDisplay = false,
      int IconOrder = 0,
      Plana.FlatData.SubEventType SubEventType = Plana.FlatData.SubEventType.None,
      bool SubEvent = false,
      long EventItemId = 0,
      long MainEventId = 0,
      ...
      Plana.FlatData.EventContentReleaseType EventContentReleaseType = Plana.FlatData.EventContentReleaseType.None,
      long EventContentStageRewardIdPermanent = 0,
      Plana.FlatData.RewardTag RewardTagPermanent = Plana.FlatData.RewardTag.Default,
  ...
  public static void AddEventContentType(FlatBufferBuilder builder, Plana.FlatData.EventContentType eventContentType) { builder.AddInt(4, (int)eventContentType, 0); }
  public static void AddOpenConditionContent(FlatBufferBuilder builder, Plana.FlatData.OpenConditionContent openConditionContent) { builder.AddInt(5, (int)openConditionContent, 0); }
  ...
  public static void AddSubEventType(FlatBufferBuilder builder, Plana.FlatData.SubEventType subEventType) { builder.AddInt(8, (int)subEventType, 0); }
  ...
  public static void AddEventContentReleaseType(FlatBufferBuilder builder, Plana.FlatData.EventContentReleaseType eventContentReleaseType) { builder.AddInt(32, (int)eventContentReleaseType, 0); }
  ...
  public static void AddRewardTagPermanent(FlatBufferBuilder builder, Plana.FlatData.RewardTag rewardTagPermanent) { builder.AddInt(34, (int)rewardTagPermanent, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentSeasonExcel> EndEventContentSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentSeasonExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentSeasonExcel> Pack(FlatBufferBuilder builder, EventContentSeasonExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentSeasonExcel>);
...
public class EventContentSeasonExcelT
{
  ...
  public Plana.FlatData.OpenConditionContent OpenConditionContent { get; set; }
  public bool EventDisplay { get; set; }
  public int IconOrder { get; set; }
  public Plana.FlatData.SubEventType SubEventType { get; set; }
  ...
  public Plana.FlatData.EventContentReleaseType EventContentReleaseType { get; set; }
  public long EventContentStageRewardIdPermanent { get; set; }
  public Plana.FlatData.RewardTag RewardTagPermanent { get; set; }
  ...
  public EventContentSeasonExcelT() {
    ...
    this.OpenConditionContent = Plana.FlatData.OpenConditionContent.Shop;
    this.EventDisplay = false;
    this.IconOrder = 0;
    this.SubEventType = Plana.FlatData.SubEventType.None;
    this.SubEvent = false;
    this.EventItemId = 0;
    this.MainEventId = 0;
    ...
    this.EventContentReleaseType = Plana.FlatData.EventContentReleaseType.None;
    this.EventContentStageRewardIdPermanent = 0;
    this.RewardTagPermanent = Plana.FlatData.RewardTag.Default;
...
static public class EventContentSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*EventContentType*/, 4 /*Plana.FlatData.EventContentType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*OpenConditionContent*/, 4 /*Plana.FlatData.OpenConditionContent*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*EventDisplay*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*IconOrder*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*SubEventType*/, 4 /*Plana.FlatData.SubEventType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 68 /*EventContentReleaseType*/, 4 /*Plana.FlatData.EventContentReleaseType*/, 4, false)
      && verifier.VerifyField(tablePos, 70 /*EventContentStageRewardIdPermanent*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 72 /*RewardTagPermanent*/, 4 /*Plana.FlatData.RewardTag*/, 4, false)
