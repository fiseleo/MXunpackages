...
public struct ScenarioCharacterNameExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ScenarioCharacterShapes Shape { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ScenarioCharacterShapes)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ScenarioCharacterShapes.None; } }
  ...
  public static void AddShape(FlatBufferBuilder builder, Plana.FlatData.ScenarioCharacterShapes shape) { builder.AddInt(6, (int)shape, 0); }
...
static public class ScenarioCharacterNameExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*Shape*/, 4 /*Plana.FlatData.ScenarioCharacterShapes*/, 4, false)
