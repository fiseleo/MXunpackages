...
public struct LogicEffectCommonVisualExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EffectBone ParticleEnterSocket { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EffectBone.None; } }
  ...
  public Plana.FlatData.EffectBone ParticleLoopSocket { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EffectBone.None; } }
  ...
  public Plana.FlatData.EffectBone ParticleEndSocket { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EffectBone.None; } }
  ...
  public Plana.FlatData.EffectBone ParticleApplySocket { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EffectBone.None; } }
  ...
  public Plana.FlatData.EffectBone ParticleRemovedSocket { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EffectBone.None; } }

  public static Offset<Plana.FlatData.LogicEffectCommonVisualExcel> CreateLogicEffectCommonVisualExcel(FlatBufferBuilder builder,
      uint StringID = 0,
      ...
      Plana.FlatData.EffectBone ParticleEnterSocket = Plana.FlatData.EffectBone.None,
      StringOffset ParticleLoopPathOffset = default(StringOffset),
      Plana.FlatData.EffectBone ParticleLoopSocket = Plana.FlatData.EffectBone.None,
      StringOffset ParticleEndPathOffset = default(StringOffset),
      Plana.FlatData.EffectBone ParticleEndSocket = Plana.FlatData.EffectBone.None,
      StringOffset ParticleApplyPathOffset = default(StringOffset),
      Plana.FlatData.EffectBone ParticleApplySocket = Plana.FlatData.EffectBone.None,
      StringOffset ParticleRemovedPathOffset = default(StringOffset),
      Plana.FlatData.EffectBone ParticleRemovedSocket = Plana.FlatData.EffectBone.None) {
  ...
  public static void AddParticleEnterSocket(FlatBufferBuilder builder, Plana.FlatData.EffectBone particleEnterSocket) { builder.AddInt(4, (int)particleEnterSocket, 0); }
  ...
  public static void AddParticleLoopSocket(FlatBufferBuilder builder, Plana.FlatData.EffectBone particleLoopSocket) { builder.AddInt(6, (int)particleLoopSocket, 0); }
  ...
  public static void AddParticleEndSocket(FlatBufferBuilder builder, Plana.FlatData.EffectBone particleEndSocket) { builder.AddInt(8, (int)particleEndSocket, 0); }
  ...
  public static void AddParticleApplySocket(FlatBufferBuilder builder, Plana.FlatData.EffectBone particleApplySocket) { builder.AddInt(10, (int)particleApplySocket, 0); }
  ...
  public static void AddParticleRemovedSocket(FlatBufferBuilder builder, Plana.FlatData.EffectBone particleRemovedSocket) { builder.AddInt(12, (int)particleRemovedSocket, 0); }
  public static Offset<Plana.FlatData.LogicEffectCommonVisualExcel> EndLogicEffectCommonVisualExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.LogicEffectCommonVisualExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.LogicEffectCommonVisualExcel> Pack(FlatBufferBuilder builder, LogicEffectCommonVisualExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.LogicEffectCommonVisualExcel>);
...
public class LogicEffectCommonVisualExcelT
{
  ...
  public Plana.FlatData.EffectBone ParticleEnterSocket { get; set; }
  public string ParticleLoopPath { get; set; }
  public Plana.FlatData.EffectBone ParticleLoopSocket { get; set; }
  public string ParticleEndPath { get; set; }
  public Plana.FlatData.EffectBone ParticleEndSocket { get; set; }
  public string ParticleApplyPath { get; set; }
  public Plana.FlatData.EffectBone ParticleApplySocket { get; set; }
  public string ParticleRemovedPath { get; set; }
  public Plana.FlatData.EffectBone ParticleRemovedSocket { get; set; }
  ...
  public LogicEffectCommonVisualExcelT() {
    ...
    this.ParticleEnterSocket = Plana.FlatData.EffectBone.None;
    this.ParticleLoopPath = null;
    this.ParticleLoopSocket = Plana.FlatData.EffectBone.None;
    this.ParticleEndPath = null;
    this.ParticleEndSocket = Plana.FlatData.EffectBone.None;
    this.ParticleApplyPath = null;
    this.ParticleApplySocket = Plana.FlatData.EffectBone.None;
    this.ParticleRemovedPath = null;
    this.ParticleRemovedSocket = Plana.FlatData.EffectBone.None;
  }
}
...
static public class LogicEffectCommonVisualExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ParticleEnterSocket*/, 4 /*Plana.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 14 /*ParticleLoopPath*/, false)
      && verifier.VerifyField(tablePos, 16 /*ParticleLoopSocket*/, 4 /*Plana.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 18 /*ParticleEndPath*/, false)
      && verifier.VerifyField(tablePos, 20 /*ParticleEndSocket*/, 4 /*Plana.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 22 /*ParticleApplyPath*/, false)
      && verifier.VerifyField(tablePos, 24 /*ParticleApplySocket*/, 4 /*Plana.FlatData.EffectBone*/, 4, false)
      && verifier.VerifyString(tablePos, 26 /*ParticleRemovedPath*/, false)
      && verifier.VerifyField(tablePos, 28 /*ParticleRemovedSocket*/, 4 /*Plana.FlatData.EffectBone*/, 4, false)
