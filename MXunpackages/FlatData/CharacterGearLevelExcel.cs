...
public struct CharacterGearLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterGearLevelExcel> CreateCharacterGearLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<Plana.FlatData.CharacterGearLevelExcel> EndCharacterGearLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterGearLevelExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterGearLevelExcel> Pack(FlatBufferBuilder builder, CharacterGearLevelExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterGearLevelExcel>);
