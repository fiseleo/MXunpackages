...
public struct NormalSkillTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.NormalSkillTemplateExcel> CreateNormalSkillTemplateExcel(FlatBufferBuilder builder,
      long Index = 0,
  ...
  public static Offset<Plana.FlatData.NormalSkillTemplateExcel> EndNormalSkillTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.NormalSkillTemplateExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.NormalSkillTemplateExcel> Pack(FlatBufferBuilder builder, NormalSkillTemplateExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.NormalSkillTemplateExcel>);
