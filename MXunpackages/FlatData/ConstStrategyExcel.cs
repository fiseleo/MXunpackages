...
public struct ConstStrategyExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CurrencyTypes HealCostType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CurrencyTypes.Invalid; } }
  ...
  public static Offset<Plana.FlatData.ConstStrategyExcel> CreateConstStrategyExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.CurrencyTypes HealCostType = Plana.FlatData.CurrencyTypes.Invalid,
  ...
  public static void AddHealCostType(FlatBufferBuilder builder, Plana.FlatData.CurrencyTypes healCostType) { builder.AddInt(5, (int)healCostType, 0); }
  ...
  public static Offset<Plana.FlatData.ConstStrategyExcel> EndConstStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConstStrategyExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConstStrategyExcel> Pack(FlatBufferBuilder builder, ConstStrategyExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConstStrategyExcel>);
...
public class ConstStrategyExcelT
{
  ...
  public Plana.FlatData.CurrencyTypes HealCostType { get; set; }
  ...
  public ConstStrategyExcelT() {
    ...
    this.HealCostType = Plana.FlatData.CurrencyTypes.Invalid;
...
static public class ConstStrategyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*HealCostType*/, 4 /*Plana.FlatData.CurrencyTypes*/, 4, false)
