...
public struct RaidStageSeasonRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.RaidStageSeasonRewardExcel> CreateRaidStageSeasonRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.RaidStageSeasonRewardExcel> EndRaidStageSeasonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RaidStageSeasonRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RaidStageSeasonRewardExcel> Pack(FlatBufferBuilder builder, RaidStageSeasonRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RaidStageSeasonRewardExcel>);
