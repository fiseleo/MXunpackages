...
public struct PresetCharacterGroupSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.PresetCharacterGroupSettingExcel> CreatePresetCharacterGroupSettingExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Plana.FlatData.PresetCharacterGroupSettingExcel> EndPresetCharacterGroupSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.PresetCharacterGroupSettingExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.PresetCharacterGroupSettingExcel> Pack(FlatBufferBuilder builder, PresetCharacterGroupSettingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.PresetCharacterGroupSettingExcel>);
