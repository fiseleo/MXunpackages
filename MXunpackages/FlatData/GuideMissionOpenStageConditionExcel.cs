...
public struct GuideMissionOpenStageConditionExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.GuideMissionOpenStageConditionExcel> CreateGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long OrderNumber = 0,
  ...
  public static Offset<Plana.FlatData.GuideMissionOpenStageConditionExcel> EndGuideMissionOpenStageConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GuideMissionOpenStageConditionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GuideMissionOpenStageConditionExcel> Pack(FlatBufferBuilder builder, GuideMissionOpenStageConditionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GuideMissionOpenStageConditionExcel>);
