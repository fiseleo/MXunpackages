...
public struct FixedEchelonSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.FixedEchelonSettingExcel> CreateFixedEchelonSettingExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.FixedEchelonSettingExcel> EndFixedEchelonSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FixedEchelonSettingExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FixedEchelonSettingExcel> Pack(FlatBufferBuilder builder, FixedEchelonSettingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FixedEchelonSettingExcel>);
