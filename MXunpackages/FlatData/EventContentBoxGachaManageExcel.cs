...
public struct EventContentBoxGachaManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaManageExcel> CreateEventContentBoxGachaManageExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaManageExcel> EndEventContentBoxGachaManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentBoxGachaManageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaManageExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaManageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentBoxGachaManageExcel>);
