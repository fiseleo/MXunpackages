...
public struct RaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.RaidStageRewardExcel> CreateRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.RaidStageRewardExcel> EndRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RaidStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RaidStageRewardExcel> Pack(FlatBufferBuilder builder, RaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RaidStageRewardExcel>);
