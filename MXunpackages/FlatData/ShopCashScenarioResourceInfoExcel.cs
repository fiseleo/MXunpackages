...
public struct ShopCashScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ShopCashScenarioResourceInfoExcel> CreateShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ShopCashScenarioResourceInfoExcel> EndShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ShopCashScenarioResourceInfoExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ShopCashScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ShopCashScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ShopCashScenarioResourceInfoExcel>);
