...
public struct ConquestCameraSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConquestCameraSettingExcel> CreateConquestCameraSettingExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.ConquestCameraSettingExcel> EndConquestCameraSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestCameraSettingExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestCameraSettingExcel> Pack(FlatBufferBuilder builder, ConquestCameraSettingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestCameraSettingExcel>);
