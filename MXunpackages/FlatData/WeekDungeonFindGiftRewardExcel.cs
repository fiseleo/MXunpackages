...
public struct WeekDungeonFindGiftRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.WeekDungeonFindGiftRewardExcel> CreateWeekDungeonFindGiftRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.WeekDungeonFindGiftRewardExcel> EndWeekDungeonFindGiftRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WeekDungeonFindGiftRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.WeekDungeonFindGiftRewardExcel> Pack(FlatBufferBuilder builder, WeekDungeonFindGiftRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WeekDungeonFindGiftRewardExcel>);
