...
public struct PickupDuplicateBonusExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopCategoryType ShopCategoryType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopCategoryType.General; } }
  ...
  public Plana.FlatData.ParcelType RewardParcelType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.PickupDuplicateBonusExcel> CreatePickupDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.ShopCategoryType ShopCategoryType_ = Plana.FlatData.ShopCategoryType.General,
      long ShopId = 0,
    ...
    PickupDuplicateBonusExcel.AddShopCategoryType_(builder, ShopCategoryType_);
  ...
  public static void AddShopCategoryType_(FlatBufferBuilder builder, Plana.FlatData.ShopCategoryType shopCategoryType_) { builder.AddInt(1, (int)shopCategoryType_, 0); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType rewardParcelType) { builder.AddInt(4, (int)rewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.PickupDuplicateBonusExcel> EndPickupDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.PickupDuplicateBonusExcel>(o);
  }
  ...
  public void UnPackTo(PickupDuplicateBonusExcelT _o) {
    ...
    _o.ShopCategoryType_ = TableEncryptionService.Convert(this.ShopCategoryType_, key);
  ...
  public static Offset<Plana.FlatData.PickupDuplicateBonusExcel> Pack(FlatBufferBuilder builder, PickupDuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.PickupDuplicateBonusExcel>);
    return CreatePickupDuplicateBonusExcel(
      builder,
      _o.Id,
      _o.ShopCategoryType_,
      _o.ShopId,
...
public class PickupDuplicateBonusExcelT
{
  ...
  public Plana.FlatData.ShopCategoryType ShopCategoryType_ { get; set; }
  ...
  public PickupDuplicateBonusExcelT() {
    this.Id = 0;
    this.ShopCategoryType_ = Plana.FlatData.ShopCategoryType.General;
    this.ShopId = 0;
...
static public class PickupDuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ShopCategoryType_*/, 4 /*Plana.FlatData.ShopCategoryType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*ShopId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 10 /*PickupCharacterId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*RewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
