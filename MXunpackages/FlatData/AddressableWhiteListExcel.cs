...
public struct AddressableWhiteListExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AddressableWhiteListExcel> CreateAddressableWhiteListExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.AddressableWhiteListExcel> EndAddressableWhiteListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AddressableWhiteListExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AddressableWhiteListExcel> Pack(FlatBufferBuilder builder, AddressableWhiteListExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AddressableWhiteListExcel>);
