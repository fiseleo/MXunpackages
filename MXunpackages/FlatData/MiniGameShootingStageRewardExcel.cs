...
public struct MiniGameShootingStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameShootingStageRewardExcel> CreateMiniGameShootingStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long RewardId = 0,
      long ClearSection = 0,
  ...
  public static Offset<Plana.FlatData.MiniGameShootingStageRewardExcel> EndMiniGameShootingStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameShootingStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameShootingStageRewardExcel> Pack(FlatBufferBuilder builder, MiniGameShootingStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameShootingStageRewardExcel>);
