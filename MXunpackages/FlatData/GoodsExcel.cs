...
public struct GoodsExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ConsumeParcelType(int j) { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int ConsumeParcelTypeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetConsumeParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(12, 4); }
#else
  public ArraySegment<byte>? GetConsumeParcelTypeBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Plana.FlatData.ParcelType[] GetConsumeParcelTypeArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ConsumeCondition ConsumeCondition_(int j) { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.ConsumeCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ConsumeCondition)0; }
  public int ConsumeCondition_Length { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ConsumeCondition> GetConsumeCondition_Bytes() { return __p.__vector_as_span<Plana.FlatData.ConsumeCondition>(18, 4); }
#else
  public ArraySegment<byte>? GetConsumeCondition_Bytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public Plana.FlatData.ConsumeCondition[] GetConsumeCondition_Array() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ConsumeCondition[] a = new Plana.FlatData.ConsumeCondition[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ConsumeCondition)__p.bb.GetInt(p + i * 4); } return a; }
  public Plana.FlatData.GachaTicketType ConsumeGachaTicketType { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.GachaTicketType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.GachaTicketType.None; } }
  ...
  public Plana.FlatData.ParcelType ParcelType_(int j) { int o = __p.__offset(38); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int ParcelType_Length { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetParcelType_Bytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(38, 4); }
#else
  public ArraySegment<byte>? GetParcelType_Bytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public Plana.FlatData.ParcelType[] GetParcelType_Array() { int o = __p.__offset(38); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.GoodsExcel> CreateGoodsExcel(FlatBufferBuilder builder,
      long Id = 0,
      int Type = 0,
      ...
      Plana.FlatData.GachaTicketType ConsumeGachaTicketType = Plana.FlatData.GachaTicketType.None,
  ...
  public static VectorOffset CreateConsumeParcelTypeVector(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateConsumeCondition_Vector(FlatBufferBuilder builder, Plana.FlatData.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeCondition_VectorBlock(FlatBufferBuilder builder, Plana.FlatData.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeCondition_VectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ConsumeCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeCondition_VectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ConsumeCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartConsumeCondition_Vector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddConsumeGachaTicketType(FlatBufferBuilder builder, Plana.FlatData.GachaTicketType consumeGachaTicketType) { builder.AddInt(8, (int)consumeGachaTicketType, 0); }
  ...
  public static void AddParcelType_(FlatBufferBuilder builder, VectorOffset parcelType_Offset) { builder.AddOffset(17, parcelType_Offset.Value, 0); }
  ...
  public static Offset<Plana.FlatData.GoodsExcel> EndGoodsExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GoodsExcel>(o);
  }
  ...
  public void UnPackTo(GoodsExcelT _o) {
    ...
    _o.ConsumeParcelType = new List<Plana.FlatData.ParcelType>();
    ...
    _o.ConsumeCondition_ = new List<Plana.FlatData.ConsumeCondition>();
    ...
    _o.ProductIdONE = TableEncryptionService.Convert(this.ProductIdONE, key);
    _o.ProductIdSGS = TableEncryptionService.Convert(this.ProductIdSGS, key);
  ...
  public static Offset<Plana.FlatData.GoodsExcel> Pack(FlatBufferBuilder builder, GoodsExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GoodsExcel>);
...
public class GoodsExcelT
{
  ...
  public List<Plana.FlatData.ParcelType> ConsumeParcelType { get; set; }
  public List<long> ConsumeParcelId { get; set; }
  public List<long> ConsumeParcelAmount { get; set; }
  public List<Plana.FlatData.ConsumeCondition> ConsumeCondition_ { get; set; }
  public Plana.FlatData.GachaTicketType ConsumeGachaTicketType { get; set; }
  ...
  public GoodsExcelT() {
    ...
    this.ConsumeGachaTicketType = Plana.FlatData.GachaTicketType.None;
...
static public class GoodsExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*ConsumeParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 18 /*ConsumeCondition_*/, 4 /*Plana.FlatData.ConsumeCondition*/, false)
      && verifier.VerifyField(tablePos, 20 /*ConsumeGachaTicketType*/, 4 /*Plana.FlatData.GachaTicketType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 32 /*ConsumeExtraStep*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfData(tablePos, 34 /*ConsumeExtraAmount*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 36 /*State*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 38 /*ParcelType_*/, 4 /*Plana.FlatData.ParcelType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 40 /*ParcelId*/, 8 /*long*/, false)
      && verifier.VerifyVectorOfData(tablePos, 42 /*ParcelAmount*/, 8 /*long*/, false)
