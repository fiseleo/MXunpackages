...
public struct WorldRaidBossGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.WorldRaidBossGroupExcel> CreateWorldRaidBossGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.WorldRaidBossGroupExcel> EndWorldRaidBossGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WorldRaidBossGroupExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidBossGroupExcelT _o) {
    ...
    _o.WorldBossHPTw = TableEncryptionService.Convert(this.WorldBossHPTw, key);
    _o.WorldBossHPAsia = TableEncryptionService.Convert(this.WorldBossHPAsia, key);
    _o.WorldBossHPNa = TableEncryptionService.Convert(this.WorldBossHPNa, key);
    _o.WorldBossHPGlobal = TableEncryptionService.Convert(this.WorldBossHPGlobal, key);
  ...
  public static Offset<Plana.FlatData.WorldRaidBossGroupExcel> Pack(FlatBufferBuilder builder, WorldRaidBossGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WorldRaidBossGroupExcel>);
