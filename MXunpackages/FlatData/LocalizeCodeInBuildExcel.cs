...
public struct LocalizeCodeInBuildExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.LocalizeCodeInBuildExcel> CreateLocalizeCodeInBuildExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<Plana.FlatData.LocalizeCodeInBuildExcel> EndLocalizeCodeInBuildExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.LocalizeCodeInBuildExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.LocalizeCodeInBuildExcel> Pack(FlatBufferBuilder builder, LocalizeCodeInBuildExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.LocalizeCodeInBuildExcel>);
