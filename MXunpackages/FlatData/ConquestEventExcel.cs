...
public struct ConquestEventExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ConquestEventType ConquestEventType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ConquestEventType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ConquestEventType.None; } }
  ...
  public static Offset<Plana.FlatData.ConquestEventExcel> CreateConquestEventExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.ConquestEventType ConquestEventType = Plana.FlatData.ConquestEventType.None,
  ...
  public static void AddConquestEventType(FlatBufferBuilder builder, Plana.FlatData.ConquestEventType conquestEventType) { builder.AddInt(2, (int)conquestEventType, 0); }
...
public class ConquestEventExcelT
{
  ...
  public Plana.FlatData.ConquestEventType ConquestEventType { get; set; }
  ...
  public ConquestEventExcelT() {
    ...
    this.ConquestEventType = Plana.FlatData.ConquestEventType.None;
...
static public class ConquestEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ConquestEventType*/, 4 /*Plana.FlatData.ConquestEventType*/, 4, false)
