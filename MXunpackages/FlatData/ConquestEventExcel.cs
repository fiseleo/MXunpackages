...
public struct ConquestEventExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ConquestEventType ConquestEventType_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ConquestEventType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ConquestEventType.None; } }
  ...
  public static Offset<Plana.FlatData.ConquestEventExcel> CreateConquestEventExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long MainStoryEventContentId = 0,
      Plana.FlatData.ConquestEventType ConquestEventType_ = Plana.FlatData.ConquestEventType.None,
  ...
  public static void AddConquestEventType_(FlatBufferBuilder builder, Plana.FlatData.ConquestEventType conquestEventType_) { builder.AddInt(2, (int)conquestEventType_, 0); }
  ...
  public static Offset<Plana.FlatData.ConquestEventExcel> EndConquestEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestEventExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestEventExcel> Pack(FlatBufferBuilder builder, ConquestEventExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestEventExcel>);
...
public class ConquestEventExcelT
{
  ...
  public Plana.FlatData.ConquestEventType ConquestEventType_ { get; set; }
  ...
  public ConquestEventExcelT() {
    ...
    this.ConquestEventType_ = Plana.FlatData.ConquestEventType.None;
...
static public class ConquestEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ConquestEventType_*/, 4 /*Plana.FlatData.ConquestEventType*/, 4, false)
