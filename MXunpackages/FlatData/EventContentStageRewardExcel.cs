...
public struct EventContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentStageRewardExcel> CreateEventContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.EventContentStageRewardExcel> EndEventContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentStageRewardExcel> Pack(FlatBufferBuilder builder, EventContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentStageRewardExcel>);
