...
public struct GroundModuleRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType RewardParcelType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.GroundModuleRewardExcel> CreateGroundModuleRewardExcel(FlatBufferBuilder builder,
      uint GroupId = 0,
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType rewardParcelType) { builder.AddInt(1, (int)rewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.GroundModuleRewardExcel> EndGroundModuleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GroundModuleRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GroundModuleRewardExcel> Pack(FlatBufferBuilder builder, GroundModuleRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GroundModuleRewardExcel>);
...
static public class GroundModuleRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
