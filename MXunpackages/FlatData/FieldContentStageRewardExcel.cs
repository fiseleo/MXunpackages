...
public struct FieldContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.FieldContentStageRewardExcel> CreateFieldContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.FieldContentStageRewardExcel> EndFieldContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FieldContentStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FieldContentStageRewardExcel> Pack(FlatBufferBuilder builder, FieldContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FieldContentStageRewardExcel>);
