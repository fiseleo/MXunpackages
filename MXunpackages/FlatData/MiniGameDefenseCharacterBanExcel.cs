...
public struct MiniGameDefenseCharacterBanExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameDefenseCharacterBanExcel> CreateMiniGameDefenseCharacterBanExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.MiniGameDefenseCharacterBanExcel> EndMiniGameDefenseCharacterBanExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDefenseCharacterBanExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameDefenseCharacterBanExcel> Pack(FlatBufferBuilder builder, MiniGameDefenseCharacterBanExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDefenseCharacterBanExcel>);
