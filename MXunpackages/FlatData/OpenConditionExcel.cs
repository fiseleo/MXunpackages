...
public struct OpenConditionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.OpenConditionContent OpenConditionContentType { get { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.OpenConditionContent.Shop; } }
  ...
  public Plana.FlatData.MultipleConditionCheckType MultipleConditionCheckType_ { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MultipleConditionCheckType.And; } }
  public Plana.FlatData.WeekDay OpenDayOfWeek { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeekDay.Sunday; } }
  public long OpenHour { get { int o = __p.__offset(28); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.WeekDay CloseDayOfWeek { get { int o = __p.__offset(30); return o != 0 ? (Plana.FlatData.WeekDay)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeekDay.Sunday; } }
  ...
  public static Offset<Plana.FlatData.OpenConditionExcel> CreateOpenConditionExcel(FlatBufferBuilder builder,
      Plana.FlatData.OpenConditionContent OpenConditionContentType = Plana.FlatData.OpenConditionContent.Shop,
      ...
      Plana.FlatData.WeekDay OpenDayOfWeek = Plana.FlatData.WeekDay.Sunday,
      long OpenHour = 0,
      Plana.FlatData.WeekDay CloseDayOfWeek = Plana.FlatData.WeekDay.Sunday,
      long CloseHour = 0,
      long OpenedCafeId = 0,
    ...
    OpenConditionExcel.AddMultipleConditionCheckType_(builder, MultipleConditionCheckType_);
  ...
  public static void AddOpenConditionContentType(FlatBufferBuilder builder, Plana.FlatData.OpenConditionContent openConditionContentType) { builder.AddInt(0, (int)openConditionContentType, 0); }
  ...
  public static void AddMultipleConditionCheckType_(FlatBufferBuilder builder, Plana.FlatData.MultipleConditionCheckType multipleConditionCheckType_) { builder.AddInt(10, (int)multipleConditionCheckType_, 0); }
  public static void AddOpenDayOfWeek(FlatBufferBuilder builder, Plana.FlatData.WeekDay openDayOfWeek) { builder.AddInt(11, (int)openDayOfWeek, 0); }
  public static void AddOpenHour(FlatBufferBuilder builder, long openHour) { builder.AddLong(12, openHour, 0); }
  public static void AddCloseDayOfWeek(FlatBufferBuilder builder, Plana.FlatData.WeekDay closeDayOfWeek) { builder.AddInt(13, (int)closeDayOfWeek, 0); }
  ...
  public static Offset<Plana.FlatData.OpenConditionExcel> EndOpenConditionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.OpenConditionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.OpenConditionExcel> Pack(FlatBufferBuilder builder, OpenConditionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.OpenConditionExcel>);
...
{
  public Plana.FlatData.OpenConditionContent OpenConditionContentType { get; set; }
  ...
  public Plana.FlatData.WeekDay OpenDayOfWeek { get; set; }
  public long OpenHour { get; set; }
  public Plana.FlatData.WeekDay CloseDayOfWeek { get; set; }
  ...
  public OpenConditionExcelT() {
    this.OpenConditionContentType = Plana.FlatData.OpenConditionContent.Shop;
    this.LockUI = null;
    ...
    this.OpenDayOfWeek = Plana.FlatData.WeekDay.Sunday;
    this.OpenHour = 0;
    this.CloseDayOfWeek = Plana.FlatData.WeekDay.Sunday;
    this.CloseHour = 0;
    this.OpenedCafeId = 0;
...
static public class OpenConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*OpenConditionContentType*/, 4 /*Plana.FlatData.OpenConditionContent*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*MultipleConditionCheckType_*/, 4 /*Plana.FlatData.MultipleConditionCheckType*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*OpenDayOfWeek*/, 4 /*Plana.FlatData.WeekDay*/, 4, false)
      && verifier.VerifyField(tablePos, 28 /*OpenHour*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 30 /*CloseDayOfWeek*/, 4 /*Plana.FlatData.WeekDay*/, 4, false)
