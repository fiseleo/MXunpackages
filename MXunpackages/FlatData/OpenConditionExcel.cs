...
public struct OpenConditionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MultipleConditionCheckType.And; } }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Plana.FlatData.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(10, (int)multipleConditionCheckType, 0); }
...
static public class OpenConditionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*MultipleConditionCheckType*/, 4 /*Plana.FlatData.MultipleConditionCheckType*/, 4, false)
