...
public struct EventContentScenarioExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentScenarioConditionType ScenarioConditionType { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.EventContentScenarioConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentScenarioConditionType.None; } }
  ...
  public Plana.FlatData.ParcelType CostParcelType { get { int o = __p.__offset(36); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.ParcelType RewardParcelType(int j) { int o = __p.__offset(42); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(42, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public Plana.FlatData.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(42); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.EventContentScenarioExcel> CreateEventContentScenarioExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Plana.FlatData.EventContentScenarioConditionType ScenarioConditionType = Plana.FlatData.EventContentScenarioConditionType.None,
  ...
  public static void AddScenarioConditionType(FlatBufferBuilder builder, Plana.FlatData.EventContentScenarioConditionType scenarioConditionType) { builder.AddInt(9, (int)scenarioConditionType, 0); }
  ...
  public static void AddCostParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType costParcelType) { builder.AddInt(16, (int)costParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentScenarioExcel> EndEventContentScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentScenarioExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentScenarioExcel> Pack(FlatBufferBuilder builder, EventContentScenarioExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentScenarioExcel>);
...
public class EventContentScenarioExcelT
{
  ...
  public Plana.FlatData.EventContentScenarioConditionType ScenarioConditionType { get; set; }
  ...
  public EventContentScenarioExcelT() {
    ...
    this.ScenarioConditionType = Plana.FlatData.EventContentScenarioConditionType.None;
...
static public class EventContentScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*ScenarioConditionType*/, 4 /*Plana.FlatData.EventContentScenarioConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*CostParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 38 /*CostId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 40 /*CostAmount*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 42 /*RewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
