...
public struct WorldRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.WorldRaidStageRewardExcel> CreateWorldRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.WorldRaidStageRewardExcel> EndWorldRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WorldRaidStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.WorldRaidStageRewardExcel> Pack(FlatBufferBuilder builder, WorldRaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WorldRaidStageRewardExcel>);
