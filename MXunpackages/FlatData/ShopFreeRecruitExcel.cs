...
public struct ShopFreeRecruitExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopFreeRecruitType FreeRecruitType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ShopFreeRecruitType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopFreeRecruitType.None; } }
  ...
  public static Offset<Plana.FlatData.ShopFreeRecruitExcel> CreateShopFreeRecruitExcel(FlatBufferBuilder builder,
      long Id = 0,
      StringOffset FreeRecruitPeriodFromOffset = default(StringOffset),
      StringOffset FreeRecruitPeriodToOffset = default(StringOffset),
      Plana.FlatData.ShopFreeRecruitType FreeRecruitType = Plana.FlatData.ShopFreeRecruitType.None,
  ...
  public static void AddFreeRecruitType(FlatBufferBuilder builder, Plana.FlatData.ShopFreeRecruitType freeRecruitType) { builder.AddInt(3, (int)freeRecruitType, 0); }
  ...
  public static Offset<Plana.FlatData.ShopFreeRecruitExcel> EndShopFreeRecruitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ShopFreeRecruitExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ShopFreeRecruitExcel> Pack(FlatBufferBuilder builder, ShopFreeRecruitExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ShopFreeRecruitExcel>);
...
public class ShopFreeRecruitExcelT
{
  ...
  public Plana.FlatData.ShopFreeRecruitType FreeRecruitType { get; set; }
  ...
  public ShopFreeRecruitExcelT() {
    ...
    this.FreeRecruitType = Plana.FlatData.ShopFreeRecruitType.None;
...
static public class ShopFreeRecruitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*FreeRecruitType*/, 4 /*Plana.FlatData.ShopFreeRecruitType*/, 4, false)
