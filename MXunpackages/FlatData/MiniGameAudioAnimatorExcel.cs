...
public struct MiniGameAudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameAudioAnimatorExcel> CreateMiniGameAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.MiniGameAudioAnimatorExcel> EndMiniGameAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameAudioAnimatorExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameAudioAnimatorExcel> Pack(FlatBufferBuilder builder, MiniGameAudioAnimatorExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameAudioAnimatorExcel>);
