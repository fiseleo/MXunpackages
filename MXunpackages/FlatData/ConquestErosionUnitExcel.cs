...
public struct ConquestErosionUnitExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConquestErosionUnitExcel> CreateConquestErosionUnitExcel(FlatBufferBuilder builder,
      long TilePrefabId = 0,
  ...
  public static Offset<Plana.FlatData.ConquestErosionUnitExcel> EndConquestErosionUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestErosionUnitExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestErosionUnitExcel> Pack(FlatBufferBuilder builder, ConquestErosionUnitExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestErosionUnitExcel>);
