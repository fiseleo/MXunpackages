...
public struct BossPhaseExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BossPhaseExcel> CreateBossPhaseExcel(FlatBufferBuilder builder,
      long Id = 0,
      long AIPhase = 0,
  ...
  public static Offset<Plana.FlatData.BossPhaseExcel> EndBossPhaseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BossPhaseExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BossPhaseExcel> Pack(FlatBufferBuilder builder, BossPhaseExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BossPhaseExcel>);
