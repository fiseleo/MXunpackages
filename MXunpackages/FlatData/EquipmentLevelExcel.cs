...
public struct EquipmentLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EquipmentLevelExcel> CreateEquipmentLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<Plana.FlatData.EquipmentLevelExcel> EndEquipmentLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EquipmentLevelExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EquipmentLevelExcel> Pack(FlatBufferBuilder builder, EquipmentLevelExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EquipmentLevelExcel>);
