...
public struct EventContentFortuneGachaModifyExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentFortuneGachaModifyExcel> CreateEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentFortuneGachaModifyExcel> EndEventContentFortuneGachaModifyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentFortuneGachaModifyExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentFortuneGachaModifyExcel> Pack(FlatBufferBuilder builder, EventContentFortuneGachaModifyExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentFortuneGachaModifyExcel>);
