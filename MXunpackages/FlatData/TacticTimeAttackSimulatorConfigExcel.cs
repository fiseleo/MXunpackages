...
public struct TacticTimeAttackSimulatorConfigExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.TacticTimeAttackSimulatorConfigExcel> CreateTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
  ...
  public static Offset<Plana.FlatData.TacticTimeAttackSimulatorConfigExcel> EndTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TacticTimeAttackSimulatorConfigExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TacticTimeAttackSimulatorConfigExcel> Pack(FlatBufferBuilder builder, TacticTimeAttackSimulatorConfigExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TacticTimeAttackSimulatorConfigExcel>);
