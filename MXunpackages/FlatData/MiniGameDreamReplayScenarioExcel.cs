...
public struct MiniGameDreamReplayScenarioExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameDreamReplayScenarioExcel> CreateMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.MiniGameDreamReplayScenarioExcel> EndMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamReplayScenarioExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamReplayScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamReplayScenarioExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamReplayScenarioExcel>);
