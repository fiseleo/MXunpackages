...
public struct MiniGameMissionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Plana.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(42); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(42, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public Plana.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(42); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(46); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(46); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(46, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(46); }
#endif
  public Plana.FlatData.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(46); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.MiniGameMissionExcel> CreateMiniGameMissionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Plana.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(15, (int)completeConditionType, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameMissionExcel> EndMiniGameMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameMissionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameMissionExcel> Pack(FlatBufferBuilder builder, MiniGameMissionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameMissionExcel>);
...
static public class MiniGameMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*CompleteConditionType*/, 4 /*Plana.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 42 /*CompleteConditionParameterTag*/, 4 /*Plana.FlatData.Tag*/, false)
      && verifier.VerifyString(tablePos, 44 /*RewardIcon*/, false)
      && verifier.VerifyVectorOfData(tablePos, 46 /*MissionRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
