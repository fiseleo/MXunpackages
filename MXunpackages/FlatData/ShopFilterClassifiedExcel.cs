...
public struct ShopFilterClassifiedExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ConsumeParcelType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  public long ConsumeParcelId { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.ShopFilterType ShopFilterType_ { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ShopFilterType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopFilterType.GachaTicket; } }
  public long GoodsId { get { int o = __p.__offset(14); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Plana.FlatData.ShopFilterClassifiedExcel> CreateShopFilterClassifiedExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.ShopCategoryType CategoryType = Plana.FlatData.ShopCategoryType.General,
      Plana.FlatData.ParcelType ConsumeParcelType = Plana.FlatData.ParcelType.None,
      long ConsumeParcelId = 0,
      Plana.FlatData.ShopFilterType ShopFilterType_ = Plana.FlatData.ShopFilterType.GachaTicket,
      long GoodsId = 0) {
    ...
    ShopFilterClassifiedExcel.AddShopFilterType_(builder, ShopFilterType_);
  ...
  public static void AddConsumeParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType consumeParcelType) { builder.AddInt(2, (int)consumeParcelType, 0); }
  public static void AddConsumeParcelId(FlatBufferBuilder builder, long consumeParcelId) { builder.AddLong(3, consumeParcelId, 0); }
  public static void AddShopFilterType_(FlatBufferBuilder builder, Plana.FlatData.ShopFilterType shopFilterType_) { builder.AddInt(4, (int)shopFilterType_, 0); }
  public static void AddGoodsId(FlatBufferBuilder builder, long goodsId) { builder.AddLong(5, goodsId, 0); }
  public static Offset<Plana.FlatData.ShopFilterClassifiedExcel> EndShopFilterClassifiedExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ShopFilterClassifiedExcel>(o);
  }
  ...
  public void UnPackTo(ShopFilterClassifiedExcelT _o) {
    ...
    _o.ShopFilterType_ = TableEncryptionService.Convert(this.ShopFilterType_, key);
    _o.GoodsId = TableEncryptionService.Convert(this.GoodsId, key);
  }
  public static Offset<Plana.FlatData.ShopFilterClassifiedExcel> Pack(FlatBufferBuilder builder, ShopFilterClassifiedExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ShopFilterClassifiedExcel>);
...
public class ShopFilterClassifiedExcelT
{
  ...
  public Plana.FlatData.ParcelType ConsumeParcelType { get; set; }
  public long ConsumeParcelId { get; set; }
  public Plana.FlatData.ShopFilterType ShopFilterType_ { get; set; }
  public long GoodsId { get; set; }

  public ShopFilterClassifiedExcelT() {
    this.Id = 0;
    this.CategoryType = Plana.FlatData.ShopCategoryType.General;
    this.ConsumeParcelType = Plana.FlatData.ParcelType.None;
    this.ConsumeParcelId = 0;
    this.ShopFilterType_ = Plana.FlatData.ShopFilterType.GachaTicket;
    this.GoodsId = 0;
  }
}
...
static public class ShopFilterClassifiedExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ConsumeParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*ConsumeParcelId*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*ShopFilterType_*/, 4 /*Plana.FlatData.ShopFilterType*/, 4, false)
