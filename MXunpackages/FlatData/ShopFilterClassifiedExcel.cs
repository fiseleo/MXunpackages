...
public struct ShopFilterClassifiedExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopFilterType ShopFilterType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ShopFilterType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopFilterType.GachaTicket; } }
  ...
  public static Offset<Plana.FlatData.ShopFilterClassifiedExcel> CreateShopFilterClassifiedExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.ShopFilterType ShopFilterType = Plana.FlatData.ShopFilterType.GachaTicket,
      long GoodsId = 0) {
  ...
  public static void AddShopFilterType(FlatBufferBuilder builder, Plana.FlatData.ShopFilterType shopFilterType) { builder.AddInt(4, (int)shopFilterType, 0); }
...
public class ShopFilterClassifiedExcelT
{
  ...
  public Plana.FlatData.ShopFilterType ShopFilterType { get; set; }
  ...
  public ShopFilterClassifiedExcelT() {
    ...
    this.ShopFilterType = Plana.FlatData.ShopFilterType.GachaTicket;
    this.GoodsId = 0;
  }
}
...
static public class ShopFilterClassifiedExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ShopFilterType*/, 4 /*Plana.FlatData.ShopFilterType*/, 4, false)
