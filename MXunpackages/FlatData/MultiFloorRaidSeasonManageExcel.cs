...
public struct MultiFloorRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidSeasonManageExcel> CreateMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidSeasonManageExcel> EndMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MultiFloorRaidSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(MultiFloorRaidSeasonManageExcelT _o) {
    ...
    _o.PlayTip = TableEncryptionService.Convert(this.PlayTip, key);
  }
  public static Offset<Plana.FlatData.MultiFloorRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MultiFloorRaidSeasonManageExcel>);
