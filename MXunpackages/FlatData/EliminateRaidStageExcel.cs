...
public struct EliminateRaidStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType RaidEnterCostType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.Difficulty Difficulty { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Difficulty.Normal; } }
  ...
  public Plana.FlatData.TacticEnvironment TacticEnvironment { get { int o = __p.__offset(44); return o != 0 ? (Plana.FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticEnvironment.None; } }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(80); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }

  public static Offset<Plana.FlatData.EliminateRaidStageExcel> CreateEliminateRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      bool UseBossIndex = false,
      bool UseBossAIPhaseSync = false,
      StringOffset RaidBossGroupOffset = default(StringOffset),
      Plana.FlatData.ParcelType RaidEnterCostType = Plana.FlatData.ParcelType.None,
      ...
      Plana.FlatData.Difficulty Difficulty = Plana.FlatData.Difficulty.Normal,
      bool IsOpen = false,
      ...
      Plana.FlatData.TacticEnvironment TacticEnvironment = Plana.FlatData.TacticEnvironment.None,
  ...
  public static void AddRaidEnterCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType raidEnterCostType) { builder.AddInt(4, (int)raidEnterCostType, 0); }
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Plana.FlatData.Difficulty difficulty) { builder.AddInt(12, (int)difficulty, 0); }
  ...
  public static void AddTacticEnvironment(FlatBufferBuilder builder, Plana.FlatData.TacticEnvironment tacticEnvironment) { builder.AddInt(20, (int)tacticEnvironment, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(38, (int)echelonExtensionType, 0); }
  public static Offset<Plana.FlatData.EliminateRaidStageExcel> EndEliminateRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EliminateRaidStageExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidStageExcelT _o) {
    ...
    _o.RaidEnterCostAmount = TableEncryptionService.Convert(this.RaidEnterCostAmount, key);
    _o.BossSpinePath = TableEncryptionService.Convert(this.BossSpinePath, key);
  ...
  public static Offset<Plana.FlatData.EliminateRaidStageExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EliminateRaidStageExcel>);
...
public class EliminateRaidStageExcelT
{
  ...
  public Plana.FlatData.Difficulty Difficulty { get; set; }
  ...
  public Plana.FlatData.TacticEnvironment TacticEnvironment { get; set; }
  ...
  public EliminateRaidStageExcelT() {
    ...
    this.Difficulty = Plana.FlatData.Difficulty.Normal;
    this.IsOpen = false;
    ...
    this.TacticEnvironment = Plana.FlatData.TacticEnvironment.None;
...
static public class EliminateRaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*RaidEnterCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*Difficulty*/, 4 /*Plana.FlatData.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 44 /*TacticEnvironment*/, 4 /*Plana.FlatData.TacticEnvironment*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 80 /*EchelonExtensionType*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
