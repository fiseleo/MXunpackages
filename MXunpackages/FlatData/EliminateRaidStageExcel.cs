...
public struct EliminateRaidStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Difficulty Difficulty_ { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Difficulty.Normal; } }
  ...
  public Plana.FlatData.TacticEnvironment TacticEnvironment_ { get { int o = __p.__offset(44); return o != 0 ? (Plana.FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticEnvironment.None; } }
  ...
  public static Offset<Plana.FlatData.EliminateRaidStageExcel> CreateEliminateRaidStageExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.Difficulty Difficulty_ = Plana.FlatData.Difficulty.Normal,
      bool IsOpen = false,
      ...
      Plana.FlatData.TacticEnvironment TacticEnvironment_ = Plana.FlatData.TacticEnvironment.None,
  ...
  public static void AddDifficulty_(FlatBufferBuilder builder, Plana.FlatData.Difficulty difficulty_) { builder.AddInt(12, (int)difficulty_, 0); }
  ...
  public static void AddTacticEnvironment_(FlatBufferBuilder builder, Plana.FlatData.TacticEnvironment tacticEnvironment_) { builder.AddInt(20, (int)tacticEnvironment_, 0); }
...
public class EliminateRaidStageExcelT
{
  ...
  public Plana.FlatData.Difficulty Difficulty_ { get; set; }
  ...
  public Plana.FlatData.TacticEnvironment TacticEnvironment_ { get; set; }
  ...
  public EliminateRaidStageExcelT() {
    ...
    this.Difficulty_ = Plana.FlatData.Difficulty.Normal;
    this.IsOpen = false;
    ...
    this.TacticEnvironment_ = Plana.FlatData.TacticEnvironment.None;
...
static public class EliminateRaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*Difficulty_*/, 4 /*Plana.FlatData.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 44 /*TacticEnvironment_*/, 4 /*Plana.FlatData.TacticEnvironment*/, 4, false)
