...
public struct WeekDungeonExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.WeekDungeonType WeekDungeonType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.WeekDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeekDungeonType.None; } }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }

  public static Offset<Plana.FlatData.WeekDungeonExcel> CreateWeekDungeonExcel(FlatBufferBuilder builder,
      long StageId = 0,
      Plana.FlatData.WeekDungeonType WeekDungeonType = Plana.FlatData.WeekDungeonType.None,
      int Difficulty = 0,
  ...
  public static void AddWeekDungeonType(FlatBufferBuilder builder, Plana.FlatData.WeekDungeonType weekDungeonType) { builder.AddInt(1, (int)weekDungeonType, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(18, (int)echelonExtensionType, 0); }
...
public class WeekDungeonExcelT
{
  ...
  public Plana.FlatData.WeekDungeonType WeekDungeonType { get; set; }
  ...
  public WeekDungeonExcelT() {
    this.StageId = 0;
    this.WeekDungeonType = Plana.FlatData.WeekDungeonType.None;
    this.Difficulty = 0;
...
static public class WeekDungeonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*WeekDungeonType*/, 4 /*Plana.FlatData.WeekDungeonType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*EchelonExtensionType*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
