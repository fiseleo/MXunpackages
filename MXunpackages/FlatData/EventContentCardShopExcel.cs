...
public struct EventContentCardShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentCardShopExcel> CreateEventContentCardShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentCardShopExcel> EndEventContentCardShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentCardShopExcel>(o);
  }
  ...
  public void UnPackTo(EventContentCardShopExcelT _o) {
    ...
    _o.ProbWeight1 = TableEncryptionService.Convert(this.ProbWeight1, key);
  ...
  public static Offset<Plana.FlatData.EventContentCardShopExcel> Pack(FlatBufferBuilder builder, EventContentCardShopExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentCardShopExcel>);
