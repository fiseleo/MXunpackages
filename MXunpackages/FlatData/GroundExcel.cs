...
public struct GroundExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageTopography StageTopography_ { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  public Plana.FlatData.BulletType EnemyBulletType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.BulletType.Normal; } }
  public Plana.FlatData.ArmorType EnemyArmorType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ArmorType.LightArmor; } }
  ...
  public Plana.FlatData.TacticSpeed ForcedTacticSpeed { get { int o = __p.__offset(82); return o != 0 ? (Plana.FlatData.TacticSpeed)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticSpeed.None; } }
  public Plana.FlatData.TacticSkillUse ForcedSkillUse { get { int o = __p.__offset(84); return o != 0 ? (Plana.FlatData.TacticSkillUse)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticSkillUse.None; } }
  public Plana.FlatData.ShowSkillCutIn ShowNPCSkillCutIn { get { int o = __p.__offset(86); return o != 0 ? (Plana.FlatData.ShowSkillCutIn)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShowSkillCutIn.None; } }
  ...
  public static Offset<Plana.FlatData.GroundExcel> CreateGroundExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Plana.FlatData.BulletType EnemyBulletType = Plana.FlatData.BulletType.Normal,
      Plana.FlatData.ArmorType EnemyArmorType = Plana.FlatData.ArmorType.LightArmor,
      long LevelNPC = 0,
      long LevelMinion = 0,
      long LevelElite = 0,
      ...
      Plana.FlatData.TacticSpeed ForcedTacticSpeed = Plana.FlatData.TacticSpeed.None,
      Plana.FlatData.TacticSkillUse ForcedSkillUse = Plana.FlatData.TacticSkillUse.None,
      Plana.FlatData.ShowSkillCutIn ShowNPCSkillCutIn = Plana.FlatData.ShowSkillCutIn.None,
  ...
  public static void AddStageTopography_(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography_) { builder.AddInt(4, (int)stageTopography_, 0); }
  public static void AddEnemyBulletType(FlatBufferBuilder builder, Plana.FlatData.BulletType enemyBulletType) { builder.AddInt(5, (int)enemyBulletType, 0); }
  public static void AddEnemyArmorType(FlatBufferBuilder builder, Plana.FlatData.ArmorType enemyArmorType) { builder.AddInt(6, (int)enemyArmorType, 0); }
  ...
  public static void AddForcedTacticSpeed(FlatBufferBuilder builder, Plana.FlatData.TacticSpeed forcedTacticSpeed) { builder.AddInt(39, (int)forcedTacticSpeed, 0); }
  public static void AddForcedSkillUse(FlatBufferBuilder builder, Plana.FlatData.TacticSkillUse forcedSkillUse) { builder.AddInt(40, (int)forcedSkillUse, 0); }
  public static void AddShowNPCSkillCutIn(FlatBufferBuilder builder, Plana.FlatData.ShowSkillCutIn showNPCSkillCutIn) { builder.AddInt(41, (int)showNPCSkillCutIn, 0); }
  ...
  public static Offset<Plana.FlatData.GroundExcel> EndGroundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GroundExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GroundExcel> Pack(FlatBufferBuilder builder, GroundExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GroundExcel>);
...
public class GroundExcelT
{
  ...
  public Plana.FlatData.BulletType EnemyBulletType { get; set; }
  public Plana.FlatData.ArmorType EnemyArmorType { get; set; }
  ...
  public Plana.FlatData.TacticSpeed ForcedTacticSpeed { get; set; }
  public Plana.FlatData.TacticSkillUse ForcedSkillUse { get; set; }
  public Plana.FlatData.ShowSkillCutIn ShowNPCSkillCutIn { get; set; }
  ...
  public GroundExcelT() {
    ...
    this.EnemyBulletType = Plana.FlatData.BulletType.Normal;
    this.EnemyArmorType = Plana.FlatData.ArmorType.LightArmor;
    this.LevelNPC = 0;
    this.LevelMinion = 0;
    this.LevelElite = 0;
    ...
    this.ForcedTacticSpeed = Plana.FlatData.TacticSpeed.None;
    this.ForcedSkillUse = Plana.FlatData.TacticSkillUse.None;
    this.ShowNPCSkillCutIn = Plana.FlatData.ShowSkillCutIn.None;
...
static public class GroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StageTopography_*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*EnemyBulletType*/, 4 /*Plana.FlatData.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*EnemyArmorType*/, 4 /*Plana.FlatData.ArmorType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 82 /*ForcedTacticSpeed*/, 4 /*Plana.FlatData.TacticSpeed*/, 4, false)
      && verifier.VerifyField(tablePos, 84 /*ForcedSkillUse*/, 4 /*Plana.FlatData.TacticSkillUse*/, 4, false)
      && verifier.VerifyField(tablePos, 86 /*ShowNPCSkillCutIn*/, 4 /*Plana.FlatData.ShowSkillCutIn*/, 4, false)
