...
public struct GroundExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageTopography StageTopography { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography) { builder.AddInt(4, (int)stageTopography, 0); }
...
static public class GroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StageTopography*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
