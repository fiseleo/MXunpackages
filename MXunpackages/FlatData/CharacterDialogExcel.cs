...
public struct CharacterDialogExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ProductionStep ProductionStep { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ProductionStep)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ProductionStep.ToDo; } }
  public Plana.FlatData.DialogCategory DialogCategory { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.DialogCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DialogCategory.Cafe; } }
  public Plana.FlatData.DialogCondition DialogCondition { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.DialogCondition)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DialogCondition.Idle; } }
  public Plana.FlatData.Anniversary Anniversary { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.Anniversary)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Anniversary.None; } }
  ...
  public Plana.FlatData.CVCollectionType CVCollectionType { get { int o = __p.__offset(46); return o != 0 ? (Plana.FlatData.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CVCollectionType.CVNormal; } }
  ...
  public static Offset<Plana.FlatData.CharacterDialogExcel> CreateCharacterDialogExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.Anniversary Anniversary = Plana.FlatData.Anniversary.None,
  ...
  public static void AddProductionStep(FlatBufferBuilder builder, Plana.FlatData.ProductionStep productionStep) { builder.AddInt(3, (int)productionStep, 0); }
  public static void AddDialogCategory(FlatBufferBuilder builder, Plana.FlatData.DialogCategory dialogCategory) { builder.AddInt(4, (int)dialogCategory, 0); }
  public static void AddDialogCondition(FlatBufferBuilder builder, Plana.FlatData.DialogCondition dialogCondition) { builder.AddInt(5, (int)dialogCondition, 0); }
  public static void AddAnniversary(FlatBufferBuilder builder, Plana.FlatData.Anniversary anniversary) { builder.AddInt(6, (int)anniversary, 0); }
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, Plana.FlatData.CVCollectionType cVCollectionType) { builder.AddInt(21, (int)cVCollectionType, 0); }
...
public class CharacterDialogExcelT
{
  ...
  public Plana.FlatData.Anniversary Anniversary { get; set; }
  ...
  public CharacterDialogExcelT() {
    ...
    this.Anniversary = Plana.FlatData.Anniversary.None;
    this.StartDate = null;
    this.EndDate = null;
    this.GroupId = 0;
...
static public class CharacterDialogExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ProductionStep*/, 4 /*Plana.FlatData.ProductionStep*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*DialogCategory*/, 4 /*Plana.FlatData.DialogCategory*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*DialogCondition*/, 4 /*Plana.FlatData.DialogCondition*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*Anniversary*/, 4 /*Plana.FlatData.Anniversary*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 46 /*CVCollectionType*/, 4 /*Plana.FlatData.CVCollectionType*/, 4, false)
