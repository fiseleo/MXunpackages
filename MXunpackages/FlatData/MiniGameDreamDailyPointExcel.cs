...
public struct MiniGameDreamDailyPointExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameDreamDailyPointExcel> CreateMiniGameDreamDailyPointExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Plana.FlatData.MiniGameDreamDailyPointExcel> EndMiniGameDreamDailyPointExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamDailyPointExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamDailyPointExcel> Pack(FlatBufferBuilder builder, MiniGameDreamDailyPointExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamDailyPointExcel>);
