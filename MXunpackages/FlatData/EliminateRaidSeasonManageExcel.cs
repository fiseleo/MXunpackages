...
public struct EliminateRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EliminateRaidSeasonManageExcel> CreateEliminateRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<Plana.FlatData.EliminateRaidSeasonManageExcel> EndEliminateRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EliminateRaidSeasonManageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EliminateRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, EliminateRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EliminateRaidSeasonManageExcel>);
