...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopCategoryType.General; } }
  ...
  public Plana.FlatData.PurchaseCountResetType PurchaseCountResetType_ { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PurchaseCountResetType.None; } }
  ...
  public static Offset<Plana.FlatData.ShopExcel> CreateShopExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    ShopExcel.AddPurchaseCountResetType_(builder, PurchaseCountResetType_);
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Plana.FlatData.ShopCategoryType categoryType) { builder.AddInt(2, (int)categoryType, 0); }
  ...
  public static void AddPurchaseCountResetType_(FlatBufferBuilder builder, Plana.FlatData.PurchaseCountResetType purchaseCountResetType_) { builder.AddInt(10, (int)purchaseCountResetType_, 0); }
  ...
  public static Offset<Plana.FlatData.ShopExcel> EndShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ShopExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ShopExcel> Pack(FlatBufferBuilder builder, ShopExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ShopExcel>);
...
static public class ShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CategoryType*/, 4 /*Plana.FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*PurchaseCountResetType_*/, 4 /*Plana.FlatData.PurchaseCountResetType*/, 4, false)
