...
public struct ShopExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.PurchaseCountResetType PurchaseCountResetType { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PurchaseCountResetType.None; } }
  ...
  public static void AddPurchaseCountResetType(FlatBufferBuilder builder, Plana.FlatData.PurchaseCountResetType purchaseCountResetType) { builder.AddInt(10, (int)purchaseCountResetType, 0); }
...
static public class ShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*PurchaseCountResetType*/, 4 /*Plana.FlatData.PurchaseCountResetType*/, 4, false)
