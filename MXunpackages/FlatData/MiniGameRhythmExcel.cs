...
public struct MiniGameRhythmExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Difficulty StageDifficulty { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Difficulty.Normal; } }
  ...
  public static Offset<Plana.FlatData.MiniGameRhythmExcel> CreateMiniGameRhythmExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long RhythmBgmId = 0,
      StringOffset PresetNameOffset = default(StringOffset),
      Plana.FlatData.Difficulty StageDifficulty = Plana.FlatData.Difficulty.Normal,
  ...
  public static void AddStageDifficulty(FlatBufferBuilder builder, Plana.FlatData.Difficulty stageDifficulty) { builder.AddInt(3, (int)stageDifficulty, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameRhythmExcel> EndMiniGameRhythmExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameRhythmExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameRhythmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameRhythmExcel>);
...
public class MiniGameRhythmExcelT
{
  ...
  public Plana.FlatData.Difficulty StageDifficulty { get; set; }
  ...
  public MiniGameRhythmExcelT() {
    ...
    this.StageDifficulty = Plana.FlatData.Difficulty.Normal;
...
static public class MiniGameRhythmExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StageDifficulty*/, 4 /*Plana.FlatData.Difficulty*/, 4, false)
