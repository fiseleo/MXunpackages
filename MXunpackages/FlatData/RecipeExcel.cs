...
public struct RecipeExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.RecipeExcel> CreateRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    RecipeExcel.AddRecipeType_(builder, RecipeType_);
  ...
  public static Offset<Plana.FlatData.RecipeExcel> EndRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RecipeExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RecipeExcel> Pack(FlatBufferBuilder builder, RecipeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RecipeExcel>);
