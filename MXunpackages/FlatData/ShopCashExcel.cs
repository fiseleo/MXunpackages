...
public struct ShopCashExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.PurchaseSourceType PackageType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.PurchaseSourceType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PurchaseSourceType.None; } }
  ...
  public Plana.FlatData.ProductCategory CategoryType { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.ProductCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ProductCategory.None; } }
  public Plana.FlatData.ProductDisplayTag DisplayTag { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.ProductDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ProductDisplayTag.None; } }
  ...
  public static Offset<Plana.FlatData.ShopCashExcel> CreateShopCashExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.PurchaseSourceType PackageType = Plana.FlatData.PurchaseSourceType.None,
  ...
  public static void AddPackageType(FlatBufferBuilder builder, Plana.FlatData.PurchaseSourceType packageType) { builder.AddInt(2, (int)packageType, 0); }
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Plana.FlatData.ProductCategory categoryType) { builder.AddInt(7, (int)categoryType, 0); }
  public static void AddDisplayTag(FlatBufferBuilder builder, Plana.FlatData.ProductDisplayTag displayTag) { builder.AddInt(8, (int)displayTag, 0); }
...
public class ShopCashExcelT
{
  ...
  public Plana.FlatData.PurchaseSourceType PackageType { get; set; }
  ...
  public ShopCashExcelT() {
    ...
    this.PackageType = Plana.FlatData.PurchaseSourceType.None;
...
static public class ShopCashExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*PackageType*/, 4 /*Plana.FlatData.PurchaseSourceType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 18 /*CategoryType*/, 4 /*Plana.FlatData.ProductCategory*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*DisplayTag*/, 4 /*Plana.FlatData.ProductDisplayTag*/, 4, false)
