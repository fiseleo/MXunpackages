...
public struct TimeAttackDungeonSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonSeasonManageExcel> CreateTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonSeasonManageExcel> EndTimeAttackDungeonSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TimeAttackDungeonSeasonManageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonSeasonManageExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TimeAttackDungeonSeasonManageExcel>);
