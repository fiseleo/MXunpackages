...
public struct ToastExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ToastType ToastType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ToastType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ToastType.None; } }
  ...
  public static Offset<Plana.FlatData.ToastExcel> CreateToastExcel(FlatBufferBuilder builder,
      uint Id = 0,
      Plana.FlatData.ToastType ToastType = Plana.FlatData.ToastType.None,
      uint MissionId = 0,
      uint TextId = 0,
      long LifeTime = 0) {
  ...
  public static void AddToastType(FlatBufferBuilder builder, Plana.FlatData.ToastType toastType) { builder.AddInt(1, (int)toastType, 0); }
...
public class ToastExcelT
{
  ...
  public Plana.FlatData.ToastType ToastType { get; set; }
  ...
  public ToastExcelT() {
    this.Id = 0;
    this.ToastType = Plana.FlatData.ToastType.None;
    this.MissionId = 0;
    this.TextId = 0;
    this.LifeTime = 0;
  }
...
static public class ToastExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ToastType*/, 4 /*Plana.FlatData.ToastType*/, 4, false)
