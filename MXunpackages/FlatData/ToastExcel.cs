...
public struct ToastExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ToastType ToastType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ToastType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ToastType.None; } }
  ...
  public static Offset<Plana.FlatData.ToastExcel> CreateToastExcel(FlatBufferBuilder builder,
      uint Id = 0,
      Plana.FlatData.ToastType ToastType_ = Plana.FlatData.ToastType.None,
      uint MissionId = 0,
      uint TextId = 0,
      long LifeTime = 0) {
  ...
  public static void AddToastType_(FlatBufferBuilder builder, Plana.FlatData.ToastType toastType_) { builder.AddInt(1, (int)toastType_, 0); }
  ...
  public static Offset<Plana.FlatData.ToastExcel> EndToastExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ToastExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ToastExcel> Pack(FlatBufferBuilder builder, ToastExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ToastExcel>);
...
public class ToastExcelT
{
  ...
  public Plana.FlatData.ToastType ToastType_ { get; set; }
  ...
  public ToastExcelT() {
    this.Id = 0;
    this.ToastType_ = Plana.FlatData.ToastType.None;
    this.MissionId = 0;
    this.TextId = 0;
    this.LifeTime = 0;
  }
...
static public class ToastExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ToastType_*/, 4 /*Plana.FlatData.ToastType*/, 4, false)
