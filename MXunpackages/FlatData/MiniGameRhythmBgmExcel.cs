...
public struct MiniGameRhythmBgmExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameRhythmBgmExcel> CreateMiniGameRhythmBgmExcel(FlatBufferBuilder builder,
      long RhythmBgmId = 0,
  ...
  public static Offset<Plana.FlatData.MiniGameRhythmBgmExcel> EndMiniGameRhythmBgmExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameRhythmBgmExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameRhythmBgmExcel> Pack(FlatBufferBuilder builder, MiniGameRhythmBgmExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameRhythmBgmExcel>);
