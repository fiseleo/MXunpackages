...
public struct ScenarioEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ScenarioEffectExcel> CreateScenarioEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ScenarioEffectExcel> EndScenarioEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ScenarioEffectExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ScenarioEffectExcel> Pack(FlatBufferBuilder builder, ScenarioEffectExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ScenarioEffectExcel>);
