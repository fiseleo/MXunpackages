...
public struct CharacterPotentialExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.PotentialStatBonusRateType PotentialStatBonusRateType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PotentialStatBonusRateType.None; } }
  ...
  public static Offset<Plana.FlatData.CharacterPotentialExcel> CreateCharacterPotentialExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.PotentialStatBonusRateType PotentialStatBonusRateType = Plana.FlatData.PotentialStatBonusRateType.None,
  ...
  public static void AddPotentialStatBonusRateType(FlatBufferBuilder builder, Plana.FlatData.PotentialStatBonusRateType potentialStatBonusRateType) { builder.AddInt(2, (int)potentialStatBonusRateType, 0); }
...
public class CharacterPotentialExcelT
{
  ...
  public Plana.FlatData.PotentialStatBonusRateType PotentialStatBonusRateType { get; set; }
  public bool IsUnnecessaryStat { get; set; }

  public CharacterPotentialExcelT() {
    this.Id = 0;
    this.PotentialStatGroupId = 0;
    this.PotentialStatBonusRateType = Plana.FlatData.PotentialStatBonusRateType.None;
...
static public class CharacterPotentialExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*PotentialStatBonusRateType*/, 4 /*Plana.FlatData.PotentialStatBonusRateType*/, 4, false)
