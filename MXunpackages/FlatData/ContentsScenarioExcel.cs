...
public struct ContentsScenarioExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ScenarioContentType ScenarioContentType_ { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ScenarioContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ScenarioContentType.Prologue; } }
  ...
  public static Offset<Plana.FlatData.ContentsScenarioExcel> CreateContentsScenarioExcel(FlatBufferBuilder builder,
      uint Id = 0,
      uint LocalizeId = 0,
      int DisplayOrder = 0,
      Plana.FlatData.ScenarioContentType ScenarioContentType_ = Plana.FlatData.ScenarioContentType.Prologue,
  ...
  public static void AddScenarioContentType_(FlatBufferBuilder builder, Plana.FlatData.ScenarioContentType scenarioContentType_) { builder.AddInt(3, (int)scenarioContentType_, 0); }
  ...
  public static Offset<Plana.FlatData.ContentsScenarioExcel> EndContentsScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ContentsScenarioExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ContentsScenarioExcel> Pack(FlatBufferBuilder builder, ContentsScenarioExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ContentsScenarioExcel>);
...
public class ContentsScenarioExcelT
{
  ...
  public Plana.FlatData.ScenarioContentType ScenarioContentType_ { get; set; }
  ...
  public ContentsScenarioExcelT() {
    ...
    this.LocalizeId = 0;
    this.DisplayOrder = 0;
    this.ScenarioContentType_ = Plana.FlatData.ScenarioContentType.Prologue;
...
static public class ContentsScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ScenarioContentType_*/, 4 /*Plana.FlatData.ScenarioContentType*/, 4, false)
