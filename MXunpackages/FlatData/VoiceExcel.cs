...
public struct VoiceExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.VoiceExcel> CreateVoiceExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Plana.FlatData.VoiceExcel> EndVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.VoiceExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.VoiceExcel> Pack(FlatBufferBuilder builder, VoiceExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.VoiceExcel>);
