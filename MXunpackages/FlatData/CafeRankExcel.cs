...
public struct CafeRankExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CafeRankExcel> CreateCafeRankExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      long RecipeId = 0,
      long ComfortMax = 0,
  ...
  public static Offset<Plana.FlatData.CafeRankExcel> EndCafeRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CafeRankExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CafeRankExcel> Pack(FlatBufferBuilder builder, CafeRankExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CafeRankExcel>);
