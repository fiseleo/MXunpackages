...
public struct MultiFloorRaidRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ClearStageRewardParcelType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidRewardExcel> CreateMultiFloorRaidRewardExcel(FlatBufferBuilder builder,
  ...
  public static void AddClearStageRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType clearStageRewardParcelType) { builder.AddInt(2, (int)clearStageRewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidRewardExcel> EndMultiFloorRaidRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MultiFloorRaidRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidRewardExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MultiFloorRaidRewardExcel>);
...
static public class MultiFloorRaidRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ClearStageRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
