...
public struct TutorialExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.TutorialExcel> CreateTutorialExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Plana.FlatData.TutorialExcel> EndTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TutorialExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TutorialExcel> Pack(FlatBufferBuilder builder, TutorialExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TutorialExcel>);
