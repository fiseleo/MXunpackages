...
public struct ServiceActionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ServiceActionType ServiceActionType { get { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.ServiceActionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ServiceActionType.ClanCreate; } }
  ...
  public static Offset<Plana.FlatData.ServiceActionExcel> CreateServiceActionExcel(FlatBufferBuilder builder,
      Plana.FlatData.ServiceActionType ServiceActionType = Plana.FlatData.ServiceActionType.ClanCreate,
      bool IsLegacy = false,
      long GoodsId = 0) {
  ...
  public static void AddServiceActionType(FlatBufferBuilder builder, Plana.FlatData.ServiceActionType serviceActionType) { builder.AddInt(0, (int)serviceActionType, 0); }
...
{
  public Plana.FlatData.ServiceActionType ServiceActionType { get; set; }
  public bool IsLegacy { get; set; }
  public long GoodsId { get; set; }

  public ServiceActionExcelT() {
    this.ServiceActionType = Plana.FlatData.ServiceActionType.ClanCreate;
    this.IsLegacy = false;
    this.GoodsId = 0;
  }
}
...
static public class ServiceActionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*ServiceActionType*/, 4 /*Plana.FlatData.ServiceActionType*/, 4, false)
