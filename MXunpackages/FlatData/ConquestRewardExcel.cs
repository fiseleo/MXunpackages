...
public struct ConquestRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConquestRewardExcel> CreateConquestRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.ConquestRewardExcel> EndConquestRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestRewardExcel> Pack(FlatBufferBuilder builder, ConquestRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestRewardExcel>);
