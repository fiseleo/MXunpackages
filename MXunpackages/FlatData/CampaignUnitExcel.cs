...
public struct CampaignUnitExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StrategyAIType AIMoveType { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.StrategyAIType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StrategyAIType.None; } }
  public Plana.FlatData.HexaUnitGrade Grade { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.HexaUnitGrade)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.HexaUnitGrade.Grade1; } }
  public Plana.FlatData.TacticEnvironment EnvironmentType { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticEnvironment.None; } }
  ...
  public static Offset<Plana.FlatData.CampaignUnitExcel> CreateCampaignUnitExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      ...
      long GroundId = 0,
      int MoveRange = 0,
      Plana.FlatData.StrategyAIType AIMoveType = Plana.FlatData.StrategyAIType.None,
      Plana.FlatData.HexaUnitGrade Grade = Plana.FlatData.HexaUnitGrade.Grade1,
      Plana.FlatData.TacticEnvironment EnvironmentType = Plana.FlatData.TacticEnvironment.None,
      float Scale = 0.0f,
  ...
  public static void AddAIMoveType(FlatBufferBuilder builder, Plana.FlatData.StrategyAIType aIMoveType) { builder.AddInt(9, (int)aIMoveType, 0); }
  public static void AddGrade(FlatBufferBuilder builder, Plana.FlatData.HexaUnitGrade grade) { builder.AddInt(10, (int)grade, 0); }
  public static void AddEnvironmentType(FlatBufferBuilder builder, Plana.FlatData.TacticEnvironment environmentType) { builder.AddInt(11, (int)environmentType, 0); }
  ...
  public static Offset<Plana.FlatData.CampaignUnitExcel> EndCampaignUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CampaignUnitExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CampaignUnitExcel> Pack(FlatBufferBuilder builder, CampaignUnitExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CampaignUnitExcel>);
...
public class CampaignUnitExcelT
{
  ...
  public Plana.FlatData.StrategyAIType AIMoveType { get; set; }
  public Plana.FlatData.HexaUnitGrade Grade { get; set; }
  public Plana.FlatData.TacticEnvironment EnvironmentType { get; set; }
  ...
  public CampaignUnitExcelT() {
    ...
    this.GroundId = 0;
    this.MoveRange = 0;
    this.AIMoveType = Plana.FlatData.StrategyAIType.None;
    this.Grade = Plana.FlatData.HexaUnitGrade.Grade1;
    this.EnvironmentType = Plana.FlatData.TacticEnvironment.None;
    this.Scale = 0.0f;
...
static public class CampaignUnitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*AIMoveType*/, 4 /*Plana.FlatData.StrategyAIType*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*Grade*/, 4 /*Plana.FlatData.HexaUnitGrade*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*EnvironmentType*/, 4 /*Plana.FlatData.TacticEnvironment*/, 4, false)
