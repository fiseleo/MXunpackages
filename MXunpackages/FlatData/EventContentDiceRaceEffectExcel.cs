...
public struct EventContentDiceRaceEffectExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentDiceRaceResultType EventContentDiceRaceResultType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EventContentDiceRaceResultType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentDiceRaceResultType.DiceResult1; } }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceEffectExcel> CreateEventContentDiceRaceEffectExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Plana.FlatData.EventContentDiceRaceResultType EventContentDiceRaceResultType_ = Plana.FlatData.EventContentDiceRaceResultType.DiceResult1,
  ...
  public static void AddEventContentDiceRaceResultType_(FlatBufferBuilder builder, Plana.FlatData.EventContentDiceRaceResultType eventContentDiceRaceResultType_) { builder.AddInt(1, (int)eventContentDiceRaceResultType_, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceEffectExcel> EndEventContentDiceRaceEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentDiceRaceEffectExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceEffectExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceEffectExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentDiceRaceEffectExcel>);
...
public class EventContentDiceRaceEffectExcelT
{
  ...
  public Plana.FlatData.EventContentDiceRaceResultType EventContentDiceRaceResultType_ { get; set; }
  ...
  public EventContentDiceRaceEffectExcelT() {
    ...
    this.EventContentDiceRaceResultType_ = Plana.FlatData.EventContentDiceRaceResultType.DiceResult1;
...
static public class EventContentDiceRaceEffectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EventContentDiceRaceResultType_*/, 4 /*Plana.FlatData.EventContentDiceRaceResultType*/, 4, false)
