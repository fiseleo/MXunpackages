...
public struct CharacterStatExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TerrainAdaptationStat StreetBattleAdaptation { get { int o = __p.__offset(154); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  public Plana.FlatData.TerrainAdaptationStat OutdoorBattleAdaptation { get { int o = __p.__offset(156); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  public Plana.FlatData.TerrainAdaptationStat IndoorBattleAdaptation { get { int o = __p.__offset(158); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  public long RegenCost { get { int o = __p.__offset(160); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Plana.FlatData.CharacterStatExcel> CreateCharacterStatExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      ...
      Plana.FlatData.TerrainAdaptationStat StreetBattleAdaptation = Plana.FlatData.TerrainAdaptationStat.D,
      Plana.FlatData.TerrainAdaptationStat OutdoorBattleAdaptation = Plana.FlatData.TerrainAdaptationStat.D,
      Plana.FlatData.TerrainAdaptationStat IndoorBattleAdaptation = Plana.FlatData.TerrainAdaptationStat.D,
      long RegenCost = 0) {
  ...
  public static void AddStreetBattleAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat streetBattleAdaptation) { builder.AddInt(75, (int)streetBattleAdaptation, 0); }
  public static void AddOutdoorBattleAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat outdoorBattleAdaptation) { builder.AddInt(76, (int)outdoorBattleAdaptation, 0); }
  public static void AddIndoorBattleAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat indoorBattleAdaptation) { builder.AddInt(77, (int)indoorBattleAdaptation, 0); }
  public static void AddRegenCost(FlatBufferBuilder builder, long regenCost) { builder.AddLong(78, regenCost, 0); }
  public static Offset<Plana.FlatData.CharacterStatExcel> EndCharacterStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterStatExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterStatExcel> Pack(FlatBufferBuilder builder, CharacterStatExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterStatExcel>);
...
public class CharacterStatExcelT
{
  ...
  public Plana.FlatData.TerrainAdaptationStat StreetBattleAdaptation { get; set; }
  public Plana.FlatData.TerrainAdaptationStat OutdoorBattleAdaptation { get; set; }
  public Plana.FlatData.TerrainAdaptationStat IndoorBattleAdaptation { get; set; }
  ...
  public CharacterStatExcelT() {
    ...
    this.StreetBattleAdaptation = Plana.FlatData.TerrainAdaptationStat.D;
    this.OutdoorBattleAdaptation = Plana.FlatData.TerrainAdaptationStat.D;
    this.IndoorBattleAdaptation = Plana.FlatData.TerrainAdaptationStat.D;
    this.RegenCost = 0;
  }
}
...
static public class CharacterStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 154 /*StreetBattleAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 156 /*OutdoorBattleAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 158 /*IndoorBattleAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
