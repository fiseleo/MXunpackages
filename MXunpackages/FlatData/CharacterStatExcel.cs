...
public struct CharacterStatExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TerrainAdaptationStat StreetBattleAdaptation { get { int o = __p.__offset(128); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  public Plana.FlatData.TerrainAdaptationStat OutdoorBattleAdaptation { get { int o = __p.__offset(130); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  public Plana.FlatData.TerrainAdaptationStat IndoorBattleAdaptation { get { int o = __p.__offset(132); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  ...
  public static void AddStreetBattleAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat streetBattleAdaptation) { builder.AddInt(62, (int)streetBattleAdaptation, 0); }
  public static void AddOutdoorBattleAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat outdoorBattleAdaptation) { builder.AddInt(63, (int)outdoorBattleAdaptation, 0); }
  public static void AddIndoorBattleAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat indoorBattleAdaptation) { builder.AddInt(64, (int)indoorBattleAdaptation, 0); }
...
static public class CharacterStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 128 /*StreetBattleAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 130 /*OutdoorBattleAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 132 /*IndoorBattleAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
