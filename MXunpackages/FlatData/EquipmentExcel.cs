...
public struct EquipmentExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EquipmentCategory EquipmentCategory { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EquipmentCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EquipmentCategory.Unable; } }
  ...
  public Plana.FlatData.Tag Tags(int j) { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(28); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(28, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public Plana.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(28); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ShopCategoryType ShopCategory(int j) { int o = __p.__offset(38); return o != 0 ? (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ShopCategoryType)0; }
  public int ShopCategoryLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ShopCategoryType> GetShopCategoryBytes() { return __p.__vector_as_span<Plana.FlatData.ShopCategoryType>(38, 4); }
#else
  public ArraySegment<byte>? GetShopCategoryBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public Plana.FlatData.ShopCategoryType[] GetShopCategoryArray() { int o = __p.__offset(38); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ShopCategoryType[] a = new Plana.FlatData.ShopCategoryType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(p + i * 4); } return a; }
  public long ShortcutTypeId { get { int o = __p.__offset(40); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<Plana.FlatData.EquipmentExcel> CreateEquipmentExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.EquipmentCategory EquipmentCategory = Plana.FlatData.EquipmentCategory.Unable,
  ...
  public static void AddEquipmentCategory(FlatBufferBuilder builder, Plana.FlatData.EquipmentCategory equipmentCategory) { builder.AddInt(1, (int)equipmentCategory, 0); }
  ...
  public static Offset<Plana.FlatData.EquipmentExcel> EndEquipmentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EquipmentExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EquipmentExcel> Pack(FlatBufferBuilder builder, EquipmentExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EquipmentExcel>);
...
public class EquipmentExcelT
{
  ...
  public Plana.FlatData.EquipmentCategory EquipmentCategory { get; set; }
  ...
  public EquipmentExcelT() {
    this.Id = 0;
    this.EquipmentCategory = Plana.FlatData.EquipmentCategory.Unable;
...
static public class EquipmentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EquipmentCategory*/, 4 /*Plana.FlatData.EquipmentCategory*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 28 /*Tags*/, 4 /*Plana.FlatData.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 38 /*ShopCategory*/, 4 /*Plana.FlatData.ShopCategoryType*/, false)
