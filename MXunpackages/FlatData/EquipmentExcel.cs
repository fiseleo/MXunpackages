...
public struct EquipmentExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EquipmentCategory EquipmentCategory_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EquipmentCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EquipmentCategory.Unable; } }
  ...
  public static void AddEquipmentCategory_(FlatBufferBuilder builder, Plana.FlatData.EquipmentCategory equipmentCategory_) { builder.AddInt(1, (int)equipmentCategory_, 0); }
...
static public class EquipmentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EquipmentCategory_*/, 4 /*Plana.FlatData.EquipmentCategory*/, 4, false)
