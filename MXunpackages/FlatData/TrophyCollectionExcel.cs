...
public struct TrophyCollectionExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.TrophyCollectionExcel> CreateTrophyCollectionExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.TrophyCollectionExcel> EndTrophyCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TrophyCollectionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TrophyCollectionExcel> Pack(FlatBufferBuilder builder, TrophyCollectionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TrophyCollectionExcel>);
