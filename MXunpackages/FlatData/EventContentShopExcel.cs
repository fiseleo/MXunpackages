...
public struct EventContentShopExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopCategoryType.General; } }
  ...
  public Plana.FlatData.PurchaseCountResetType PurchaseCountResetType_ { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PurchaseCountResetType.None; } }
  ...
  public static Offset<Plana.FlatData.EventContentShopExcel> CreateEventContentShopExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Plana.FlatData.ShopCategoryType categoryType) { builder.AddInt(3, (int)categoryType, 0); }
  ...
  public static void AddPurchaseCountResetType_(FlatBufferBuilder builder, Plana.FlatData.PurchaseCountResetType purchaseCountResetType_) { builder.AddInt(11, (int)purchaseCountResetType_, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentShopExcel> EndEventContentShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentShopExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentShopExcel> Pack(FlatBufferBuilder builder, EventContentShopExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentShopExcel>);
...
static public class EventContentShopExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*CategoryType*/, 4 /*Plana.FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*PurchaseCountResetType_*/, 4 /*Plana.FlatData.PurchaseCountResetType*/, 4, false)
