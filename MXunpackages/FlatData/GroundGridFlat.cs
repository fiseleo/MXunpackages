...
public struct GroundGridFlat : IFlatbufferObject
{
  ...
  public Plana.FlatData.GroundNodeFlat? Nodes(int j) { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.GroundNodeFlat?)(new Plana.FlatData.GroundNodeFlat()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<Plana.FlatData.GroundGridFlat> CreateGroundGridFlat(FlatBufferBuilder builder,
      int X = 0,
      int Y = 0,
      float StartX = 0.0f,
      float StartY = 0.0f,
  ...
  public static VectorOffset CreateNodesVector(FlatBufferBuilder builder, Offset<Plana.FlatData.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, Offset<Plana.FlatData.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Plana.FlatData.GroundNodeFlat>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Plana.FlatData.GroundNodeFlat>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.GroundGridFlat> EndGroundGridFlat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GroundGridFlat>(o);
  }
  ...
  public void UnPackTo(GroundGridFlatT _o) {
        byte[] key = TableEncryptionService.CreateKey("GroundGridFlatT");
    ...
    _o.Nodes = new List<Plana.FlatData.GroundNodeFlatT>();
  ...
  public static Offset<Plana.FlatData.GroundGridFlat> Pack(FlatBufferBuilder builder, GroundGridFlatT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GroundGridFlat>);
    var _Nodes = default(VectorOffset);
    if (_o.Nodes != null) {
      var __Nodes = new Offset<Plana.FlatData.GroundNodeFlat>[_o.Nodes.Count];
      for (var _j = 0; _j < __Nodes.Length; ++_j) { __Nodes[_j] = Plana.FlatData.GroundNodeFlat.Pack(builder, _o.Nodes[_j]); }
...
public class GroundGridFlatT
{
  ...
  public List<Plana.FlatData.GroundNodeFlatT> Nodes { get; set; }
...
static public class GroundGridFlatVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 14 /*Nodes*/, Plana.FlatData.GroundNodeFlatVerify.Verify, false)
