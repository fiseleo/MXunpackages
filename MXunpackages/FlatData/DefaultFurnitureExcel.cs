...
public struct DefaultFurnitureExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.FurnitureLocation Location { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.FurnitureLocation)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.FurnitureLocation.None; } }
  ...
  public static Offset<Plana.FlatData.DefaultFurnitureExcel> CreateDefaultFurnitureExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddLocation(FlatBufferBuilder builder, Plana.FlatData.FurnitureLocation location) { builder.AddInt(1, (int)location, 0); }
  ...
  public static Offset<Plana.FlatData.DefaultFurnitureExcel> EndDefaultFurnitureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.DefaultFurnitureExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.DefaultFurnitureExcel> Pack(FlatBufferBuilder builder, DefaultFurnitureExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.DefaultFurnitureExcel>);
...
static public class DefaultFurnitureExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Location*/, 4 /*Plana.FlatData.FurnitureLocation*/, 4, false)
