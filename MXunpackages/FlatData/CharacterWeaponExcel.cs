...
public struct CharacterWeaponExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatLevelUpType.Standard; } }
  ...
  public Plana.FlatData.EquipmentOptionType StatType(int j) { int o = __p.__offset(32); return o != 0 ? (Plana.FlatData.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<Plana.FlatData.EquipmentOptionType>(32, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public Plana.FlatData.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(32); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.EquipmentOptionType[] a = new Plana.FlatData.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Plana.FlatData.StatLevelUpType statLevelUpType) { builder.AddInt(3, (int)statLevelUpType, 0); }
...
static public class CharacterWeaponExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StatLevelUpType*/, 4 /*Plana.FlatData.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 32 /*StatType*/, 4 /*Plana.FlatData.EquipmentOptionType*/, false)
