...
public struct CharacterWeaponExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StatLevelUpType StatLevelUpType_ { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatLevelUpType.Standard; } }
  ...
  public Plana.FlatData.Tag Tags(int j) { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(24, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Plana.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.EquipmentOptionType StatType(int j) { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<Plana.FlatData.EquipmentOptionType>(34, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Plana.FlatData.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.EquipmentOptionType[] a = new Plana.FlatData.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.CharacterWeaponExcel> CreateCharacterWeaponExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStatLevelUpType_(FlatBufferBuilder builder, Plana.FlatData.StatLevelUpType statLevelUpType_) { builder.AddInt(3, (int)statLevelUpType_, 0); }
  ...
  public static Offset<Plana.FlatData.CharacterWeaponExcel> EndCharacterWeaponExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterWeaponExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterWeaponExcel> Pack(FlatBufferBuilder builder, CharacterWeaponExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterWeaponExcel>);
...
static public class CharacterWeaponExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*StatLevelUpType_*/, 4 /*Plana.FlatData.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 24 /*Tags*/, 4 /*Plana.FlatData.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*StatType*/, 4 /*Plana.FlatData.EquipmentOptionType*/, false)
