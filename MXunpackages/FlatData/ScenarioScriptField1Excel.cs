...
public struct ScenarioScriptField1Excel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ScenarioScriptField1Excel> CreateScenarioScriptField1Excel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.ScenarioScriptField1Excel> EndScenarioScriptField1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ScenarioScriptField1Excel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ScenarioScriptField1Excel> Pack(FlatBufferBuilder builder, ScenarioScriptField1ExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ScenarioScriptField1Excel>);
