...
public struct MissionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MissionCategory Category { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.MissionCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCategory.Challenge; } }
  ...
  public Plana.FlatData.MissionResetType ResetType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.MissionResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionResetType.None; } }
  public Plana.FlatData.MissionToastDisplayConditionType ToastDisplayType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.MissionToastDisplayConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionToastDisplayConditionType.Always; } }
  ...
  public Plana.FlatData.ContentType DateAutoRefer { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ContentType.None; } }
  ...
  public Plana.FlatData.AccountState AccountType { get { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.AccountState)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.AccountState.WaitingSignIn; } }
  public long AccountLevel { get { int o = __p.__offset(36); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.SuddenMissionContentType ContentTags(int j) { int o = __p.__offset(38); return o != 0 ? (Plana.FlatData.SuddenMissionContentType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.SuddenMissionContentType)0; }
  public int ContentTagsLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.SuddenMissionContentType> GetContentTagsBytes() { return __p.__vector_as_span<Plana.FlatData.SuddenMissionContentType>(38, 4); }
#else
  public ArraySegment<byte>? GetContentTagsBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public Plana.FlatData.SuddenMissionContentType[] GetContentTagsArray() { int o = __p.__offset(38); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.SuddenMissionContentType[] a = new Plana.FlatData.SuddenMissionContentType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.SuddenMissionContentType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(44); return o != 0 ? (Plana.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Plana.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(50); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(50); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(50, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(50); }
#endif
  public Plana.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(50); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(54); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(54); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(54, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(54); }
#endif
  public Plana.FlatData.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(54); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.MissionExcel> CreateMissionExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.MissionCategory Category = Plana.FlatData.MissionCategory.Challenge,
      StringOffset DescriptionOffset = default(StringOffset),
      Plana.FlatData.MissionResetType ResetType = Plana.FlatData.MissionResetType.None,
      Plana.FlatData.MissionToastDisplayConditionType ToastDisplayType = Plana.FlatData.MissionToastDisplayConditionType.Always,
      ...
      Plana.FlatData.ContentType DateAutoRefer = Plana.FlatData.ContentType.None,
      long DisplayOrder = 0,
      VectorOffset PreMissionIdOffset = default(VectorOffset),
      Plana.FlatData.AccountState AccountType = Plana.FlatData.AccountState.WaitingSignIn,
      long AccountLevel = 0,
      ...
      Plana.FlatData.MissionCompleteConditionType CompleteConditionType = Plana.FlatData.MissionCompleteConditionType.None,
  ...
  public static void AddCategory(FlatBufferBuilder builder, Plana.FlatData.MissionCategory category) { builder.AddInt(1, (int)category, 0); }
  ...
  public static void AddResetType(FlatBufferBuilder builder, Plana.FlatData.MissionResetType resetType) { builder.AddInt(3, (int)resetType, 0); }
  public static void AddToastDisplayType(FlatBufferBuilder builder, Plana.FlatData.MissionToastDisplayConditionType toastDisplayType) { builder.AddInt(4, (int)toastDisplayType, 0); }
  ...
  public static void AddDateAutoRefer(FlatBufferBuilder builder, Plana.FlatData.ContentType dateAutoRefer) { builder.AddInt(12, (int)dateAutoRefer, 0); }
  ...
  public static void AddAccountType(FlatBufferBuilder builder, Plana.FlatData.AccountState accountType) { builder.AddInt(15, (int)accountType, 0); }
  ...
  public static VectorOffset CreateContentTagsVector(FlatBufferBuilder builder, Plana.FlatData.SuddenMissionContentType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateContentTagsVectorBlock(FlatBufferBuilder builder, Plana.FlatData.SuddenMissionContentType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateContentTagsVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.SuddenMissionContentType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateContentTagsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.SuddenMissionContentType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Plana.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(20, (int)completeConditionType, 0); }
  ...
  public static VectorOffset CreateCompleteConditionParameterTagVector(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateCompleteConditionParameterTagVectorBlock(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCompleteConditionParameterTagVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCompleteConditionParameterTagVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateMissionRewardParcelTypeVector(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateMissionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateMissionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateMissionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.MissionExcel> EndMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MissionExcel>(o);
  }
  ...
  public void UnPackTo(MissionExcelT _o) {
    ...
    _o.ContentTags = new List<Plana.FlatData.SuddenMissionContentType>();
    ...
    _o.CompleteConditionParameterTag = new List<Plana.FlatData.Tag>();
    ...
    _o.MissionRewardParcelType = new List<Plana.FlatData.ParcelType>();
  ...
  public static Offset<Plana.FlatData.MissionExcel> Pack(FlatBufferBuilder builder, MissionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MissionExcel>);
...
public class MissionExcelT
{
  ...
  public Plana.FlatData.MissionCategory Category { get; set; }
  public string Description { get; set; }
  public Plana.FlatData.MissionResetType ResetType { get; set; }
  public Plana.FlatData.MissionToastDisplayConditionType ToastDisplayType { get; set; }
  ...
  public Plana.FlatData.ContentType DateAutoRefer { get; set; }
  public long DisplayOrder { get; set; }
  public List<long> PreMissionId { get; set; }
  public Plana.FlatData.AccountState AccountType { get; set; }
  public long AccountLevel { get; set; }
  public List<Plana.FlatData.SuddenMissionContentType> ContentTags { get; set; }
  public List<string> ShortcutUI { get; set; }
  public long ChallengeStageShortcut { get; set; }
  public Plana.FlatData.MissionCompleteConditionType CompleteConditionType { get; set; }
  public long CompleteConditionCount { get; set; }
  public List<long> CompleteConditionParameter { get; set; }
  public List<Plana.FlatData.Tag> CompleteConditionParameterTag { get; set; }
  public string RewardIcon { get; set; }
  public List<Plana.FlatData.ParcelType> MissionRewardParcelType { get; set; }
  public List<long> MissionRewardParcelId { get; set; }
  public List<int> MissionRewardAmount { get; set; }

  public MissionExcelT() {
    this.Id = 0;
    this.Category = Plana.FlatData.MissionCategory.Challenge;
    this.Description = null;
    this.ResetType = Plana.FlatData.MissionResetType.None;
    this.ToastDisplayType = Plana.FlatData.MissionToastDisplayConditionType.Always;
    ...
    this.DateAutoRefer = Plana.FlatData.ContentType.None;
    this.DisplayOrder = 0;
    this.PreMissionId = null;
    this.AccountType = Plana.FlatData.AccountState.WaitingSignIn;
    this.AccountLevel = 0;
    this.ContentTags = null;
    this.ShortcutUI = null;
    this.ChallengeStageShortcut = 0;
    this.CompleteConditionType = Plana.FlatData.MissionCompleteConditionType.None;
...
static public class MissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Category*/, 4 /*Plana.FlatData.MissionCategory*/, 4, false)
      && verifier.VerifyString(tablePos, 8 /*Description*/, false)
      && verifier.VerifyField(tablePos, 10 /*ResetType*/, 4 /*Plana.FlatData.MissionResetType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ToastDisplayType*/, 4 /*Plana.FlatData.MissionToastDisplayConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*DateAutoRefer*/, 4 /*Plana.FlatData.ContentType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 34 /*AccountType*/, 4 /*Plana.FlatData.AccountState*/, 4, false)
      && verifier.VerifyField(tablePos, 36 /*AccountLevel*/, 8 /*long*/, 8, false)
      && verifier.VerifyVectorOfData(tablePos, 38 /*ContentTags*/, 4 /*Plana.FlatData.SuddenMissionContentType*/, false)
      ...
      && verifier.VerifyField(tablePos, 44 /*CompleteConditionType*/, 4 /*Plana.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 50 /*CompleteConditionParameterTag*/, 4 /*Plana.FlatData.Tag*/, false)
      && verifier.VerifyString(tablePos, 52 /*RewardIcon*/, false)
      && verifier.VerifyVectorOfData(tablePos, 54 /*MissionRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
