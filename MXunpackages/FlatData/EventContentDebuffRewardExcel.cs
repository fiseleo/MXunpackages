...
public struct EventContentDebuffRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentItemType EventContentItemType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.EventContentItemType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentItemType.EventPoint; } }
  ...
  public static void AddEventContentItemType(FlatBufferBuilder builder, Plana.FlatData.EventContentItemType eventContentItemType) { builder.AddInt(2, (int)eventContentItemType, 0); }
...
static public class EventContentDebuffRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EventContentItemType*/, 4 /*Plana.FlatData.EventContentItemType*/, 4, false)
