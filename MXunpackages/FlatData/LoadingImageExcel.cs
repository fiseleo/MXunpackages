...
public struct LoadingImageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.LoadingImageExcel> CreateLoadingImageExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<Plana.FlatData.LoadingImageExcel> EndLoadingImageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.LoadingImageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.LoadingImageExcel> Pack(FlatBufferBuilder builder, LoadingImageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.LoadingImageExcel>);
