...
public struct MinigameTBGEncounterOptionExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MinigameTBGEncounterOptionExcel> CreateMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.MinigameTBGEncounterOptionExcel> EndMinigameTBGEncounterOptionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameTBGEncounterOptionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameTBGEncounterOptionExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterOptionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameTBGEncounterOptionExcel>);
