...
public struct LimitedStageSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.LimitedStageSeasonExcel> CreateLimitedStageSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.LimitedStageSeasonExcel> EndLimitedStageSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.LimitedStageSeasonExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.LimitedStageSeasonExcel> Pack(FlatBufferBuilder builder, LimitedStageSeasonExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.LimitedStageSeasonExcel>);
