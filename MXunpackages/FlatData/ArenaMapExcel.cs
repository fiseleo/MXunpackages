...
public struct ArenaMapExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ArenaMapExcel> CreateArenaMapExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long TerrainType = 0,
  ...
  public static Offset<Plana.FlatData.ArenaMapExcel> EndArenaMapExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ArenaMapExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ArenaMapExcel> Pack(FlatBufferBuilder builder, ArenaMapExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ArenaMapExcel>);
