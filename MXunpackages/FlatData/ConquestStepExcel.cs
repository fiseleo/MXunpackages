...
public struct ConquestStepExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageDifficulty MapDifficulty { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageDifficulty.None; } }
  ...
  public Plana.FlatData.ParcelType StepEnterItemType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.ConquestStepExcel> CreateConquestStepExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.ParcelType StepEnterItemType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddMapDifficulty(FlatBufferBuilder builder, Plana.FlatData.StageDifficulty mapDifficulty) { builder.AddInt(1, (int)mapDifficulty, 0); }
  ...
  public static void AddStepEnterItemType(FlatBufferBuilder builder, Plana.FlatData.ParcelType stepEnterItemType) { builder.AddInt(5, (int)stepEnterItemType, 0); }
  ...
  public static Offset<Plana.FlatData.ConquestStepExcel> EndConquestStepExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestStepExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestStepExcel> Pack(FlatBufferBuilder builder, ConquestStepExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestStepExcel>);
...
public class ConquestStepExcelT
{
  ...
  public Plana.FlatData.ParcelType StepEnterItemType { get; set; }
  ...
  public ConquestStepExcelT() {
    ...
    this.StepEnterItemType = Plana.FlatData.ParcelType.None;
...
static public class ConquestStepExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*MapDifficulty*/, 4 /*Plana.FlatData.StageDifficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 14 /*StepEnterItemType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
