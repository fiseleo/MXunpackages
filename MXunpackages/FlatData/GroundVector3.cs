...
public struct GroundVector3 : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.GroundVector3> CreateGroundVector3(FlatBufferBuilder builder,
      float X = 0.0f,
      float Y = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<Plana.FlatData.GroundVector3> EndGroundVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GroundVector3>(o);
  }
  ...
  public void UnPackTo(GroundVector3T _o) {
        byte[] key = TableEncryptionService.CreateKey("GroundVector3T");
  ...
  public static Offset<Plana.FlatData.GroundVector3> Pack(FlatBufferBuilder builder, GroundVector3T _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GroundVector3>);
