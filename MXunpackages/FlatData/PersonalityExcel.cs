...
public struct PersonalityExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.PersonalityExcel> CreatePersonalityExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.PersonalityExcel> EndPersonalityExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.PersonalityExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.PersonalityExcel> Pack(FlatBufferBuilder builder, PersonalityExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.PersonalityExcel>);
