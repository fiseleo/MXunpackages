...
public struct CampaignStageRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RewardTag RewardTag { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RewardTag.Default; } }
  public int StageRewardProb { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Plana.FlatData.ParcelType StageRewardParcelType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.CampaignStageRewardExcel> CreateCampaignStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      Plana.FlatData.RewardTag RewardTag = Plana.FlatData.RewardTag.Default,
      int StageRewardProb = 0,
      Plana.FlatData.ParcelType StageRewardParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddRewardTag(FlatBufferBuilder builder, Plana.FlatData.RewardTag rewardTag) { builder.AddInt(1, (int)rewardTag, 0); }
  public static void AddStageRewardProb(FlatBufferBuilder builder, int stageRewardProb) { builder.AddInt(2, stageRewardProb, 0); }
  public static void AddStageRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType stageRewardParcelType) { builder.AddInt(3, (int)stageRewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.CampaignStageRewardExcel> EndCampaignStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CampaignStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CampaignStageRewardExcel> Pack(FlatBufferBuilder builder, CampaignStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CampaignStageRewardExcel>);
...
public class CampaignStageRewardExcelT
{
  ...
  public Plana.FlatData.ParcelType StageRewardParcelType { get; set; }
  ...
  public CampaignStageRewardExcelT() {
    ...
    this.StageRewardParcelType = Plana.FlatData.ParcelType.None;
...
static public class CampaignStageRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RewardTag*/, 4 /*Plana.FlatData.RewardTag*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*StageRewardProb*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*StageRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
