...
public struct ArenaSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ArenaSeasonExcel> CreateArenaSeasonExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Plana.FlatData.ArenaSeasonExcel> EndArenaSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ArenaSeasonExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ArenaSeasonExcel> Pack(FlatBufferBuilder builder, ArenaSeasonExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ArenaSeasonExcel>);
