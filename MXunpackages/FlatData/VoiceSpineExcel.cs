...
public struct VoiceSpineExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.VoiceSpineExcel> CreateVoiceSpineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<Plana.FlatData.VoiceSpineExcel> EndVoiceSpineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.VoiceSpineExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.VoiceSpineExcel> Pack(FlatBufferBuilder builder, VoiceSpineExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.VoiceSpineExcel>);
