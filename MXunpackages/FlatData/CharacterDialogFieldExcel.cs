...
public struct CharacterDialogFieldExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.FieldDialogType DialogType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.FieldDialogType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.FieldDialogType.None; } }
  ...
  public static Offset<Plana.FlatData.CharacterDialogFieldExcel> CreateCharacterDialogFieldExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int Phase = 0,
      int TargetIndex = 0,
      Plana.FlatData.FieldDialogType DialogType = Plana.FlatData.FieldDialogType.None,
      long Duration = 0,
  ...
  public static void AddDialogType(FlatBufferBuilder builder, Plana.FlatData.FieldDialogType dialogType) { builder.AddInt(3, (int)dialogType, 0); }
  ...
  public static Offset<Plana.FlatData.CharacterDialogFieldExcel> EndCharacterDialogFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterDialogFieldExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterDialogFieldExcel> Pack(FlatBufferBuilder builder, CharacterDialogFieldExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterDialogFieldExcel>);
...
public class CharacterDialogFieldExcelT
{
  ...
  public Plana.FlatData.FieldDialogType DialogType { get; set; }
  ...
  public CharacterDialogFieldExcelT() {
    ...
    this.Phase = 0;
    this.TargetIndex = 0;
    this.DialogType = Plana.FlatData.FieldDialogType.None;
    this.Duration = 0;
...
static public class CharacterDialogFieldExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*DialogType*/, 4 /*Plana.FlatData.FieldDialogType*/, 4, false)
