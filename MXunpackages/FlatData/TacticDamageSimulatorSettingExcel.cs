...
public struct TacticDamageSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TerrainAdaptationStat OverrideStreetAdaptation { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  public Plana.FlatData.TerrainAdaptationStat OverrideOutdoorAdaptation { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  public Plana.FlatData.TerrainAdaptationStat OverrideIndoorAdaptation { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TerrainAdaptationStat.D; } }
  ...
  public static Offset<Plana.FlatData.TacticDamageSimulatorSettingExcel> CreateTacticDamageSimulatorSettingExcel(FlatBufferBuilder builder,
      int Order = 0,
      int Repeat = 0,
      long TestPreset = 0,
      ...
      Plana.FlatData.TerrainAdaptationStat OverrideStreetAdaptation = Plana.FlatData.TerrainAdaptationStat.D,
      Plana.FlatData.TerrainAdaptationStat OverrideOutdoorAdaptation = Plana.FlatData.TerrainAdaptationStat.D,
      Plana.FlatData.TerrainAdaptationStat OverrideIndoorAdaptation = Plana.FlatData.TerrainAdaptationStat.D,
  ...
  public static void AddOverrideStreetAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat overrideStreetAdaptation) { builder.AddInt(9, (int)overrideStreetAdaptation, 0); }
  public static void AddOverrideOutdoorAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat overrideOutdoorAdaptation) { builder.AddInt(10, (int)overrideOutdoorAdaptation, 0); }
  public static void AddOverrideIndoorAdaptation(FlatBufferBuilder builder, Plana.FlatData.TerrainAdaptationStat overrideIndoorAdaptation) { builder.AddInt(11, (int)overrideIndoorAdaptation, 0); }
  ...
  public static Offset<Plana.FlatData.TacticDamageSimulatorSettingExcel> EndTacticDamageSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TacticDamageSimulatorSettingExcel>(o);
  }
  ...
  public void UnPackTo(TacticDamageSimulatorSettingExcelT _o) {
    ...
    _o.OverrideFavorLevel = TableEncryptionService.Convert(this.OverrideFavorLevel, key);
    _o.ApplyOverrideFavorLevel = TableEncryptionService.Convert(this.ApplyOverrideFavorLevel, key);
  ...
  public static Offset<Plana.FlatData.TacticDamageSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticDamageSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TacticDamageSimulatorSettingExcel>);
...
public class TacticDamageSimulatorSettingExcelT
{
  ...
  public Plana.FlatData.TerrainAdaptationStat OverrideStreetAdaptation { get; set; }
  public Plana.FlatData.TerrainAdaptationStat OverrideOutdoorAdaptation { get; set; }
  public Plana.FlatData.TerrainAdaptationStat OverrideIndoorAdaptation { get; set; }
  ...
  public TacticDamageSimulatorSettingExcelT() {
    ...
    this.OverrideStreetAdaptation = Plana.FlatData.TerrainAdaptationStat.D;
    this.OverrideOutdoorAdaptation = Plana.FlatData.TerrainAdaptationStat.D;
    this.OverrideIndoorAdaptation = Plana.FlatData.TerrainAdaptationStat.D;
...
static public class TacticDamageSimulatorSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*OverrideStreetAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*OverrideOutdoorAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*OverrideIndoorAdaptation*/, 4 /*Plana.FlatData.TerrainAdaptationStat*/, 4, false)
