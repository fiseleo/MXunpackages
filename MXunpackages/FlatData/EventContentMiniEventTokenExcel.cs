...
public struct EventContentMiniEventTokenExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentMiniEventTokenExcel> CreateEventContentMiniEventTokenExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentMiniEventTokenExcel> EndEventContentMiniEventTokenExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentMiniEventTokenExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentMiniEventTokenExcel> Pack(FlatBufferBuilder builder, EventContentMiniEventTokenExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentMiniEventTokenExcel>);
