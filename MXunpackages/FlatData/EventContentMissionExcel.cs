...
public struct EventContentMissionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MissionCategory Category { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.MissionCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCategory.Challenge; } }
  public uint Description { get { int o = __p.__offset(14); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public Plana.FlatData.MissionResetType ResetType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.MissionResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionResetType.None; } }
  public Plana.FlatData.MissionToastDisplayConditionType ToastDisplayType { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.MissionToastDisplayConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionToastDisplayConditionType.Always; } }
  ...
  public Plana.FlatData.AccountState AccountType { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.AccountState)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.AccountState.WaitingSignIn; } }
  ...
  public Plana.FlatData.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(36); return o != 0 ? (Plana.FlatData.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MissionCompleteConditionType.None; } }
  ...
  public Plana.FlatData.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(44); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(44, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(44); }
#endif
  public Plana.FlatData.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(44); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(52); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(52); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(52, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public Plana.FlatData.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(52); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType ConditionRewardParcelType(int j) { int o = __p.__offset(58); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int ConditionRewardParcelTypeLength { get { int o = __p.__offset(58); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetConditionRewardParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(58, 4); }
#else
  public ArraySegment<byte>? GetConditionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(58); }
#endif
  public Plana.FlatData.ParcelType[] GetConditionRewardParcelTypeArray() { int o = __p.__offset(58); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.EventContentMissionExcel> CreateEventContentMissionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCategory(FlatBufferBuilder builder, Plana.FlatData.MissionCategory category) { builder.AddInt(4, (int)category, 0); }
  public static void AddDescription(FlatBufferBuilder builder, uint description) { builder.AddUint(5, description, 0); }
  public static void AddResetType(FlatBufferBuilder builder, Plana.FlatData.MissionResetType resetType) { builder.AddInt(6, (int)resetType, 0); }
  public static void AddToastDisplayType(FlatBufferBuilder builder, Plana.FlatData.MissionToastDisplayConditionType toastDisplayType) { builder.AddInt(7, (int)toastDisplayType, 0); }
  ...
  public static void AddAccountType(FlatBufferBuilder builder, Plana.FlatData.AccountState accountType) { builder.AddInt(12, (int)accountType, 0); }
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, Plana.FlatData.MissionCompleteConditionType completeConditionType) { builder.AddInt(16, (int)completeConditionType, 0); }
  ...
  public static VectorOffset CreateConditionRewardParcelTypeVector(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConditionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.EventContentMissionExcel> EndEventContentMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentMissionExcel>(o);
  }
  ...
  public void UnPackTo(EventContentMissionExcelT _o) {
    ...
    _o.ConditionRewardParcelType = new List<Plana.FlatData.ParcelType>();
  ...
  public static Offset<Plana.FlatData.EventContentMissionExcel> Pack(FlatBufferBuilder builder, EventContentMissionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentMissionExcel>);
...
public class EventContentMissionExcelT
{
  ...
  public List<Plana.FlatData.ParcelType> ConditionRewardParcelType { get; set; }
...
static public class EventContentMissionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*Category*/, 4 /*Plana.FlatData.MissionCategory*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*Description*/, 4 /*uint*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*ResetType*/, 4 /*Plana.FlatData.MissionResetType*/, 4, false)
      && verifier.VerifyField(tablePos, 18 /*ToastDisplayType*/, 4 /*Plana.FlatData.MissionToastDisplayConditionType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*AccountType*/, 4 /*Plana.FlatData.AccountState*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*CompleteConditionType*/, 4 /*Plana.FlatData.MissionCompleteConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 44 /*CompleteConditionParameterTag*/, 4 /*Plana.FlatData.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 52 /*MissionRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 58 /*ConditionRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
