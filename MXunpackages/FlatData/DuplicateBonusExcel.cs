...
public struct DuplicateBonusExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ItemCategory ItemCategory { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ItemCategory.Coin; } }
  ...
  public static Offset<Plana.FlatData.DuplicateBonusExcel> CreateDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddItemCategory(FlatBufferBuilder builder, Plana.FlatData.ItemCategory itemCategory) { builder.AddInt(1, (int)itemCategory, 0); }
  ...
  public static Offset<Plana.FlatData.DuplicateBonusExcel> EndDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.DuplicateBonusExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.DuplicateBonusExcel> Pack(FlatBufferBuilder builder, DuplicateBonusExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.DuplicateBonusExcel>);
...
static public class DuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ItemCategory*/, 4 /*Plana.FlatData.ItemCategory*/, 4, false)
