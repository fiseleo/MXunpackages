...
public struct DuplicateBonusExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ItemCategory ItemCategory_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ItemCategory.Coin; } }
  ...
  public static void AddItemCategory_(FlatBufferBuilder builder, Plana.FlatData.ItemCategory itemCategory_) { builder.AddInt(1, (int)itemCategory_, 0); }
...
static public class DuplicateBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ItemCategory_*/, 4 /*Plana.FlatData.ItemCategory*/, 4, false)
