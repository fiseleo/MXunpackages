...
public struct EventContentSpoilerPopupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentSpoilerPopupExcel> CreateEventContentSpoilerPopupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentSpoilerPopupExcel> EndEventContentSpoilerPopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentSpoilerPopupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentSpoilerPopupExcel> Pack(FlatBufferBuilder builder, EventContentSpoilerPopupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentSpoilerPopupExcel>);
