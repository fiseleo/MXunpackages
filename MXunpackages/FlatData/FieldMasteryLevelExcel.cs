...
public struct FieldMasteryLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.FieldMasteryLevelExcel> CreateFieldMasteryLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<Plana.FlatData.FieldMasteryLevelExcel> EndFieldMasteryLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FieldMasteryLevelExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FieldMasteryLevelExcel> Pack(FlatBufferBuilder builder, FieldMasteryLevelExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FieldMasteryLevelExcel>);
