...
public struct ArenaNPCExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity ExceptionCharacterRarities(int j) { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Rarity)0; }
  public int ExceptionCharacterRaritiesLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Rarity> GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_span<Plana.FlatData.Rarity>(16, 4); }
#else
  public ArraySegment<byte>? GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public Plana.FlatData.Rarity[] GetExceptionCharacterRaritiesArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Rarity[] a = new Plana.FlatData.Rarity[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Rarity)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.ArenaNPCExcel> CreateArenaNPCExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long Rank = 0,
  ...
  public static VectorOffset CreateExceptionCharacterRaritiesVector(FlatBufferBuilder builder, Plana.FlatData.Rarity[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateExceptionCharacterRaritiesVectorBlock(FlatBufferBuilder builder, Plana.FlatData.Rarity[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExceptionCharacterRaritiesVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.Rarity> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateExceptionCharacterRaritiesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.Rarity>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.ArenaNPCExcel> EndArenaNPCExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ArenaNPCExcel>(o);
  }
  ...
  public void UnPackTo(ArenaNPCExcelT _o) {
    ...
    _o.ExceptionCharacterRarities = new List<Plana.FlatData.Rarity>();
  ...
  public static Offset<Plana.FlatData.ArenaNPCExcel> Pack(FlatBufferBuilder builder, ArenaNPCExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ArenaNPCExcel>);
...
public class ArenaNPCExcelT
{
  ...
  public List<Plana.FlatData.Rarity> ExceptionCharacterRarities { get; set; }
...
static public class ArenaNPCExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 16 /*ExceptionCharacterRarities*/, 4 /*Plana.FlatData.Rarity*/, false)
