...
public struct ArenaNPCExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity ExceptionCharacterRarities(int j) { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Rarity)0; }
  public int ExceptionCharacterRaritiesLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Rarity> GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_span<Plana.FlatData.Rarity>(18, 4); }
#else
  public ArraySegment<byte>? GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public Plana.FlatData.Rarity[] GetExceptionCharacterRaritiesArray() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Rarity[] a = new Plana.FlatData.Rarity[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Rarity)__p.bb.GetInt(p + i * 4); } return a; }
...
static public class ArenaNPCExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 18 /*ExceptionCharacterRarities*/, 4 /*Plana.FlatData.Rarity*/, false)
