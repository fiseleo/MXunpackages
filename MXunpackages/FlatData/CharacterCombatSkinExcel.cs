...
public struct CharacterCombatSkinExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterCombatSkinExcel> CreateCharacterCombatSkinExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.CharacterCombatSkinExcel> EndCharacterCombatSkinExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterCombatSkinExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterCombatSkinExcel> Pack(FlatBufferBuilder builder, CharacterCombatSkinExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterCombatSkinExcel>);
