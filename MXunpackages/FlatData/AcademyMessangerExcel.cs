...
public struct AcademyMessangerExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.AcademyMessangerExcel> CreateAcademyMessangerExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.AcademyMessangerExcel> EndAcademyMessangerExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.AcademyMessangerExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.AcademyMessangerExcel> Pack(FlatBufferBuilder builder, AcademyMessangerExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.AcademyMessangerExcel>);
