...
public struct EventContentStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentType OpenConditionContentType { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentType.Stage; } }
  ...
  public Plana.FlatData.ParcelType StageEnterCostType { get { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.StageTopography StageTopography { get { int o = __p.__offset(58); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  ...
  public Plana.FlatData.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(64); return o != 0 ? (Plana.FlatData.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StrategyEnvironment.None; } }
  public long GroundID { get { int o = __p.__offset(66); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.ContentType ContentType { get { int o = __p.__offset(68); return o != 0 ? (Plana.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ContentType.None; } }
  ...
  public Plana.FlatData.StarGoalType StarGoal(int j) { int o = __p.__offset(80); return o != 0 ? (Plana.FlatData.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(80); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Plana.FlatData.StarGoalType>(80, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(80); }
#endif
  public Plana.FlatData.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(80); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.StarGoalType[] a = new Plana.FlatData.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(88); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }
  ...
  public static Offset<Plana.FlatData.EventContentStageExcel> CreateEventContentStageExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.StrategyEnvironment StrategyEnvironment = Plana.FlatData.StrategyEnvironment.None,
      long GroundID = 0,
  ...
  public static void AddOpenConditionContentType(FlatBufferBuilder builder, Plana.FlatData.EventContentType openConditionContentType) { builder.AddInt(12, (int)openConditionContentType, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType stageEnterCostType) { builder.AddInt(15, (int)stageEnterCostType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography) { builder.AddInt(27, (int)stageTopography, 0); }
  ...
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Plana.FlatData.StrategyEnvironment strategyEnvironment) { builder.AddInt(30, (int)strategyEnvironment, 0); }
  public static void AddGroundID(FlatBufferBuilder builder, long groundID) { builder.AddLong(31, groundID, 0); }
  public static void AddContentType(FlatBufferBuilder builder, Plana.FlatData.ContentType contentType) { builder.AddInt(32, (int)contentType, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(42, (int)echelonExtensionType, 0); }
...
public class EventContentStageExcelT
{
  ...
  public Plana.FlatData.StrategyEnvironment StrategyEnvironment { get; set; }
  ...
  public EventContentStageExcelT() {
    ...
    this.BgmId = null;
    this.StrategyEnvironment = Plana.FlatData.StrategyEnvironment.None;
    this.GroundID = 0;
...
static public class EventContentStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*OpenConditionContentType*/, 4 /*Plana.FlatData.EventContentType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 34 /*StageEnterCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 58 /*StageTopography*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 60 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 62 /*BgmId*/, false)
      && verifier.VerifyField(tablePos, 64 /*StrategyEnvironment*/, 4 /*Plana.FlatData.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 66 /*GroundID*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 68 /*ContentType*/, 4 /*Plana.FlatData.ContentType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 80 /*StarGoal*/, 4 /*Plana.FlatData.StarGoalType*/, false)
      ...
      && verifier.VerifyField(tablePos, 88 /*EchelonExtensionType*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
