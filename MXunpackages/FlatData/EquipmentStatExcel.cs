...
public struct EquipmentStatExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StatLevelUpType StatLevelUpType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatLevelUpType.Standard; } }
  ...
  public Plana.FlatData.CurrencyTypes LevelUpFeedCostCurrency { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CurrencyTypes.Invalid; } }
  public long LevelUpFeedCostAmount { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.EquipmentCategory EquipmentCategory_ { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.EquipmentCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EquipmentCategory.Unable; } }
  ...
  public static Offset<Plana.FlatData.EquipmentStatExcel> CreateEquipmentStatExcel(FlatBufferBuilder builder,
      long EquipmentId = 0,
      Plana.FlatData.StatLevelUpType StatLevelUpType_ = Plana.FlatData.StatLevelUpType.Standard,
      ...
      Plana.FlatData.CurrencyTypes LevelUpFeedCostCurrency = Plana.FlatData.CurrencyTypes.Invalid,
      long LevelUpFeedCostAmount = 0,
      Plana.FlatData.EquipmentCategory EquipmentCategory_ = Plana.FlatData.EquipmentCategory.Unable,
  ...
  public static void AddStatLevelUpType_(FlatBufferBuilder builder, Plana.FlatData.StatLevelUpType statLevelUpType_) { builder.AddInt(1, (int)statLevelUpType_, 0); }
  ...
  public static void AddLevelUpFeedCostCurrency(FlatBufferBuilder builder, Plana.FlatData.CurrencyTypes levelUpFeedCostCurrency) { builder.AddInt(7, (int)levelUpFeedCostCurrency, 0); }
  ...
  public static void AddEquipmentCategory_(FlatBufferBuilder builder, Plana.FlatData.EquipmentCategory equipmentCategory_) { builder.AddInt(9, (int)equipmentCategory_, 0); }
  ...
  public static Offset<Plana.FlatData.EquipmentStatExcel> EndEquipmentStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EquipmentStatExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EquipmentStatExcel> Pack(FlatBufferBuilder builder, EquipmentStatExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EquipmentStatExcel>);
...
public class EquipmentStatExcelT
{
  ...
  public Plana.FlatData.StatLevelUpType StatLevelUpType_ { get; set; }
  ...
  public Plana.FlatData.CurrencyTypes LevelUpFeedCostCurrency { get; set; }
  public long LevelUpFeedCostAmount { get; set; }
  public Plana.FlatData.EquipmentCategory EquipmentCategory_ { get; set; }
  ...
  public EquipmentStatExcelT() {
    this.EquipmentId = 0;
    this.StatLevelUpType_ = Plana.FlatData.StatLevelUpType.Standard;
    this.StatType = null;
    this.MinStat = null;
    this.MaxStat = null;
    this.LevelUpInsertLimit = 0;
    this.LevelUpFeedExp = 0;
    this.LevelUpFeedCostCurrency = Plana.FlatData.CurrencyTypes.Invalid;
    this.LevelUpFeedCostAmount = 0;
    this.EquipmentCategory_ = Plana.FlatData.EquipmentCategory.Unable;
...
static public class EquipmentStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*StatLevelUpType_*/, 4 /*Plana.FlatData.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 18 /*LevelUpFeedCostCurrency*/, 4 /*Plana.FlatData.CurrencyTypes*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*LevelUpFeedCostAmount*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 22 /*EquipmentCategory_*/, 4 /*Plana.FlatData.EquipmentCategory*/, 4, false)
