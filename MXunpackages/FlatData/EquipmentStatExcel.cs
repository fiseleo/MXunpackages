...
public struct EquipmentStatExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatLevelUpType.Standard; } }
  ...
  public Plana.FlatData.EquipmentCategory EquipmentCategory { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.EquipmentCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EquipmentCategory.Unable; } }
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Plana.FlatData.StatLevelUpType statLevelUpType) { builder.AddInt(1, (int)statLevelUpType, 0); }
  ...
  public static void AddEquipmentCategory(FlatBufferBuilder builder, Plana.FlatData.EquipmentCategory equipmentCategory) { builder.AddInt(9, (int)equipmentCategory, 0); }
...
static public class EquipmentStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*StatLevelUpType*/, 4 /*Plana.FlatData.StatLevelUpType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 22 /*EquipmentCategory*/, 4 /*Plana.FlatData.EquipmentCategory*/, 4, false)
