...
public struct CharacterDialogSubtitleExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterDialogSubtitleExcel> CreateCharacterDialogSubtitleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.CharacterDialogSubtitleExcel> EndCharacterDialogSubtitleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterDialogSubtitleExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterDialogSubtitleExcel> Pack(FlatBufferBuilder builder, CharacterDialogSubtitleExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterDialogSubtitleExcel>);
