...
public struct MissionEmergencyCompleteExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MissionEmergencyCompleteExcel> CreateMissionEmergencyCompleteExcel(FlatBufferBuilder builder,
      long MissionId = 0,
  ...
  public static Offset<Plana.FlatData.MissionEmergencyCompleteExcel> EndMissionEmergencyCompleteExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MissionEmergencyCompleteExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MissionEmergencyCompleteExcel> Pack(FlatBufferBuilder builder, MissionEmergencyCompleteExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MissionEmergencyCompleteExcel>);
