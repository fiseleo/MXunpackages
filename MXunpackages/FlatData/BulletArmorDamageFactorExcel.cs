...
public struct BulletArmorDamageFactorExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.BulletType BulletType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.BulletType.Normal; } }
  public Plana.FlatData.ArmorType ArmorType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ArmorType.LightArmor; } }
  public long DamageRate { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.DamageAttribute DamageAttribute { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.DamageAttribute)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DamageAttribute.Resist; } }
  ...
  public static Offset<Plana.FlatData.BulletArmorDamageFactorExcel> CreateBulletArmorDamageFactorExcel(FlatBufferBuilder builder,
      ...
      long DamageRate = 0,
      Plana.FlatData.DamageAttribute DamageAttribute = Plana.FlatData.DamageAttribute.Resist,
  ...
  public static void AddBulletType(FlatBufferBuilder builder, Plana.FlatData.BulletType bulletType) { builder.AddInt(1, (int)bulletType, 0); }
  public static void AddArmorType(FlatBufferBuilder builder, Plana.FlatData.ArmorType armorType) { builder.AddInt(2, (int)armorType, 0); }
  public static void AddDamageRate(FlatBufferBuilder builder, long damageRate) { builder.AddLong(3, damageRate, 0); }
  public static void AddDamageAttribute(FlatBufferBuilder builder, Plana.FlatData.DamageAttribute damageAttribute) { builder.AddInt(4, (int)damageAttribute, 0); }
...
public class BulletArmorDamageFactorExcelT
{
  ...
  public Plana.FlatData.DamageAttribute DamageAttribute { get; set; }
  ...
  public BulletArmorDamageFactorExcelT() {
    ...
    this.DamageRate = 0;
    this.DamageAttribute = Plana.FlatData.DamageAttribute.Resist;
...
static public class BulletArmorDamageFactorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*BulletType*/, 4 /*Plana.FlatData.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*ArmorType*/, 4 /*Plana.FlatData.ArmorType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*DamageRate*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*DamageAttribute*/, 4 /*Plana.FlatData.DamageAttribute*/, 4, false)
