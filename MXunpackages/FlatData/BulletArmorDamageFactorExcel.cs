...
public struct BulletArmorDamageFactorExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.BulletType BulletType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.BulletType.Normal; } }
  public Plana.FlatData.ArmorType ArmorType_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ArmorType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ArmorType.LightArmor; } }
  public long DamageRate { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.DamageAttribute DamageAttribute_ { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.DamageAttribute)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DamageAttribute.Resist; } }
  ...
  public static Offset<Plana.FlatData.BulletArmorDamageFactorExcel> CreateBulletArmorDamageFactorExcel(FlatBufferBuilder builder,
      StringOffset DamageFactorGroupIdOffset = default(StringOffset),
      Plana.FlatData.BulletType BulletType_ = Plana.FlatData.BulletType.Normal,
      Plana.FlatData.ArmorType ArmorType_ = Plana.FlatData.ArmorType.LightArmor,
      long DamageRate = 0,
      Plana.FlatData.DamageAttribute DamageAttribute_ = Plana.FlatData.DamageAttribute.Resist,
  ...
  public static void AddBulletType_(FlatBufferBuilder builder, Plana.FlatData.BulletType bulletType_) { builder.AddInt(1, (int)bulletType_, 0); }
  public static void AddArmorType_(FlatBufferBuilder builder, Plana.FlatData.ArmorType armorType_) { builder.AddInt(2, (int)armorType_, 0); }
  public static void AddDamageRate(FlatBufferBuilder builder, long damageRate) { builder.AddLong(3, damageRate, 0); }
  public static void AddDamageAttribute_(FlatBufferBuilder builder, Plana.FlatData.DamageAttribute damageAttribute_) { builder.AddInt(4, (int)damageAttribute_, 0); }
  ...
  public static Offset<Plana.FlatData.BulletArmorDamageFactorExcel> EndBulletArmorDamageFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BulletArmorDamageFactorExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BulletArmorDamageFactorExcel> Pack(FlatBufferBuilder builder, BulletArmorDamageFactorExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BulletArmorDamageFactorExcel>);
...
public class BulletArmorDamageFactorExcelT
{
  ...
  public Plana.FlatData.BulletType BulletType_ { get; set; }
  public Plana.FlatData.ArmorType ArmorType_ { get; set; }
  public long DamageRate { get; set; }
  public Plana.FlatData.DamageAttribute DamageAttribute_ { get; set; }
  ...
  public BulletArmorDamageFactorExcelT() {
    ...
    this.BulletType_ = Plana.FlatData.BulletType.Normal;
    this.ArmorType_ = Plana.FlatData.ArmorType.LightArmor;
    this.DamageRate = 0;
    this.DamageAttribute_ = Plana.FlatData.DamageAttribute.Resist;
...
static public class BulletArmorDamageFactorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*BulletType_*/, 4 /*Plana.FlatData.BulletType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*ArmorType_*/, 4 /*Plana.FlatData.ArmorType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*DamageRate*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*DamageAttribute_*/, 4 /*Plana.FlatData.DamageAttribute*/, 4, false)
