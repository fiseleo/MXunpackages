...
public struct MinigameTBGEncounterRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TBGOptionSuccessType TBGOptionSuccessType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.TBGOptionSuccessType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TBGOptionSuccessType.None; } }
  public long Paremeter { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.ParcelType ParcelType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.MinigameTBGEncounterRewardExcel> CreateMinigameTBGEncounterRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long UniqueId = 0,
      Plana.FlatData.TBGOptionSuccessType TBGOptionSuccessType = Plana.FlatData.TBGOptionSuccessType.None,
      long Paremeter = 0,
  ...
  public static void AddTBGOptionSuccessType(FlatBufferBuilder builder, Plana.FlatData.TBGOptionSuccessType tBGOptionSuccessType) { builder.AddInt(2, (int)tBGOptionSuccessType, 0); }
  public static void AddParemeter(FlatBufferBuilder builder, long paremeter) { builder.AddLong(3, paremeter, 0); }
  public static void AddParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType parcelType) { builder.AddInt(4, (int)parcelType, 0); }
...
public class MinigameTBGEncounterRewardExcelT
{
  ...
  public Plana.FlatData.TBGOptionSuccessType TBGOptionSuccessType { get; set; }
  ...
  public MinigameTBGEncounterRewardExcelT() {
    this.GroupId = 0;
    this.UniqueId = 0;
    this.TBGOptionSuccessType = Plana.FlatData.TBGOptionSuccessType.None;
    this.Paremeter = 0;
...
static public class MinigameTBGEncounterRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*TBGOptionSuccessType*/, 4 /*Plana.FlatData.TBGOptionSuccessType*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*Paremeter*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 12 /*ParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
