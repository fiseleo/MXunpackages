...
public struct StringTestExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.StringTestExcel> CreateStringTestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.StringTestExcel> EndStringTestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.StringTestExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.StringTestExcel> Pack(FlatBufferBuilder builder, StringTestExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.StringTestExcel>);
