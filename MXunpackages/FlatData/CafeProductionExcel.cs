...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType CafeProductionParcelType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.CafeProductionExcel> CreateCafeProductionExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      Plana.FlatData.ParcelType CafeProductionParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddCafeProductionParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType cafeProductionParcelType) { builder.AddInt(2, (int)cafeProductionParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.CafeProductionExcel> EndCafeProductionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CafeProductionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CafeProductionExcel> Pack(FlatBufferBuilder builder, CafeProductionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CafeProductionExcel>);
...
public class CafeProductionExcelT
{
  ...
  public Plana.FlatData.ParcelType CafeProductionParcelType { get; set; }
  ...
  public CafeProductionExcelT() {
    this.CafeId = 0;
    this.Rank = 0;
    this.CafeProductionParcelType = Plana.FlatData.ParcelType.None;
...
static public class CafeProductionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CafeProductionParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
