...
public struct MiniGameDreamTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MiniGameDreamTimelineExcel> CreateMiniGameDreamTimelineExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.MiniGameDreamTimelineExcel> EndMiniGameDreamTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamTimelineExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamTimelineExcel> Pack(FlatBufferBuilder builder, MiniGameDreamTimelineExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamTimelineExcel>);
