...
public struct MinigameTBGObjectExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TBGObjectType ObjectType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TBGObjectType.None; } }
  public Plana.FlatData.ParcelType ObjectCostType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.MinigameTBGObjectExcel> CreateMinigameTBGObjectExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      StringOffset KeyOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      Plana.FlatData.TBGObjectType ObjectType = Plana.FlatData.TBGObjectType.None,
      Plana.FlatData.ParcelType ObjectCostType = Plana.FlatData.ParcelType.None,
      long ObjectCostId = 0,
  ...
  public static void AddObjectType(FlatBufferBuilder builder, Plana.FlatData.TBGObjectType objectType) { builder.AddInt(3, (int)objectType, 0); }
  public static void AddObjectCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType objectCostType) { builder.AddInt(4, (int)objectCostType, 0); }
  ...
  public static Offset<Plana.FlatData.MinigameTBGObjectExcel> EndMinigameTBGObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameTBGObjectExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameTBGObjectExcel> Pack(FlatBufferBuilder builder, MinigameTBGObjectExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameTBGObjectExcel>);
...
public class MinigameTBGObjectExcelT
{
  ...
  public Plana.FlatData.TBGObjectType ObjectType { get; set; }
  public Plana.FlatData.ParcelType ObjectCostType { get; set; }
  ...
  public MinigameTBGObjectExcelT() {
    ...
    this.ObjectType = Plana.FlatData.TBGObjectType.None;
    this.ObjectCostType = Plana.FlatData.ParcelType.None;
    this.ObjectCostId = 0;
...
static public class MinigameTBGObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ObjectType*/, 4 /*Plana.FlatData.TBGObjectType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*ObjectCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
