...
public struct CharacterAIExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EngageType EngageType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EngageType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EngageType.SearchAndMove; } }
  public Plana.FlatData.PositioningType Positioning { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.PositioningType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PositioningType.CloseToObstacle; } }
  ...
  public static Offset<Plana.FlatData.CharacterAIExcel> CreateCharacterAIExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.EngageType EngageType_ = Plana.FlatData.EngageType.SearchAndMove,
      Plana.FlatData.PositioningType Positioning = Plana.FlatData.PositioningType.CloseToObstacle,
  ...
  public static void AddEngageType_(FlatBufferBuilder builder, Plana.FlatData.EngageType engageType_) { builder.AddInt(1, (int)engageType_, 0); }
  public static void AddPositioning(FlatBufferBuilder builder, Plana.FlatData.PositioningType positioning) { builder.AddInt(2, (int)positioning, 0); }
  ...
  public static Offset<Plana.FlatData.CharacterAIExcel> EndCharacterAIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterAIExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterAIExcel> Pack(FlatBufferBuilder builder, CharacterAIExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterAIExcel>);
...
public class CharacterAIExcelT
{
  ...
  public Plana.FlatData.EngageType EngageType_ { get; set; }
  public Plana.FlatData.PositioningType Positioning { get; set; }
  ...
  public CharacterAIExcelT() {
    this.Id = 0;
    this.EngageType_ = Plana.FlatData.EngageType.SearchAndMove;
    this.Positioning = Plana.FlatData.PositioningType.CloseToObstacle;
...
static public class CharacterAIExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EngageType_*/, 4 /*Plana.FlatData.EngageType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*Positioning*/, 4 /*Plana.FlatData.PositioningType*/, 4, false)
