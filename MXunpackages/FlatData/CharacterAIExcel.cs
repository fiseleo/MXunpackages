...
public struct CharacterAIExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EngageType EngageType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EngageType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EngageType.SearchAndMove; } }
  ...
  public static Offset<Plana.FlatData.CharacterAIExcel> CreateCharacterAIExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.EngageType EngageType = Plana.FlatData.EngageType.SearchAndMove,
  ...
  public static void AddEngageType(FlatBufferBuilder builder, Plana.FlatData.EngageType engageType) { builder.AddInt(1, (int)engageType, 0); }
...
public class CharacterAIExcelT
{
  ...
  public Plana.FlatData.EngageType EngageType { get; set; }
  ...
  public CharacterAIExcelT() {
    this.Id = 0;
    this.EngageType = Plana.FlatData.EngageType.SearchAndMove;
...
static public class CharacterAIExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EngageType*/, 4 /*Plana.FlatData.EngageType*/, 4, false)
