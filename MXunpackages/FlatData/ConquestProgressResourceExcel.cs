...
public struct ConquestProgressResourceExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ConquestProgressType Group { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ConquestProgressType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ConquestProgressType.None; } }
  ...
  public static Offset<Plana.FlatData.ConquestProgressResourceExcel> CreateConquestProgressResourceExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Plana.FlatData.ConquestProgressType Group = Plana.FlatData.ConquestProgressType.None,
  ...
  public static void AddGroup(FlatBufferBuilder builder, Plana.FlatData.ConquestProgressType group) { builder.AddInt(2, (int)group, 0); }
  ...
  public static Offset<Plana.FlatData.ConquestProgressResourceExcel> EndConquestProgressResourceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestProgressResourceExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestProgressResourceExcel> Pack(FlatBufferBuilder builder, ConquestProgressResourceExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestProgressResourceExcel>);
...
public class ConquestProgressResourceExcelT
{
  ...
  public Plana.FlatData.ConquestProgressType Group { get; set; }
  ...
  public ConquestProgressResourceExcelT() {
    ...
    this.Group = Plana.FlatData.ConquestProgressType.None;
...
static public class ConquestProgressResourceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Group*/, 4 /*Plana.FlatData.ConquestProgressType*/, 4, false)
