...
public struct FieldRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.FieldRewardExcel> CreateFieldRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int RewardProb = 0,
  ...
  public static Offset<Plana.FlatData.FieldRewardExcel> EndFieldRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FieldRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FieldRewardExcel> Pack(FlatBufferBuilder builder, FieldRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FieldRewardExcel>);
