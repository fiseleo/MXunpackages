...
public struct TacticSkipExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.TacticSkipExcel> CreateTacticSkipExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long HPResult = 0) {
  ...
  public static Offset<Plana.FlatData.TacticSkipExcel> EndTacticSkipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TacticSkipExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TacticSkipExcel> Pack(FlatBufferBuilder builder, TacticSkipExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TacticSkipExcel>);
