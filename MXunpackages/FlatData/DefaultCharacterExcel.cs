...
public struct DefaultCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.DefaultCharacterExcel> CreateDefaultCharacterExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<Plana.FlatData.DefaultCharacterExcel> EndDefaultCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.DefaultCharacterExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.DefaultCharacterExcel> Pack(FlatBufferBuilder builder, DefaultCharacterExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.DefaultCharacterExcel>);
