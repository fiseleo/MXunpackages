...
public struct EventContentNotifyExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventNotifyType EventNotifyType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.EventNotifyType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventNotifyType.RewardIncreaseEvent; } }
  public Plana.FlatData.EventTargetType EventTargetType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.EventTargetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventTargetType.WeekDungeon; } }
  ...
  public static Offset<Plana.FlatData.EventContentNotifyExcel> CreateEventContentNotifyExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.EventNotifyType EventNotifyType = Plana.FlatData.EventNotifyType.RewardIncreaseEvent,
      Plana.FlatData.EventTargetType EventTargetType = Plana.FlatData.EventTargetType.WeekDungeon,
  ...
  public static void AddEventNotifyType(FlatBufferBuilder builder, Plana.FlatData.EventNotifyType eventNotifyType) { builder.AddInt(3, (int)eventNotifyType, 0); }
  public static void AddEventTargetType(FlatBufferBuilder builder, Plana.FlatData.EventTargetType eventTargetType) { builder.AddInt(4, (int)eventTargetType, 0); }
...
public class EventContentNotifyExcelT
{
  ...
  public Plana.FlatData.EventNotifyType EventNotifyType { get; set; }
  public Plana.FlatData.EventTargetType EventTargetType { get; set; }
  ...
  public EventContentNotifyExcelT() {
    ...
    this.IconPath = null;
    this.EventNotifyType = Plana.FlatData.EventNotifyType.RewardIncreaseEvent;
    this.EventTargetType = Plana.FlatData.EventTargetType.WeekDungeon;
...
static public class EventContentNotifyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*EventNotifyType*/, 4 /*Plana.FlatData.EventNotifyType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*EventTargetType*/, 4 /*Plana.FlatData.EventTargetType*/, 4, false)
