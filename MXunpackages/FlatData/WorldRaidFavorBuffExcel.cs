...
public struct WorldRaidFavorBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.WorldRaidFavorBuffExcel> CreateWorldRaidFavorBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.WorldRaidFavorBuffExcel> EndWorldRaidFavorBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WorldRaidFavorBuffExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.WorldRaidFavorBuffExcel> Pack(FlatBufferBuilder builder, WorldRaidFavorBuffExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WorldRaidFavorBuffExcel>);
