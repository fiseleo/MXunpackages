...
public struct BattleLevelFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BattleLevelFactorExcel> CreateBattleLevelFactorExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long DamageRate = 0) {
  ...
  public static Offset<Plana.FlatData.BattleLevelFactorExcel> EndBattleLevelFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BattleLevelFactorExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BattleLevelFactorExcel> Pack(FlatBufferBuilder builder, BattleLevelFactorExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BattleLevelFactorExcel>);
