...
public struct Position : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.Position> CreatePosition(FlatBufferBuilder builder,
      float X = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<Plana.FlatData.Position> EndPosition(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.Position>(o);
  }
  ...
  public void UnPackTo(PositionT _o) {
        byte[] key = TableEncryptionService.CreateKey("PositionT");
    _o.X = TableEncryptionService.Convert(this.X, key);
    _o.Z = TableEncryptionService.Convert(this.Z, key);
  }
  public static Offset<Plana.FlatData.Position> Pack(FlatBufferBuilder builder, PositionT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.Position>);
