...
public struct RecipeIngredientExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RecipeType RecipeType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.RecipeType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RecipeType.None; } }
  ...
  public static Offset<Plana.FlatData.RecipeIngredientExcel> CreateRecipeIngredientExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.RecipeType RecipeType = Plana.FlatData.RecipeType.None,
  ...
  public static void AddRecipeType(FlatBufferBuilder builder, Plana.FlatData.RecipeType recipeType) { builder.AddInt(1, (int)recipeType, 0); }
...
public class RecipeIngredientExcelT
{
  ...
  public Plana.FlatData.RecipeType RecipeType { get; set; }
  ...
  public RecipeIngredientExcelT() {
    this.Id = 0;
    this.RecipeType = Plana.FlatData.RecipeType.None;
...
static public class RecipeIngredientExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*RecipeType*/, 4 /*Plana.FlatData.RecipeType*/, 4, false)
