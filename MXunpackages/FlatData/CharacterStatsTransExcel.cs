...
public struct CharacterStatsTransExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }
  public int TransSupportStatsFactor { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Plana.FlatData.StatTransType StatTransType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.StatTransType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatTransType.SpecialTransStat; } }
  ...
  public static Offset<Plana.FlatData.CharacterStatsTransExcel> CreateCharacterStatsTransExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.StatTransType StatTransType = Plana.FlatData.StatTransType.SpecialTransStat) {
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(1, (int)echelonExtensionType, 0); }
  ...
  public static void AddStatTransType(FlatBufferBuilder builder, Plana.FlatData.StatTransType statTransType) { builder.AddInt(3, (int)statTransType, 0); }
...
public class CharacterStatsTransExcelT
{
  ...
  public Plana.FlatData.StatTransType StatTransType { get; set; }
  ...
  public CharacterStatsTransExcelT() {
    ...
    this.StatTransType = Plana.FlatData.StatTransType.SpecialTransStat;
  }
}
...
static public class CharacterStatsTransExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EchelonExtensionType*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*TransSupportStatsFactor*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*StatTransType*/, 4 /*Plana.FlatData.StatTransType*/, 4, false)
