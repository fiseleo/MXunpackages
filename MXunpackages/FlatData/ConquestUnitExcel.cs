...
public struct ConquestUnitExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ConquestEnemyType EnemyType { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.ConquestEnemyType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ConquestEnemyType.None; } }
  public Plana.FlatData.ConquestTeamType Team { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.ConquestTeamType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ConquestTeamType.None; } }
  ...
  public Plana.FlatData.StarGoalType StarGoal(int j) { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<Plana.FlatData.StarGoalType>(34, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Plana.FlatData.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.StarGoalType[] a = new Plana.FlatData.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType StageEnterCostType { get { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.ParcelType ManageEchelonStageEnterCostType { get { int o = __p.__offset(46); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.StageTopography StageTopography_ { get { int o = __p.__offset(58); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType_ { get { int o = __p.__offset(66); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }

  public static Offset<Plana.FlatData.ConquestUnitExcel> CreateConquestUnitExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
      ...
      Plana.FlatData.ConquestEnemyType EnemyType = Plana.FlatData.ConquestEnemyType.None,
      Plana.FlatData.ConquestTeamType Team = Plana.FlatData.ConquestTeamType.None,
      long UnitGroup = 0,
      ...
      Plana.FlatData.ParcelType ManageEchelonStageEnterCostType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddEnemyType(FlatBufferBuilder builder, Plana.FlatData.ConquestEnemyType enemyType) { builder.AddInt(9, (int)enemyType, 0); }
  public static void AddTeam(FlatBufferBuilder builder, Plana.FlatData.ConquestTeamType team) { builder.AddInt(10, (int)team, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType stageEnterCostType) { builder.AddInt(18, (int)stageEnterCostType, 0); }
  ...
  public static void AddManageEchelonStageEnterCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType manageEchelonStageEnterCostType) { builder.AddInt(21, (int)manageEchelonStageEnterCostType, 0); }
  ...
  public static void AddStageTopography_(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography_) { builder.AddInt(27, (int)stageTopography_, 0); }
  ...
  public static void AddEchelonExtensionType_(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType_) { builder.AddInt(31, (int)echelonExtensionType_, 0); }
  public static Offset<Plana.FlatData.ConquestUnitExcel> EndConquestUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestUnitExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestUnitExcel> Pack(FlatBufferBuilder builder, ConquestUnitExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestUnitExcel>);
...
public class ConquestUnitExcelT
{
  ...
  public Plana.FlatData.ConquestEnemyType EnemyType { get; set; }
  public Plana.FlatData.ConquestTeamType Team { get; set; }
  ...
  public Plana.FlatData.ParcelType ManageEchelonStageEnterCostType { get; set; }
  ...
  public ConquestUnitExcelT() {
    ...
    this.EnemyType = Plana.FlatData.ConquestEnemyType.None;
    this.Team = Plana.FlatData.ConquestTeamType.None;
    this.UnitGroup = 0;
    ...
    this.ManageEchelonStageEnterCostType = Plana.FlatData.ParcelType.None;
...
static public class ConquestUnitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*EnemyType*/, 4 /*Plana.FlatData.ConquestEnemyType*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*Team*/, 4 /*Plana.FlatData.ConquestTeamType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*StarGoal*/, 4 /*Plana.FlatData.StarGoalType*/, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*StageEnterCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 46 /*ManageEchelonStageEnterCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 58 /*StageTopography_*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 66 /*EchelonExtensionType_*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
