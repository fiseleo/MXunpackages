...
public struct CameraExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CameraExcel> CreateCameraExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Plana.FlatData.CameraExcel> EndCameraExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CameraExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CameraExcel> Pack(FlatBufferBuilder builder, CameraExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CameraExcel>);
