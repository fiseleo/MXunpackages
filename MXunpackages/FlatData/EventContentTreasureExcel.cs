...
public struct EventContentTreasureExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentTreasureExcel> CreateEventContentTreasureExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentTreasureExcel> EndEventContentTreasureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentTreasureExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentTreasureExcel> Pack(FlatBufferBuilder builder, EventContentTreasureExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentTreasureExcel>);
