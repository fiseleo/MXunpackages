...
public struct CharacterGearExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StatLevelUpType StatLevelUpType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.StatLevelUpType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatLevelUpType.Standard; } }
  ...
  public static void AddStatLevelUpType(FlatBufferBuilder builder, Plana.FlatData.StatLevelUpType statLevelUpType) { builder.AddInt(2, (int)statLevelUpType, 0); }
...
static public class CharacterGearExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*StatLevelUpType*/, 4 /*Plana.FlatData.StatLevelUpType*/, 4, false)
