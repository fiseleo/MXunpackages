...
public struct GachaCraftNodeExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.GachaCraftNodeExcel> CreateGachaCraftNodeExcel(FlatBufferBuilder builder,
      long ID = 0,
      long Tier = 0,
  ...
  public static Offset<Plana.FlatData.GachaCraftNodeExcel> EndGachaCraftNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GachaCraftNodeExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GachaCraftNodeExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GachaCraftNodeExcel>);
