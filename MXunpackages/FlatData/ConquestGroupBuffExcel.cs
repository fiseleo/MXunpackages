...
public struct ConquestGroupBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ConquestGroupBuffExcel> CreateConquestGroupBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ConquestGroupBuffExcel> EndConquestGroupBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestGroupBuffExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestGroupBuffExcel> Pack(FlatBufferBuilder builder, ConquestGroupBuffExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestGroupBuffExcel>);
