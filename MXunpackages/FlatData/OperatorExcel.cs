...
public struct OperatorExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.OperatorCondition OperatorCondition_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.OperatorCondition)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.OperatorCondition.None; } }
  ...
  public static Offset<Plana.FlatData.OperatorExcel> CreateOperatorExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      StringOffset GroupIdOffset = default(StringOffset),
      Plana.FlatData.OperatorCondition OperatorCondition_ = Plana.FlatData.OperatorCondition.None,
    ...
    OperatorExcel.AddOperatorCondition_(builder, OperatorCondition_);
  ...
  public static void AddOperatorCondition_(FlatBufferBuilder builder, Plana.FlatData.OperatorCondition operatorCondition_) { builder.AddInt(2, (int)operatorCondition_, 0); }
  ...
  public static Offset<Plana.FlatData.OperatorExcel> EndOperatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.OperatorExcel>(o);
  }
  ...
  public void UnPackTo(OperatorExcelT _o) {
    ...
    _o.OperatorCondition_ = TableEncryptionService.Convert(this.OperatorCondition_, key);
  ...
  public static Offset<Plana.FlatData.OperatorExcel> Pack(FlatBufferBuilder builder, OperatorExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.OperatorExcel>);
...
public class OperatorExcelT
{
  ...
  public Plana.FlatData.OperatorCondition OperatorCondition_ { get; set; }
  ...
  public OperatorExcelT() {
    this.UniqueId = 0;
    this.GroupId = null;
    this.OperatorCondition_ = Plana.FlatData.OperatorCondition.None;
...
static public class OperatorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*OperatorCondition_*/, 4 /*Plana.FlatData.OperatorCondition*/, 4, false)
