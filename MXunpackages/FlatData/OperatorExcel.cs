...
public struct OperatorExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.OperatorCondition OperatorCondition { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.OperatorCondition)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.OperatorCondition.None; } }
  ...
  public static Offset<Plana.FlatData.OperatorExcel> CreateOperatorExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.OperatorCondition OperatorCondition = Plana.FlatData.OperatorCondition.None,
  ...
  public static void AddOperatorCondition(FlatBufferBuilder builder, Plana.FlatData.OperatorCondition operatorCondition) { builder.AddInt(2, (int)operatorCondition, 0); }
...
public class OperatorExcelT
{
  ...
  public Plana.FlatData.OperatorCondition OperatorCondition { get; set; }
  ...
  public OperatorExcelT() {
    this.UniqueId = 0;
    this.GroupId = null;
    this.OperatorCondition = Plana.FlatData.OperatorCondition.None;
...
static public class OperatorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*OperatorCondition*/, 4 /*Plana.FlatData.OperatorCondition*/, 4, false)
