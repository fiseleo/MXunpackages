...
public struct EventContentLocationExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ScheduleEventPointCostParcelType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.EventContentLocationExcel> CreateEventContentLocationExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      uint LocalizeEtcId = 0,
      StringOffset PrefabPathOffset = default(StringOffset),
      int LocationResetScheduleCount = 0,
      Plana.FlatData.ParcelType ScheduleEventPointCostParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddScheduleEventPointCostParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType scheduleEventPointCostParcelType) { builder.AddInt(5, (int)scheduleEventPointCostParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentLocationExcel> EndEventContentLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentLocationExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentLocationExcel> Pack(FlatBufferBuilder builder, EventContentLocationExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentLocationExcel>);
...
public class EventContentLocationExcelT
{
  ...
  public Plana.FlatData.ParcelType ScheduleEventPointCostParcelType { get; set; }
  ...
  public EventContentLocationExcelT() {
    ...
    this.ScheduleEventPointCostParcelType = Plana.FlatData.ParcelType.None;
...
static public class EventContentLocationExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*ScheduleEventPointCostParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
