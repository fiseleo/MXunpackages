...
public struct GuideMissionSeasonExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType RequirementParcelType { get { int o = __p.__offset(42); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public Plana.FlatData.GuideMissionTabType TabType { get { int o = __p.__offset(48); return o != 0 ? (Plana.FlatData.GuideMissionTabType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.GuideMissionTabType.None; } }
  ...
  public static Offset<Plana.FlatData.GuideMissionSeasonExcel> CreateGuideMissionSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Plana.FlatData.ParcelType RequirementParcelType = Plana.FlatData.ParcelType.None,
      long RequirementParcelId = 0,
      int RequirementParcelAmount = 0,
      Plana.FlatData.GuideMissionTabType TabType = Plana.FlatData.GuideMissionTabType.None,
  ...
  public static void AddRequirementParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType requirementParcelType) { builder.AddInt(19, (int)requirementParcelType, 0); }
  ...
  public static void AddTabType(FlatBufferBuilder builder, Plana.FlatData.GuideMissionTabType tabType) { builder.AddInt(22, (int)tabType, 0); }
  ...
  public static Offset<Plana.FlatData.GuideMissionSeasonExcel> EndGuideMissionSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GuideMissionSeasonExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GuideMissionSeasonExcel> Pack(FlatBufferBuilder builder, GuideMissionSeasonExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GuideMissionSeasonExcel>);
...
public class GuideMissionSeasonExcelT
{
  ...
  public Plana.FlatData.ParcelType RequirementParcelType { get; set; }
  public long RequirementParcelId { get; set; }
  public int RequirementParcelAmount { get; set; }
  public Plana.FlatData.GuideMissionTabType TabType { get; set; }
  ...
  public GuideMissionSeasonExcelT() {
    ...
    this.RequirementParcelType = Plana.FlatData.ParcelType.None;
    this.RequirementParcelId = 0;
    this.RequirementParcelAmount = 0;
    this.TabType = Plana.FlatData.GuideMissionTabType.None;
...
static public class GuideMissionSeasonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*RequirementParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 48 /*TabType*/, 4 /*Plana.FlatData.GuideMissionTabType*/, 4, false)
