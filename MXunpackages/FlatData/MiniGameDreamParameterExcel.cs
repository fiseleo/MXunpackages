...
public struct MiniGameDreamParameterExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.DreamMakerParameterType ParameterType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.DreamMakerParameterType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.DreamMakerParameterType.None; } }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamParameterExcel> CreateMiniGameDreamParameterExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Plana.FlatData.DreamMakerParameterType ParameterType = Plana.FlatData.DreamMakerParameterType.None,
  ...
  public static void AddParameterType(FlatBufferBuilder builder, Plana.FlatData.DreamMakerParameterType parameterType) { builder.AddInt(2, (int)parameterType, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamParameterExcel> EndMiniGameDreamParameterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamParameterExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamParameterExcel> Pack(FlatBufferBuilder builder, MiniGameDreamParameterExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamParameterExcel>);
...
public class MiniGameDreamParameterExcelT
{
  ...
  public Plana.FlatData.DreamMakerParameterType ParameterType { get; set; }
  ...
  public MiniGameDreamParameterExcelT() {
    ...
    this.ParameterType = Plana.FlatData.DreamMakerParameterType.None;
...
static public class MiniGameDreamParameterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ParameterType*/, 4 /*Plana.FlatData.DreamMakerParameterType*/, 4, false)
