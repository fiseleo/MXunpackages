...
public struct ScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ScenarioResourceInfoExcel> CreateScenarioResourceInfoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.ScenarioResourceInfoExcel> EndScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ScenarioResourceInfoExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ScenarioResourceInfoExcel> Pack(FlatBufferBuilder builder, ScenarioResourceInfoExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ScenarioResourceInfoExcel>);
