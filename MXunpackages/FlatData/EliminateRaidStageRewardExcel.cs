...
public struct EliminateRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ClearStageRewardParcelType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.EliminateRaidStageRewardExcel> CreateEliminateRaidStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      bool IsClearStageRewardHideInfo = false,
      long ClearStageRewardProb = 0,
      Plana.FlatData.ParcelType ClearStageRewardParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddClearStageRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType clearStageRewardParcelType) { builder.AddInt(3, (int)clearStageRewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.EliminateRaidStageRewardExcel> EndEliminateRaidStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EliminateRaidStageRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EliminateRaidStageRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EliminateRaidStageRewardExcel>);
...
public class EliminateRaidStageRewardExcelT
{
  ...
  public Plana.FlatData.ParcelType ClearStageRewardParcelType { get; set; }
  ...
  public EliminateRaidStageRewardExcelT() {
    ...
    this.ClearStageRewardParcelType = Plana.FlatData.ParcelType.None;
...
static public class EliminateRaidStageRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ClearStageRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
