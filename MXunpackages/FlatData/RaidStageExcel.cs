...
public struct RaidStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Difficulty Difficulty { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Difficulty.Normal; } }
  ...
  public Plana.FlatData.TacticEnvironment TacticEnvironment { get { int o = __p.__offset(36); return o != 0 ? (Plana.FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticEnvironment.None; } }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(72); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, Plana.FlatData.Difficulty difficulty) { builder.AddInt(8, (int)difficulty, 0); }
  ...
  public static void AddTacticEnvironment(FlatBufferBuilder builder, Plana.FlatData.TacticEnvironment tacticEnvironment) { builder.AddInt(16, (int)tacticEnvironment, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(34, (int)echelonExtensionType, 0); }
...
static public class RaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*Difficulty*/, 4 /*Plana.FlatData.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*TacticEnvironment*/, 4 /*Plana.FlatData.TacticEnvironment*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 72 /*EchelonExtensionType*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
