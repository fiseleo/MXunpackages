...
public struct RaidStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Difficulty Difficulty_ { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Difficulty.Normal; } }
  ...
  public Plana.FlatData.TacticEnvironment TacticEnvironment_ { get { int o = __p.__offset(36); return o != 0 ? (Plana.FlatData.TacticEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TacticEnvironment.None; } }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType_ { get { int o = __p.__offset(72); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }

  public static Offset<Plana.FlatData.RaidStageExcel> CreateRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    RaidStageExcel.AddEchelonExtensionType_(builder, EchelonExtensionType_);
    ...
    RaidStageExcel.AddDifficulty_(builder, Difficulty_);
  ...
  public static void AddDifficulty_(FlatBufferBuilder builder, Plana.FlatData.Difficulty difficulty_) { builder.AddInt(8, (int)difficulty_, 0); }
  ...
  public static void AddTacticEnvironment_(FlatBufferBuilder builder, Plana.FlatData.TacticEnvironment tacticEnvironment_) { builder.AddInt(16, (int)tacticEnvironment_, 0); }
  ...
  public static void AddEchelonExtensionType_(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType_) { builder.AddInt(34, (int)echelonExtensionType_, 0); }
  public static Offset<Plana.FlatData.RaidStageExcel> EndRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RaidStageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RaidStageExcel> Pack(FlatBufferBuilder builder, RaidStageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RaidStageExcel>);
...
static public class RaidStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*Difficulty_*/, 4 /*Plana.FlatData.Difficulty*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*TacticEnvironment_*/, 4 /*Plana.FlatData.TacticEnvironment*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 72 /*EchelonExtensionType_*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
