...
public struct CafeInteractionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.BubbleType BubbleType_(int j) { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.BubbleType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.BubbleType)0; }
  public int BubbleType_Length { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.BubbleType> GetBubbleType_Bytes() { return __p.__vector_as_span<Plana.FlatData.BubbleType>(12, 4); }
#else
  public ArraySegment<byte>? GetBubbleType_Bytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public Plana.FlatData.BubbleType[] GetBubbleType_Array() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.BubbleType[] a = new Plana.FlatData.BubbleType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.BubbleType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType FavorEmoticonRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.CafeInteractionExcel> CreateCafeInteractionExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
      ...
      Plana.FlatData.ParcelType FavorEmoticonRewardParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static VectorOffset CreateBubbleType_Vector(FlatBufferBuilder builder, Plana.FlatData.BubbleType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateBubbleType_VectorBlock(FlatBufferBuilder builder, Plana.FlatData.BubbleType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleType_VectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.BubbleType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBubbleType_VectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.BubbleType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddFavorEmoticonRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType favorEmoticonRewardParcelType) { builder.AddInt(6, (int)favorEmoticonRewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.CafeInteractionExcel> EndCafeInteractionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CafeInteractionExcel>(o);
  }
  ...
  public void UnPackTo(CafeInteractionExcelT _o) {
    ...
    _o.BubbleType_ = new List<Plana.FlatData.BubbleType>();
  ...
  public static Offset<Plana.FlatData.CafeInteractionExcel> Pack(FlatBufferBuilder builder, CafeInteractionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CafeInteractionExcel>);
...
public class CafeInteractionExcelT
{
  ...
  public List<Plana.FlatData.BubbleType> BubbleType_ { get; set; }
  public List<long> BubbleDuration { get; set; }
  public Plana.FlatData.ParcelType FavorEmoticonRewardParcelType { get; set; }
  ...
  public CafeInteractionExcelT() {
    ...
    this.FavorEmoticonRewardParcelType = Plana.FlatData.ParcelType.None;
...
static public class CafeInteractionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*BubbleType_*/, 4 /*Plana.FlatData.BubbleType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 14 /*BubbleDuration*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 16 /*FavorEmoticonRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
