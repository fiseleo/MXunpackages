...
public struct CampaignChapterExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CampaignChapterExcel> CreateCampaignChapterExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.CampaignChapterExcel> EndCampaignChapterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CampaignChapterExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CampaignChapterExcel> Pack(FlatBufferBuilder builder, CampaignChapterExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CampaignChapterExcel>);
