...
public struct EventContentCardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentCardExcel> CreateEventContentCardExcel(FlatBufferBuilder builder,
      int CardGroupId = 0,
  ...
  public static Offset<Plana.FlatData.EventContentCardExcel> EndEventContentCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentCardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentCardExcel> Pack(FlatBufferBuilder builder, EventContentCardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentCardExcel>);
