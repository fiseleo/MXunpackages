...
public struct TimeAttackDungeonGeasExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TimeAttackDungeonType TimeAttackDungeonType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.TimeAttackDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TimeAttackDungeonType.None; } }
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonGeasExcel> CreateTimeAttackDungeonGeasExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.TimeAttackDungeonType TimeAttackDungeonType = Plana.FlatData.TimeAttackDungeonType.None,
  ...
  public static void AddTimeAttackDungeonType(FlatBufferBuilder builder, Plana.FlatData.TimeAttackDungeonType timeAttackDungeonType) { builder.AddInt(1, (int)timeAttackDungeonType, 0); }
...
public class TimeAttackDungeonGeasExcelT
{
  ...
  public Plana.FlatData.TimeAttackDungeonType TimeAttackDungeonType { get; set; }
  ...
  public TimeAttackDungeonGeasExcelT() {
    this.Id = 0;
    this.TimeAttackDungeonType = Plana.FlatData.TimeAttackDungeonType.None;
...
static public class TimeAttackDungeonGeasExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*TimeAttackDungeonType*/, 4 /*Plana.FlatData.TimeAttackDungeonType*/, 4, false)
