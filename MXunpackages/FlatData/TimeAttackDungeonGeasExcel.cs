...
public struct TimeAttackDungeonGeasExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TimeAttackDungeonType TimeAttackDungeonType_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.TimeAttackDungeonType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TimeAttackDungeonType.None; } }
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonGeasExcel> CreateTimeAttackDungeonGeasExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.TimeAttackDungeonType TimeAttackDungeonType_ = Plana.FlatData.TimeAttackDungeonType.None,
    ...
    TimeAttackDungeonGeasExcel.AddTimeAttackDungeonType_(builder, TimeAttackDungeonType_);
  ...
  public static void AddTimeAttackDungeonType_(FlatBufferBuilder builder, Plana.FlatData.TimeAttackDungeonType timeAttackDungeonType_) { builder.AddInt(1, (int)timeAttackDungeonType_, 0); }
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonGeasExcel> EndTimeAttackDungeonGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TimeAttackDungeonGeasExcel>(o);
  }
  ...
  public void UnPackTo(TimeAttackDungeonGeasExcelT _o) {
    ...
    _o.TimeAttackDungeonType_ = TableEncryptionService.Convert(this.TimeAttackDungeonType_, key);
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonGeasExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonGeasExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TimeAttackDungeonGeasExcel>);
...
public class TimeAttackDungeonGeasExcelT
{
  ...
  public Plana.FlatData.TimeAttackDungeonType TimeAttackDungeonType_ { get; set; }
  ...
  public TimeAttackDungeonGeasExcelT() {
    this.Id = 0;
    this.TimeAttackDungeonType_ = Plana.FlatData.TimeAttackDungeonType.None;
...
static public class TimeAttackDungeonGeasExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*TimeAttackDungeonType_*/, 4 /*Plana.FlatData.TimeAttackDungeonType*/, 4, false)
