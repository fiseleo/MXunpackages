...
public struct WorldRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CurrencyTypes EnterTicket { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CurrencyTypes.Invalid; } }
  ...
  public static Offset<Plana.FlatData.WorldRaidSeasonManageExcel> CreateWorldRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long EventContentId = 0,
      Plana.FlatData.CurrencyTypes EnterTicket = Plana.FlatData.CurrencyTypes.Invalid,
  ...
  public static void AddEnterTicket(FlatBufferBuilder builder, Plana.FlatData.CurrencyTypes enterTicket) { builder.AddInt(2, (int)enterTicket, 0); }
  ...
  public static Offset<Plana.FlatData.WorldRaidSeasonManageExcel> EndWorldRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.WorldRaidSeasonManageExcel>(o);
  }
  ...
  public void UnPackTo(WorldRaidSeasonManageExcelT _o) {
    ...
    _o.HideWorldRaidBossCompleteRewardUI = TableEncryptionService.Convert(this.HideWorldRaidBossCompleteRewardUI, key);
  ...
  public static Offset<Plana.FlatData.WorldRaidSeasonManageExcel> Pack(FlatBufferBuilder builder, WorldRaidSeasonManageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.WorldRaidSeasonManageExcel>);
...
public class WorldRaidSeasonManageExcelT
{
  ...
  public Plana.FlatData.CurrencyTypes EnterTicket { get; set; }
  ...
  public WorldRaidSeasonManageExcelT() {
    ...
    this.EnterTicket = Plana.FlatData.CurrencyTypes.Invalid;
...
static public class WorldRaidSeasonManageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EnterTicket*/, 4 /*Plana.FlatData.CurrencyTypes*/, 4, false)
