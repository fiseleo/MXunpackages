...
public struct SpecialLobbyIllustExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.SpecialLobbyIllustExcel> CreateSpecialLobbyIllustExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<Plana.FlatData.SpecialLobbyIllustExcel> EndSpecialLobbyIllustExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.SpecialLobbyIllustExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.SpecialLobbyIllustExcel> Pack(FlatBufferBuilder builder, SpecialLobbyIllustExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.SpecialLobbyIllustExcel>);
