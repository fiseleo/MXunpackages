...
public struct SkillAdditionalTooltipExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.SkillAdditionalTooltipExcel> CreateSkillAdditionalTooltipExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.SkillAdditionalTooltipExcel> EndSkillAdditionalTooltipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.SkillAdditionalTooltipExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.SkillAdditionalTooltipExcel> Pack(FlatBufferBuilder builder, SkillAdditionalTooltipExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.SkillAdditionalTooltipExcel>);
