...
public struct WeekDungeonGroupBuffExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.School School { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.School)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.School.None; } }
  ...
  public static void AddSchool(FlatBufferBuilder builder, Plana.FlatData.School school) { builder.AddInt(1, (int)school, 0); }
...
static public class WeekDungeonGroupBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*School*/, 4 /*Plana.FlatData.School*/, 4, false)
