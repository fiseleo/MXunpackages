...
public struct TimeAttackDungeonExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonExcel> CreateTimeAttackDungeonExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    TimeAttackDungeonExcel.AddTimeAttackDungeonType_(builder, TimeAttackDungeonType_);
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonExcel> EndTimeAttackDungeonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TimeAttackDungeonExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TimeAttackDungeonExcel> Pack(FlatBufferBuilder builder, TimeAttackDungeonExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TimeAttackDungeonExcel>);
