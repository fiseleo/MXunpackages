...
public struct ScenarioScriptExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ScenarioScriptExcel> CreateScenarioScriptExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<Plana.FlatData.ScenarioScriptExcel> EndScenarioScriptExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ScenarioScriptExcel>(o);
  }
  ...
  public void UnPackTo(ScenarioScriptExcelT _o) {
    ...
    _o.TextTh = TableEncryptionService.Convert(this.TextTh, key);
    _o.TextTw = TableEncryptionService.Convert(this.TextTw, key);
    _o.TextEn = TableEncryptionService.Convert(this.TextEn, key);
    _o.VoiceId = TableEncryptionService.Convert(this.VoiceId, key);
    _o.TeenMode = TableEncryptionService.Convert(this.TeenMode, key);
  }
  public static Offset<Plana.FlatData.ScenarioScriptExcel> Pack(FlatBufferBuilder builder, ScenarioScriptExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ScenarioScriptExcel>);
    ...
    var _TextTh = _o.TextTh == null ? default(StringOffset) : builder.CreateString(_o.TextTh);
    var _TextTw = _o.TextTw == null ? default(StringOffset) : builder.CreateString(_o.TextTw);
    var _TextEn = _o.TextEn == null ? default(StringOffset) : builder.CreateString(_o.TextEn);
