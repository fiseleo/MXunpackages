...
public struct EventContentSpineDialogOffsetExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentType EventContentType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EventContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentType.Stage; } }
  ...
  public static Offset<Plana.FlatData.EventContentSpineDialogOffsetExcel> CreateEventContentSpineDialogOffsetExcel(FlatBufferBuilder builder,
  ...
  public static void AddEventContentType(FlatBufferBuilder builder, Plana.FlatData.EventContentType eventContentType) { builder.AddInt(1, (int)eventContentType, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentSpineDialogOffsetExcel> EndEventContentSpineDialogOffsetExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentSpineDialogOffsetExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentSpineDialogOffsetExcel> Pack(FlatBufferBuilder builder, EventContentSpineDialogOffsetExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentSpineDialogOffsetExcel>);
...
static public class EventContentSpineDialogOffsetExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EventContentType*/, 4 /*Plana.FlatData.EventContentType*/, 4, false)
