...
public struct IdCardBackgroundExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity Rarity_ { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Rarity.N; } }
  ...
  public static Offset<Plana.FlatData.IdCardBackgroundExcel> CreateIdCardBackgroundExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRarity_(FlatBufferBuilder builder, Plana.FlatData.Rarity rarity_) { builder.AddInt(1, (int)rarity_, 0); }
  ...
  public static Offset<Plana.FlatData.IdCardBackgroundExcel> EndIdCardBackgroundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.IdCardBackgroundExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.IdCardBackgroundExcel> Pack(FlatBufferBuilder builder, IdCardBackgroundExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.IdCardBackgroundExcel>);
...
static public class IdCardBackgroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Rarity_*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
