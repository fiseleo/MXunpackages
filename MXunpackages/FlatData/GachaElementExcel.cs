...
public struct GachaElementExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity Rarity { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Rarity.N; } }
  ...
  public static void AddRarity(FlatBufferBuilder builder, Plana.FlatData.Rarity rarity) { builder.AddInt(4, (int)rarity, 0); }
...
static public class GachaElementExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*Rarity*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
