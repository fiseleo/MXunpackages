...
public struct GachaElementExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity Rarity_ { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Rarity.N; } }
  ...
  public static Offset<Plana.FlatData.GachaElementExcel> CreateGachaElementExcel(FlatBufferBuilder builder,
      long ID = 0,
      long GachaGroupID = 0,
  ...
  public static void AddRarity_(FlatBufferBuilder builder, Plana.FlatData.Rarity rarity_) { builder.AddInt(4, (int)rarity_, 0); }
  ...
  public static Offset<Plana.FlatData.GachaElementExcel> EndGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GachaElementExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GachaElementExcel> Pack(FlatBufferBuilder builder, GachaElementExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GachaElementExcel>);
...
static public class GachaElementExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*Rarity_*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
