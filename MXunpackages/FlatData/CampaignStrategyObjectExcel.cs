...
public struct CampaignStrategyObjectExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StrategyObjectType StrategyObjectType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.StrategyObjectType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StrategyObjectType.None; } }
  ...
  public static Offset<Plana.FlatData.CampaignStrategyObjectExcel> CreateCampaignStrategyObjectExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.StrategyObjectType StrategyObjectType = Plana.FlatData.StrategyObjectType.None,
  ...
  public static void AddStrategyObjectType(FlatBufferBuilder builder, Plana.FlatData.StrategyObjectType strategyObjectType) { builder.AddInt(4, (int)strategyObjectType, 0); }
...
public class CampaignStrategyObjectExcelT
{
  ...
  public Plana.FlatData.StrategyObjectType StrategyObjectType { get; set; }
  ...
  public CampaignStrategyObjectExcelT() {
    ...
    this.StrategyObjectType = Plana.FlatData.StrategyObjectType.None;
...
static public class CampaignStrategyObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StrategyObjectType*/, 4 /*Plana.FlatData.StrategyObjectType*/, 4, false)
