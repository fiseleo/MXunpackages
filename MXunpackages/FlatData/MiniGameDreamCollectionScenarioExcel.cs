...
public struct MiniGameDreamCollectionScenarioExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.DreamMakerParameterType Parameter(int j) { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.DreamMakerParameterType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.DreamMakerParameterType)0; }
  public int ParameterLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.DreamMakerParameterType> GetParameterBytes() { return __p.__vector_as_span<Plana.FlatData.DreamMakerParameterType>(10, 4); }
#else
  ...
  public static Offset<Plana.FlatData.MiniGameDreamCollectionScenarioExcel> CreateMiniGameDreamCollectionScenarioExcel(FlatBufferBuilder builder,
      long Id = 0,
      bool IsSkip = false,
  ...
  public static VectorOffset CreateParameterVector(FlatBufferBuilder builder, Plana.FlatData.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, Plana.FlatData.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.DreamMakerParameterType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.DreamMakerParameterType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.MiniGameDreamCollectionScenarioExcel> EndMiniGameDreamCollectionScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameDreamCollectionScenarioExcel>(o);
  }
  ...
  public void UnPackTo(MiniGameDreamCollectionScenarioExcelT _o) {
    ...
    _o.Parameter = new List<Plana.FlatData.DreamMakerParameterType>();
  ...
  public static Offset<Plana.FlatData.MiniGameDreamCollectionScenarioExcel> Pack(FlatBufferBuilder builder, MiniGameDreamCollectionScenarioExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameDreamCollectionScenarioExcel>);
...
public class MiniGameDreamCollectionScenarioExcelT
{
  ...
  public List<Plana.FlatData.DreamMakerParameterType> Parameter { get; set; }
...
static public class MiniGameDreamCollectionScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 10 /*Parameter*/, 4 /*Plana.FlatData.DreamMakerParameterType*/, false)
