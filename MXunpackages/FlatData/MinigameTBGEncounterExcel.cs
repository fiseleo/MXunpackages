...
public struct MinigameTBGEncounterExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.TBGThemaType ThemaType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TBGThemaType.None; } }
  public Plana.FlatData.TBGObjectType ObjectType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.TBGObjectType.None; } }
  ...
  public static Offset<Plana.FlatData.MinigameTBGEncounterExcel> CreateMinigameTBGEncounterExcel(FlatBufferBuilder builder,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, Plana.FlatData.TBGThemaType themaType) { builder.AddInt(4, (int)themaType, 0); }
  public static void AddObjectType(FlatBufferBuilder builder, Plana.FlatData.TBGObjectType objectType) { builder.AddInt(5, (int)objectType, 0); }
  ...
  public static Offset<Plana.FlatData.MinigameTBGEncounterExcel> EndMinigameTBGEncounterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MinigameTBGEncounterExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MinigameTBGEncounterExcel> Pack(FlatBufferBuilder builder, MinigameTBGEncounterExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MinigameTBGEncounterExcel>);
...
static public class MinigameTBGEncounterExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ThemaType*/, 4 /*Plana.FlatData.TBGThemaType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*ObjectType*/, 4 /*Plana.FlatData.TBGObjectType*/, 4, false)
