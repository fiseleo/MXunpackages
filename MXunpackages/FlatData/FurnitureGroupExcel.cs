...
public struct FurnitureGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.FurnitureGroupExcel> CreateFurnitureGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.FurnitureGroupExcel> EndFurnitureGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FurnitureGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FurnitureGroupExcel> Pack(FlatBufferBuilder builder, FurnitureGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FurnitureGroupExcel>);
