...
public struct FieldInteractionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.FieldInteractionType InteractionType(int j) { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.FieldInteractionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.FieldInteractionType)0; }
  public int InteractionTypeLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.FieldInteractionType> GetInteractionTypeBytes() { return __p.__vector_as_span<Plana.FlatData.FieldInteractionType>(14, 4); }
#else
  public ArraySegment<byte>? GetInteractionTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public Plana.FlatData.FieldInteractionType[] GetInteractionTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.FieldInteractionType[] a = new Plana.FlatData.FieldInteractionType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.FieldInteractionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.FieldConditionClass ConditionClass { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.FieldConditionClass)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.FieldConditionClass.AndOr; } }
  ...
  public Plana.FlatData.FieldConditionType ConditionType(int j) { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<Plana.FlatData.FieldConditionType>(26, 4); }
#else
  public ArraySegment<byte>? GetConditionTypeBytes() { return __p.__vector_as_arraysegment(26); }
#endif
  public Plana.FlatData.FieldConditionType[] GetConditionTypeArray() { int o = __p.__offset(26); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.FieldConditionType[] a = new Plana.FlatData.FieldConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.FieldConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.FieldInteractionExcel> CreateFieldInteractionExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.FieldConditionClass ConditionClass = Plana.FlatData.FieldConditionClass.AndOr,
  ...
  public static VectorOffset CreateInteractionTypeVector(FlatBufferBuilder builder, Plana.FlatData.FieldInteractionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.FieldInteractionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.FieldInteractionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.FieldInteractionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddConditionClass(FlatBufferBuilder builder, Plana.FlatData.FieldConditionClass conditionClass) { builder.AddInt(7, (int)conditionClass, 0); }
  ...
  public static VectorOffset CreateConditionTypeVector(FlatBufferBuilder builder, Plana.FlatData.FieldConditionType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConditionTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.FieldConditionType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.FieldConditionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.FieldConditionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.FieldInteractionExcel> EndFieldInteractionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FieldInteractionExcel>(o);
  }
  ...
  public void UnPackTo(FieldInteractionExcelT _o) {
    ...
    _o.InteractionType = new List<Plana.FlatData.FieldInteractionType>();
    ...
    _o.ConditionType = new List<Plana.FlatData.FieldConditionType>();
  ...
  public static Offset<Plana.FlatData.FieldInteractionExcel> Pack(FlatBufferBuilder builder, FieldInteractionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FieldInteractionExcel>);
...
public class FieldInteractionExcelT
{
  ...
  public List<Plana.FlatData.FieldInteractionType> InteractionType { get; set; }
  public List<long> InteractionId { get; set; }
  public Plana.FlatData.FieldConditionClass ConditionClass { get; set; }
  public List<long> ConditionClassParameters { get; set; }
  public bool OnceOnly { get; set; }
  public List<long> ConditionIndex { get; set; }
  public List<Plana.FlatData.FieldConditionType> ConditionType { get; set; }
  ...
  public FieldInteractionExcelT() {
    ...
    this.ConditionClass = Plana.FlatData.FieldConditionClass.AndOr;
...
static public class FieldInteractionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 14 /*InteractionType*/, 4 /*Plana.FlatData.FieldInteractionType*/, false)
      && verifier.VerifyVectorOfData(tablePos, 16 /*InteractionId*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 18 /*ConditionClass*/, 4 /*Plana.FlatData.FieldConditionClass*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 26 /*ConditionType*/, 4 /*Plana.FlatData.FieldConditionType*/, false)
