...
public struct MiniGameShootingGeasExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Geas GeasType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.Geas)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Geas.ForwardProjectile; } }
  ...
  public static Offset<Plana.FlatData.MiniGameShootingGeasExcel> CreateMiniGameShootingGeasExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      Plana.FlatData.Geas GeasType = Plana.FlatData.Geas.ForwardProjectile,
  ...
  public static void AddGeasType(FlatBufferBuilder builder, Plana.FlatData.Geas geasType) { builder.AddInt(1, (int)geasType, 0); }
  ...
  public static Offset<Plana.FlatData.MiniGameShootingGeasExcel> EndMiniGameShootingGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MiniGameShootingGeasExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MiniGameShootingGeasExcel> Pack(FlatBufferBuilder builder, MiniGameShootingGeasExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MiniGameShootingGeasExcel>);
...
public class MiniGameShootingGeasExcelT
{
  ...
  public Plana.FlatData.Geas GeasType { get; set; }
  ...
  public MiniGameShootingGeasExcelT() {
    this.UniqueId = 0;
    this.GeasType = Plana.FlatData.Geas.ForwardProjectile;
    this.Icon = null;
    this.Probability = 0;
...
static public class MiniGameShootingGeasExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*GeasType*/, 4 /*Plana.FlatData.Geas*/, 4, false)
