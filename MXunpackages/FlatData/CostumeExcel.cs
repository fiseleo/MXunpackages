...
public struct CostumeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity Rarity { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Rarity.N; } }
  ...
  public Plana.FlatData.EntityMaterialType EntityMaterialType { get { int o = __p.__offset(32); return o != 0 ? (Plana.FlatData.EntityMaterialType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EntityMaterialType.Wood; } }
  ...
  public static Offset<Plana.FlatData.CostumeExcel> CreateCostumeExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.EntityMaterialType EntityMaterialType = Plana.FlatData.EntityMaterialType.Wood,
  ...
  public static void AddRarity(FlatBufferBuilder builder, Plana.FlatData.Rarity rarity) { builder.AddInt(9, (int)rarity, 0); }
  ...
  public static void AddEntityMaterialType(FlatBufferBuilder builder, Plana.FlatData.EntityMaterialType entityMaterialType) { builder.AddInt(14, (int)entityMaterialType, 0); }
  ...
  public static Offset<Plana.FlatData.CostumeExcel> EndCostumeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CostumeExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CostumeExcel> Pack(FlatBufferBuilder builder, CostumeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CostumeExcel>);
...
public class CostumeExcelT
{
  ...
  public Plana.FlatData.EntityMaterialType EntityMaterialType { get; set; }
  ...
  public CostumeExcelT() {
    ...
    this.EntityMaterialType = Plana.FlatData.EntityMaterialType.Wood;
...
static public class CostumeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*Rarity*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*EntityMaterialType*/, 4 /*Plana.FlatData.EntityMaterialType*/, 4, false)
