...
public struct CostumeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Rarity Rarity_ { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Rarity.N; } }
  ...
  public Plana.FlatData.EntityMaterialType EntityMaterialType_ { get { int o = __p.__offset(32); return o != 0 ? (Plana.FlatData.EntityMaterialType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EntityMaterialType.Wood; } }
  ...
  public static Offset<Plana.FlatData.CostumeExcel> CreateCostumeExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.EntityMaterialType EntityMaterialType_ = Plana.FlatData.EntityMaterialType.Wood,
  ...
  public static void AddRarity_(FlatBufferBuilder builder, Plana.FlatData.Rarity rarity_) { builder.AddInt(9, (int)rarity_, 0); }
  ...
  public static void AddEntityMaterialType_(FlatBufferBuilder builder, Plana.FlatData.EntityMaterialType entityMaterialType_) { builder.AddInt(14, (int)entityMaterialType_, 0); }
...
public class CostumeExcelT
{
  ...
  public Plana.FlatData.EntityMaterialType EntityMaterialType_ { get; set; }
  ...
  public CostumeExcelT() {
    ...
    this.EntityMaterialType_ = Plana.FlatData.EntityMaterialType.Wood;
...
static public class CostumeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*Rarity_*/, 4 /*Plana.FlatData.Rarity*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*EntityMaterialType_*/, 4 /*Plana.FlatData.EntityMaterialType*/, 4, false)
