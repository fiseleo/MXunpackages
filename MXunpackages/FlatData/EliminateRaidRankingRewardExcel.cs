...
public struct EliminateRaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType RewardParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public Plana.FlatData.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.EliminateRaidRankingRewardExcel> CreateEliminateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EliminateRaidRankingRewardExcel> EndEliminateRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EliminateRaidRankingRewardExcel>(o);
  }
  ...
  public void UnPackTo(EliminateRaidRankingRewardExcelT _o) {
    ...
    _o.RankStartTw = TableEncryptionService.Convert(this.RankStartTw, key);
    _o.RankEndTw = TableEncryptionService.Convert(this.RankEndTw, key);
    _o.RankStartAsia = TableEncryptionService.Convert(this.RankStartAsia, key);
    _o.RankEndAsia = TableEncryptionService.Convert(this.RankEndAsia, key);
    _o.RankStartNa = TableEncryptionService.Convert(this.RankStartNa, key);
    _o.RankEndNa = TableEncryptionService.Convert(this.RankEndNa, key);
    _o.RankStartGlobal = TableEncryptionService.Convert(this.RankStartGlobal, key);
    _o.RankEndGlobal = TableEncryptionService.Convert(this.RankEndGlobal, key);
  ...
  public static Offset<Plana.FlatData.EliminateRaidRankingRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EliminateRaidRankingRewardExcel>);
...
static public class EliminateRaidRankingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*RewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
