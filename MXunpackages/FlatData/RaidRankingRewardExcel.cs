...
public struct RaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.RaidRankingRewardExcel> CreateRaidRankingRewardExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.RaidRankingRewardExcel> EndRaidRankingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.RaidRankingRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.RaidRankingRewardExcel> Pack(FlatBufferBuilder builder, RaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.RaidRankingRewardExcel>);
