...
public struct SkillExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.BulletType BulletType { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.BulletType.Normal; } }
  ...
  public static void AddBulletType(FlatBufferBuilder builder, Plana.FlatData.BulletType bulletType) { builder.AddInt(12, (int)bulletType, 0); }
...
static public class SkillExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*BulletType*/, 4 /*Plana.FlatData.BulletType*/, 4, false)
