...
public struct SkillExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.BulletType BulletType_ { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.BulletType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.BulletType.Normal; } }
  ...
  public static Offset<Plana.FlatData.SkillExcel> CreateSkillExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    SkillExcel.AddBulletType_(builder, BulletType_);
  ...
  public static void AddBulletType_(FlatBufferBuilder builder, Plana.FlatData.BulletType bulletType_) { builder.AddInt(12, (int)bulletType_, 0); }
  ...
  public static Offset<Plana.FlatData.SkillExcel> EndSkillExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.SkillExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.SkillExcel> Pack(FlatBufferBuilder builder, SkillExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.SkillExcel>);
...
static public class SkillExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*BulletType_*/, 4 /*Plana.FlatData.BulletType*/, 4, false)
