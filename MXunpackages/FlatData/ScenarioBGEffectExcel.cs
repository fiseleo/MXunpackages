...
public struct ScenarioBGEffectExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ScenarioBGScroll Scroll { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ScenarioBGScroll)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ScenarioBGScroll.None; } }
  ...
  public static void AddScroll(FlatBufferBuilder builder, Plana.FlatData.ScenarioBGScroll scroll) { builder.AddInt(2, (int)scroll, 0); }
...
static public class ScenarioBGEffectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Scroll*/, 4 /*Plana.FlatData.ScenarioBGScroll*/, 4, false)
