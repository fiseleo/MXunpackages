...
public struct ShopRecruitExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.GachaDisplayTag DisplayTag { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.GachaDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.GachaDisplayTag.None; } }
  ...
  public Plana.FlatData.PurchaseCountResetType PurchaseCountResetType_ { get { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.PurchaseCountResetType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.PurchaseCountResetType.None; } }
  ...
  public static Offset<Plana.FlatData.ShopRecruitExcel> CreateShopRecruitExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Plana.FlatData.GachaDisplayTag DisplayTag = Plana.FlatData.GachaDisplayTag.None,
      long DisplayOrder = 0,
      ...
      Plana.FlatData.PurchaseCountResetType PurchaseCountResetType_ = Plana.FlatData.PurchaseCountResetType.None,
      bool IsNewbie = false,
    ...
    ShopRecruitExcel.AddPurchaseCountResetType_(builder, PurchaseCountResetType_);
  ...
  public static void AddDisplayTag(FlatBufferBuilder builder, Plana.FlatData.GachaDisplayTag displayTag) { builder.AddInt(6, (int)displayTag, 0); }
  ...
  public static void AddPurchaseCountResetType_(FlatBufferBuilder builder, Plana.FlatData.PurchaseCountResetType purchaseCountResetType_) { builder.AddInt(18, (int)purchaseCountResetType_, 0); }
  ...
  public static Offset<Plana.FlatData.ShopRecruitExcel> EndShopRecruitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ShopRecruitExcel>(o);
  }
  ...
  public void UnPackTo(ShopRecruitExcelT _o) {
    ...
    _o.DirectPayOneStoreShopCashId = TableEncryptionService.Convert(this.DirectPayOneStoreShopCashId, key);
    _o.ProbabilityUrlDev = TableEncryptionService.Convert(this.ProbabilityUrlDev, key);
    _o.ProbabilityUrlLive = TableEncryptionService.Convert(this.ProbabilityUrlLive, key);
  }
  public static Offset<Plana.FlatData.ShopRecruitExcel> Pack(FlatBufferBuilder builder, ShopRecruitExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ShopRecruitExcel>);
    ...
    var _ProbabilityUrlDev = _o.ProbabilityUrlDev == null ? default(StringOffset) : builder.CreateString(_o.ProbabilityUrlDev);
    var _ProbabilityUrlLive = _o.ProbabilityUrlLive == null ? default(StringOffset) : builder.CreateString(_o.ProbabilityUrlLive);
    return CreateShopRecruitExcel(
      ...
      _o.DirectPayOneStoreShopCashId,
      _ProbabilityUrlDev,
      _ProbabilityUrlLive);
  }
}
...
public class ShopRecruitExcelT
{
  ...
  public Plana.FlatData.GachaDisplayTag DisplayTag { get; set; }
  ...
  public Plana.FlatData.PurchaseCountResetType PurchaseCountResetType_ { get; set; }
  ...
  public ShopRecruitExcelT() {
    ...
    this.DisplayTag = Plana.FlatData.GachaDisplayTag.None;
    this.DisplayOrder = 0;
    ...
    this.PurchaseCountResetType_ = Plana.FlatData.PurchaseCountResetType.None;
    this.IsNewbie = false;
...
static public class ShopRecruitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*DisplayTag*/, 4 /*Plana.FlatData.GachaDisplayTag*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*PurchaseCountResetType_*/, 4 /*Plana.FlatData.PurchaseCountResetType*/, 4, false)
