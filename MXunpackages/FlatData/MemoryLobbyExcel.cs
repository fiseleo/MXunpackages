...
public struct MemoryLobbyExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.MemoryLobbyCategory MemoryLobbyCategory { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.MemoryLobbyCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MemoryLobbyCategory.None; } }
  ...
  public static Offset<Plana.FlatData.MemoryLobbyExcel> CreateMemoryLobbyExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.MemoryLobbyCategory MemoryLobbyCategory = Plana.FlatData.MemoryLobbyCategory.None,
  ...
  public static void AddMemoryLobbyCategory(FlatBufferBuilder builder, Plana.FlatData.MemoryLobbyCategory memoryLobbyCategory) { builder.AddInt(5, (int)memoryLobbyCategory, 0); }
...
public class MemoryLobbyExcelT
{
  ...
  public Plana.FlatData.MemoryLobbyCategory MemoryLobbyCategory { get; set; }
  ...
  public MemoryLobbyExcelT() {
    ...
    this.MemoryLobbyCategory = Plana.FlatData.MemoryLobbyCategory.None;
...
static public class MemoryLobbyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*MemoryLobbyCategory*/, 4 /*Plana.FlatData.MemoryLobbyCategory*/, 4, false)
