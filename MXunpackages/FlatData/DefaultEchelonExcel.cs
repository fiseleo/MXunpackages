...
public struct DefaultEchelonExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.DefaultEchelonExcel> CreateDefaultEchelonExcel(FlatBufferBuilder builder,
      int EchlonId = 0,
      long LeaderId = 0,
  ...
  public static Offset<Plana.FlatData.DefaultEchelonExcel> EndDefaultEchelonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.DefaultEchelonExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.DefaultEchelonExcel> Pack(FlatBufferBuilder builder, DefaultEchelonExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.DefaultEchelonExcel>);
