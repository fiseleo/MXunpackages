...
public struct EmblemExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EmblemCategory Category { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.EmblemCategory)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmblemCategory.None; } }
  ...
  public Plana.FlatData.EmblemDisplayType DisplayType { get { int o = __p.__offset(32); return o != 0 ? (Plana.FlatData.EmblemDisplayType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmblemDisplayType.Always; } }
  ...
  public Plana.FlatData.EmblemCheckPassType CheckPassType { get { int o = __p.__offset(40); return o != 0 ? (Plana.FlatData.EmblemCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmblemCheckPassType.None; } }
  ...
  public static Offset<Plana.FlatData.EmblemExcel> CreateEmblemExcel(FlatBufferBuilder builder,
      long Id = 0,
      Plana.FlatData.EmblemCategory Category = Plana.FlatData.EmblemCategory.None,
      ...
      Plana.FlatData.EmblemDisplayType DisplayType = Plana.FlatData.EmblemDisplayType.Always,
      ...
      Plana.FlatData.EmblemCheckPassType CheckPassType = Plana.FlatData.EmblemCheckPassType.None,
  ...
  public static void AddCategory(FlatBufferBuilder builder, Plana.FlatData.EmblemCategory category) { builder.AddInt(1, (int)category, 0); }
  ...
  public static void AddDisplayType(FlatBufferBuilder builder, Plana.FlatData.EmblemDisplayType displayType) { builder.AddInt(14, (int)displayType, 0); }
  ...
  public static void AddCheckPassType(FlatBufferBuilder builder, Plana.FlatData.EmblemCheckPassType checkPassType) { builder.AddInt(18, (int)checkPassType, 0); }
  ...
  public static Offset<Plana.FlatData.EmblemExcel> EndEmblemExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EmblemExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EmblemExcel> Pack(FlatBufferBuilder builder, EmblemExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EmblemExcel>);
...
public class EmblemExcelT
{
  ...
  public Plana.FlatData.EmblemCategory Category { get; set; }
  ...
  public EmblemExcelT() {
    ...
    this.DisplayType = Plana.FlatData.EmblemDisplayType.Always;
    this.DisplayStartDate = null;
    this.DisplayEndDate = null;
    this.DislpayFavorLevel = 0;
    this.CheckPassType = Plana.FlatData.EmblemCheckPassType.None;
...
static public class EmblemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Category*/, 4 /*Plana.FlatData.EmblemCategory*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*DisplayType*/, 4 /*Plana.FlatData.EmblemDisplayType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*CheckPassType*/, 4 /*Plana.FlatData.EmblemCheckPassType*/, 4, false)
