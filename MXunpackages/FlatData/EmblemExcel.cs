...
public struct EmblemExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EmblemDisplayType DisplayType { get { int o = __p.__offset(38); return o != 0 ? (Plana.FlatData.EmblemDisplayType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmblemDisplayType.Always; } }
  ...
  public Plana.FlatData.EmblemCheckPassType CheckPassType { get { int o = __p.__offset(46); return o != 0 ? (Plana.FlatData.EmblemCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EmblemCheckPassType.None; } }
  ...
  public static void AddDisplayType(FlatBufferBuilder builder, Plana.FlatData.EmblemDisplayType displayType) { builder.AddInt(17, (int)displayType, 0); }
  ...
  public static void AddCheckPassType(FlatBufferBuilder builder, Plana.FlatData.EmblemCheckPassType checkPassType) { builder.AddInt(21, (int)checkPassType, 0); }
  ...
  public void UnPackTo(EmblemExcelT _o) {
    ...
    _o.EmblemBGPathTh = TableEncryptionService.Convert(this.EmblemBGPathTh, key);
    _o.EmblemBGPathTw = TableEncryptionService.Convert(this.EmblemBGPathTw, key);
    _o.EmblemBGPathEn = TableEncryptionService.Convert(this.EmblemBGPathEn, key);
...
static public class EmblemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*DisplayType*/, 4 /*Plana.FlatData.EmblemDisplayType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 46 /*CheckPassType*/, 4 /*Plana.FlatData.EmblemCheckPassType*/, 4, false)
