...
public struct CharacterWeaponExpBonusExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.WeaponType WeaponType_ { get { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.WeaponType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.WeaponType.None; } }
  ...
  public static void AddWeaponType_(FlatBufferBuilder builder, Plana.FlatData.WeaponType weaponType_) { builder.AddInt(0, (int)weaponType_, 0); }
...
static public class CharacterWeaponExpBonusExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*WeaponType_*/, 4 /*Plana.FlatData.WeaponType*/, 4, false)
