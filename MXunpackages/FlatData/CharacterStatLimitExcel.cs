...
public struct CharacterStatLimitExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StatType StatType { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.StatType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StatType.None; } }
  ...
  public static Offset<Plana.FlatData.CharacterStatLimitExcel> CreateCharacterStatLimitExcel(FlatBufferBuilder builder,
      ...
      Plana.FlatData.StatType StatType = Plana.FlatData.StatType.None,
      long StatMinValue = 0,
      long StatMaxValue = 0,
  ...
  public static void AddStatType(FlatBufferBuilder builder, Plana.FlatData.StatType statType) { builder.AddInt(2, (int)statType, 0); }
...
public class CharacterStatLimitExcelT
{
  ...
  public Plana.FlatData.StatType StatType { get; set; }
  ...
  public CharacterStatLimitExcelT() {
    ...
    this.StatType = Plana.FlatData.StatType.None;
    this.StatMinValue = 0;
    this.StatMaxValue = 0;
...
static public class CharacterStatLimitExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*StatType*/, 4 /*Plana.FlatData.StatType*/, 4, false)
