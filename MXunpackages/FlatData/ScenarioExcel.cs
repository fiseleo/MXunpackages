...
public struct ScenarioExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ScenarioBGType None_(int j) { int o = __p.__offset(4); return o != 0 ? (Plana.FlatData.ScenarioBGType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ScenarioBGType)0; }
  public int None_Length { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ScenarioBGType> GetNone_Bytes() { return __p.__vector_as_span<Plana.FlatData.ScenarioBGType>(4, 4); }
#else
  public ArraySegment<byte>? GetNone_Bytes() { return __p.__vector_as_arraysegment(4); }
#endif
  public Plana.FlatData.ScenarioBGType[] GetNone_Array() { int o = __p.__offset(4); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ScenarioBGType[] a = new Plana.FlatData.ScenarioBGType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ScenarioBGType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.ScenarioExcel> CreateScenarioExcel(FlatBufferBuilder builder,
      VectorOffset None_Offset = default(VectorOffset),
    ...
    ScenarioExcel.AddNone_(builder, None_Offset);
  ...
  public static void AddNone_(FlatBufferBuilder builder, VectorOffset none_Offset) { builder.AddOffset(0, none_Offset.Value, 0); }
  public static VectorOffset CreateNone_Vector(FlatBufferBuilder builder, Plana.FlatData.ScenarioBGType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateNone_VectorBlock(FlatBufferBuilder builder, Plana.FlatData.ScenarioBGType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNone_VectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ScenarioBGType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNone_VectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ScenarioBGType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartNone_Vector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  ...
  public void UnPackTo(ScenarioExcelT _o) {
    ...
    _o.None_ = new List<Plana.FlatData.ScenarioBGType>();
    for (var _j = 0; _j < this.None_Length; ++_j) {_o.None_.Add(TableEncryptionService.Convert(this.None_(_j), key));}
  ...
  public static Offset<Plana.FlatData.ScenarioExcel> Pack(FlatBufferBuilder builder, ScenarioExcelT _o) {
    ...
    var _None_ = default(VectorOffset);
    if (_o.None_ != null) {
      var __None_ = _o.None_.ToArray();
      _None_ = CreateNone_Vector(builder, __None_);
    }
...
{
  public List<Plana.FlatData.ScenarioBGType> None_ { get; set; }
...
static public class ScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyVectorOfData(tablePos, 4 /*None_*/, 4 /*Plana.FlatData.ScenarioBGType*/, false)
