...
public struct CharacterVoiceExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CVCollectionType CVCollectionType_ { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CVCollectionType.CVNormal; } }
  ...
  public Plana.FlatData.Nation Nation_(int j) { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Nation)0; }
  public int Nation_Length { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Nation> GetNation_Bytes() { return __p.__vector_as_span<Plana.FlatData.Nation>(24, 4); }
#else
  public ArraySegment<byte>? GetNation_Bytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public Plana.FlatData.Nation[] GetNation_Array() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Nation[] a = new Plana.FlatData.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Nation)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.CharacterVoiceExcel> CreateCharacterVoiceExcel(FlatBufferBuilder builder,
  ...
  public static void AddCVCollectionType_(FlatBufferBuilder builder, Plana.FlatData.CVCollectionType cVCollectionType_) { builder.AddInt(7, (int)cVCollectionType_, 0); }
  ...
  public static Offset<Plana.FlatData.CharacterVoiceExcel> EndCharacterVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterVoiceExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterVoiceExcel> Pack(FlatBufferBuilder builder, CharacterVoiceExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterVoiceExcel>);
...
static public class CharacterVoiceExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 18 /*CVCollectionType_*/, 4 /*Plana.FlatData.CVCollectionType*/, 4, false)
      && verifier.VerifyField(tablePos, 20 /*UnlockFavorRank*/, 8 /*long*/, 8, false)
      && verifier.VerifyString(tablePos, 22 /*LocalizeCVGroup*/, false)
      && verifier.VerifyVectorOfData(tablePos, 24 /*Nation_*/, 4 /*Plana.FlatData.Nation*/, false)
