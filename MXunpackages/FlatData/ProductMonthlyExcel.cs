...
public struct ProductMonthlyExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ProductTagType ProductTagType_ { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ProductTagType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ProductTagType.Monthly; } }
  ...
  public Plana.FlatData.ParcelType ParcelType_(int j) { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int ParcelType_Length { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetParcelType_Bytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(22, 4); }
#else
  public ArraySegment<byte>? GetParcelType_Bytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Plana.FlatData.ParcelType[] GetParcelType_Array() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public Plana.FlatData.ParcelType DailyParcelType(int j) { int o = __p.__offset(30); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.ParcelType)0; }
  public int DailyParcelTypeLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.ParcelType> GetDailyParcelTypeBytes() { return __p.__vector_as_span<Plana.FlatData.ParcelType>(30, 4); }
#else
  public ArraySegment<byte>? GetDailyParcelTypeBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public Plana.FlatData.ParcelType[] GetDailyParcelTypeArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.ParcelType[] a = new Plana.FlatData.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.ProductMonthlyExcel> CreateProductMonthlyExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      Plana.FlatData.ProductTagType ProductTagType_ = Plana.FlatData.ProductTagType.Monthly,
      long MonthlyDays = 0,
    ...
    ProductMonthlyExcel.AddProductTagType_(builder, ProductTagType_);
    ProductMonthlyExcel.AddPriceReference(builder, PriceReferenceOffset);
    ProductMonthlyExcel.AddStoreType_(builder, StoreType_);
  ...
  public static void AddProductTagType_(FlatBufferBuilder builder, Plana.FlatData.ProductTagType productTagType_) { builder.AddInt(6, (int)productTagType_, 0); }
  ...
  public static VectorOffset CreateDailyParcelTypeVector(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateDailyParcelTypeVectorBlock(FlatBufferBuilder builder, Plana.FlatData.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDailyParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDailyParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.ProductMonthlyExcel> EndProductMonthlyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ProductMonthlyExcel>(o);
  }
  ...
  public void UnPackTo(ProductMonthlyExcelT _o) {
    ...
    _o.ProductTagType_ = TableEncryptionService.Convert(this.ProductTagType_, key);
    ...
    _o.DailyParcelType = new List<Plana.FlatData.ParcelType>();
  ...
  public static Offset<Plana.FlatData.ProductMonthlyExcel> Pack(FlatBufferBuilder builder, ProductMonthlyExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ProductMonthlyExcel>);
...
public class ProductMonthlyExcelT
{
  ...
  public Plana.FlatData.ProductTagType ProductTagType_ { get; set; }
  ...
  public List<Plana.FlatData.ParcelType> DailyParcelType { get; set; }
  ...
  public ProductMonthlyExcelT() {
    ...
    this.ProductTagType_ = Plana.FlatData.ProductTagType.Monthly;
    this.MonthlyDays = 0;
...
static public class ProductMonthlyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*ProductTagType_*/, 4 /*Plana.FlatData.ProductTagType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*ParcelType_*/, 4 /*Plana.FlatData.ParcelType*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 30 /*DailyParcelType*/, 4 /*Plana.FlatData.ParcelType*/, false)
