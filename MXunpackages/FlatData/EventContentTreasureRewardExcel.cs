...
public struct EventContentTreasureRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentTreasureRewardExcel> CreateEventContentTreasureRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.EventContentTreasureRewardExcel> EndEventContentTreasureRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentTreasureRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentTreasureRewardExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentTreasureRewardExcel>);
