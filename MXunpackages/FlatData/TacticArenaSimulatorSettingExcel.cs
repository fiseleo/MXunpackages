...
public struct TacticArenaSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ArenaSimulatorServer AttackerFrom { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ArenaSimulatorServer.Preset; } }
  ...
  public Plana.FlatData.ArenaSimulatorServer DefenderFrom { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ArenaSimulatorServer.Preset; } }
  ...
  public static Offset<Plana.FlatData.TacticArenaSimulatorSettingExcel> CreateTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
      Plana.FlatData.ArenaSimulatorServer AttackerFrom = Plana.FlatData.ArenaSimulatorServer.Preset,
      ...
      Plana.FlatData.ArenaSimulatorServer DefenderFrom = Plana.FlatData.ArenaSimulatorServer.Preset,
  ...
  public static void AddAttackerFrom(FlatBufferBuilder builder, Plana.FlatData.ArenaSimulatorServer attackerFrom) { builder.AddInt(2, (int)attackerFrom, 0); }
  ...
  public static void AddDefenderFrom(FlatBufferBuilder builder, Plana.FlatData.ArenaSimulatorServer defenderFrom) { builder.AddInt(8, (int)defenderFrom, 0); }
  ...
  public static Offset<Plana.FlatData.TacticArenaSimulatorSettingExcel> EndTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.TacticArenaSimulatorSettingExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.TacticArenaSimulatorSettingExcel> Pack(FlatBufferBuilder builder, TacticArenaSimulatorSettingExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.TacticArenaSimulatorSettingExcel>);
...
public class TacticArenaSimulatorSettingExcelT
{
  ...
  public Plana.FlatData.ArenaSimulatorServer AttackerFrom { get; set; }
  ...
  public Plana.FlatData.ArenaSimulatorServer DefenderFrom { get; set; }
  ...
  public TacticArenaSimulatorSettingExcelT() {
    this.Order = 0;
    this.Repeat = 0;
    this.AttackerFrom = Plana.FlatData.ArenaSimulatorServer.Preset;
    ...
    this.DefenderFrom = Plana.FlatData.ArenaSimulatorServer.Preset;
...
static public class TacticArenaSimulatorSettingExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*AttackerFrom*/, 4 /*Plana.FlatData.ArenaSimulatorServer*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*DefenderFrom*/, 4 /*Plana.FlatData.ArenaSimulatorServer*/, 4, false)
