...
public struct ConquestUnexpectedEventExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType UnexpectedEventConditionType { get { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.ConquestUnexpectedEventExcel> CreateConquestUnexpectedEventExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      Plana.FlatData.ParcelType UnexpectedEventConditionType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddUnexpectedEventConditionType(FlatBufferBuilder builder, Plana.FlatData.ParcelType unexpectedEventConditionType) { builder.AddInt(1, (int)unexpectedEventConditionType, 0); }
  ...
  public static Offset<Plana.FlatData.ConquestUnexpectedEventExcel> EndConquestUnexpectedEventExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestUnexpectedEventExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestUnexpectedEventExcel> Pack(FlatBufferBuilder builder, ConquestUnexpectedEventExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestUnexpectedEventExcel>);
...
public class ConquestUnexpectedEventExcelT
{
  ...
  public Plana.FlatData.ParcelType UnexpectedEventConditionType { get; set; }
  ...
  public ConquestUnexpectedEventExcelT() {
    ...
    this.UnexpectedEventConditionType = Plana.FlatData.ParcelType.None;
...
static public class ConquestUnexpectedEventExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*UnexpectedEventConditionType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
