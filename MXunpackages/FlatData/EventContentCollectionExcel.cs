...
public struct EventContentCollectionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.CollectionUnlockType UnlockConditionType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.CollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.CollectionUnlockType.None; } }
  ...
  public Plana.FlatData.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MultipleConditionCheckType.And; } }
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, Plana.FlatData.CollectionUnlockType unlockConditionType) { builder.AddInt(3, (int)unlockConditionType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, Plana.FlatData.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(5, (int)multipleConditionCheckType, 0); }
...
static public class EventContentCollectionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*UnlockConditionType*/, 4 /*Plana.FlatData.CollectionUnlockType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 12 /*UnlockConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 14 /*MultipleConditionCheckType*/, 4 /*Plana.FlatData.MultipleConditionCheckType*/, 4, false)
