...
public struct EventContentCollectionExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventCollectionUnlockType UnlockConditionType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.EventCollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventCollectionUnlockType.None; } }
  ...
  public Plana.FlatData.MultipleConditionCheckType MultipleConditionCheckType_ { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.MultipleConditionCheckType.And; } }
  ...
  public static Offset<Plana.FlatData.EventContentCollectionExcel> CreateEventContentCollectionExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      long GroupId = 0,
      Plana.FlatData.EventCollectionUnlockType UnlockConditionType = Plana.FlatData.EventCollectionUnlockType.None,
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, Plana.FlatData.EventCollectionUnlockType unlockConditionType) { builder.AddInt(3, (int)unlockConditionType, 0); }
  ...
  public static void AddMultipleConditionCheckType_(FlatBufferBuilder builder, Plana.FlatData.MultipleConditionCheckType multipleConditionCheckType_) { builder.AddInt(5, (int)multipleConditionCheckType_, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentCollectionExcel> EndEventContentCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentCollectionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentCollectionExcel> Pack(FlatBufferBuilder builder, EventContentCollectionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentCollectionExcel>);
...
public class EventContentCollectionExcelT
{
  ...
  public Plana.FlatData.EventCollectionUnlockType UnlockConditionType { get; set; }
  ...
  public EventContentCollectionExcelT() {
    ...
    this.GroupId = 0;
    this.UnlockConditionType = Plana.FlatData.EventCollectionUnlockType.None;
...
static public class EventContentCollectionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*UnlockConditionType*/, 4 /*Plana.FlatData.EventCollectionUnlockType*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 12 /*UnlockConditionParameter*/, 8 /*long*/, false)
      && verifier.VerifyField(tablePos, 14 /*MultipleConditionCheckType_*/, 4 /*Plana.FlatData.MultipleConditionCheckType*/, 4, false)
