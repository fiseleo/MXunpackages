...
public struct StatLevelInterpolationExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.StatLevelInterpolationExcel> CreateStatLevelInterpolationExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<Plana.FlatData.StatLevelInterpolationExcel> EndStatLevelInterpolationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.StatLevelInterpolationExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.StatLevelInterpolationExcel> Pack(FlatBufferBuilder builder, StatLevelInterpolationExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.StatLevelInterpolationExcel>);
