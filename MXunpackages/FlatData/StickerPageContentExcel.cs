...
public struct StickerPageContentExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StickerGetConditionType StickerGetConditionType_ { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.StickerGetConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StickerGetConditionType.None; } }
  public Plana.FlatData.StickerCheckPassType StickerCheckPassType_ { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.StickerCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StickerCheckPassType.None; } }
  public Plana.FlatData.GetStickerConditionType GetStickerConditionType_ { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.GetStickerConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.GetStickerConditionType.None; } }
  ...
  public Plana.FlatData.Tag StickerGetConditionParameterTag(int j) { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int StickerGetConditionParameterTagLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Plana.FlatData.Tag[] GetStickerGetConditionParameterTagArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.StickerPageContentExcel> CreateStickerPageContentExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StickerGroupId = 0,
      long StickerPageId = 0,
      long StickerSlot = 0,
      Plana.FlatData.StickerGetConditionType StickerGetConditionType_ = Plana.FlatData.StickerGetConditionType.None,
      Plana.FlatData.StickerCheckPassType StickerCheckPassType_ = Plana.FlatData.StickerCheckPassType.None,
      Plana.FlatData.GetStickerConditionType GetStickerConditionType_ = Plana.FlatData.GetStickerConditionType.None,
    ...
    StickerPageContentExcel.AddGetStickerConditionType_(builder, GetStickerConditionType_);
    StickerPageContentExcel.AddStickerCheckPassType_(builder, StickerCheckPassType_);
    StickerPageContentExcel.AddStickerGetConditionType_(builder, StickerGetConditionType_);
  ...
  public static void AddStickerGetConditionType_(FlatBufferBuilder builder, Plana.FlatData.StickerGetConditionType stickerGetConditionType_) { builder.AddInt(4, (int)stickerGetConditionType_, 0); }
  public static void AddStickerCheckPassType_(FlatBufferBuilder builder, Plana.FlatData.StickerCheckPassType stickerCheckPassType_) { builder.AddInt(5, (int)stickerCheckPassType_, 0); }
  public static void AddGetStickerConditionType_(FlatBufferBuilder builder, Plana.FlatData.GetStickerConditionType getStickerConditionType_) { builder.AddInt(6, (int)getStickerConditionType_, 0); }
  ...
  public static VectorOffset CreateStickerGetConditionParameterTagVector(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Plana.FlatData.StickerPageContentExcel> EndStickerPageContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.StickerPageContentExcel>(o);
  }
  ...
  public void UnPackTo(StickerPageContentExcelT _o) {
    ...
    _o.StickerGetConditionType_ = TableEncryptionService.Convert(this.StickerGetConditionType_, key);
    _o.StickerCheckPassType_ = TableEncryptionService.Convert(this.StickerCheckPassType_, key);
    _o.GetStickerConditionType_ = TableEncryptionService.Convert(this.GetStickerConditionType_, key);
    ...
    _o.StickerGetConditionParameterTag = new List<Plana.FlatData.Tag>();
  ...
  public static Offset<Plana.FlatData.StickerPageContentExcel> Pack(FlatBufferBuilder builder, StickerPageContentExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.StickerPageContentExcel>);
    ...
    return CreateStickerPageContentExcel(
      ...
      _o.StickerPageId,
      _o.StickerSlot,
      _o.StickerGetConditionType_,
      _o.StickerCheckPassType_,
      _o.GetStickerConditionType_,
...
public class StickerPageContentExcelT
{
  ...
  public Plana.FlatData.StickerGetConditionType StickerGetConditionType_ { get; set; }
  public Plana.FlatData.StickerCheckPassType StickerCheckPassType_ { get; set; }
  public Plana.FlatData.GetStickerConditionType GetStickerConditionType_ { get; set; }
  public long StickerGetConditionCount { get; set; }
  public List<long> StickerGetConditionParameter { get; set; }
  public List<Plana.FlatData.Tag> StickerGetConditionParameterTag { get; set; }
  ...
  public StickerPageContentExcelT() {
    ...
    this.StickerSlot = 0;
    this.StickerGetConditionType_ = Plana.FlatData.StickerGetConditionType.None;
    this.StickerCheckPassType_ = Plana.FlatData.StickerCheckPassType.None;
    this.GetStickerConditionType_ = Plana.FlatData.GetStickerConditionType.None;
...
static public class StickerPageContentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StickerGetConditionType_*/, 4 /*Plana.FlatData.StickerGetConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*StickerCheckPassType_*/, 4 /*Plana.FlatData.StickerCheckPassType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*GetStickerConditionType_*/, 4 /*Plana.FlatData.GetStickerConditionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*StickerGetConditionParameterTag*/, 4 /*Plana.FlatData.Tag*/, false)
