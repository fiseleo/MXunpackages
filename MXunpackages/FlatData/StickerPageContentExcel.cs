...
public struct StickerPageContentExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StickerGetConditionType StickerGetConditionType { get { int o = __p.__offset(12); return o != 0 ? (Plana.FlatData.StickerGetConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StickerGetConditionType.None; } }
  public Plana.FlatData.StickerCheckPassType StickerCheckPassType { get { int o = __p.__offset(14); return o != 0 ? (Plana.FlatData.StickerCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StickerCheckPassType.None; } }
  public Plana.FlatData.GetStickerConditionType GetStickerConditionType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.GetStickerConditionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.GetStickerConditionType.None; } }
  ...
  public static Offset<Plana.FlatData.StickerPageContentExcel> CreateStickerPageContentExcel(FlatBufferBuilder builder,
      ...
      long StickerSlot = 0,
      Plana.FlatData.StickerGetConditionType StickerGetConditionType = Plana.FlatData.StickerGetConditionType.None,
      Plana.FlatData.StickerCheckPassType StickerCheckPassType = Plana.FlatData.StickerCheckPassType.None,
      Plana.FlatData.GetStickerConditionType GetStickerConditionType = Plana.FlatData.GetStickerConditionType.None,
  ...
  public static void AddStickerGetConditionType(FlatBufferBuilder builder, Plana.FlatData.StickerGetConditionType stickerGetConditionType) { builder.AddInt(4, (int)stickerGetConditionType, 0); }
  public static void AddStickerCheckPassType(FlatBufferBuilder builder, Plana.FlatData.StickerCheckPassType stickerCheckPassType) { builder.AddInt(5, (int)stickerCheckPassType, 0); }
  public static void AddGetStickerConditionType(FlatBufferBuilder builder, Plana.FlatData.GetStickerConditionType getStickerConditionType) { builder.AddInt(6, (int)getStickerConditionType, 0); }
...
public class StickerPageContentExcelT
{
  ...
  public Plana.FlatData.StickerGetConditionType StickerGetConditionType { get; set; }
  public Plana.FlatData.StickerCheckPassType StickerCheckPassType { get; set; }
  public Plana.FlatData.GetStickerConditionType GetStickerConditionType { get; set; }
  ...
  public StickerPageContentExcelT() {
    ...
    this.StickerSlot = 0;
    this.StickerGetConditionType = Plana.FlatData.StickerGetConditionType.None;
    this.StickerCheckPassType = Plana.FlatData.StickerCheckPassType.None;
    this.GetStickerConditionType = Plana.FlatData.GetStickerConditionType.None;
...
static public class StickerPageContentExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*StickerGetConditionType*/, 4 /*Plana.FlatData.StickerGetConditionType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*StickerCheckPassType*/, 4 /*Plana.FlatData.StickerCheckPassType*/, 4, false)
      && verifier.VerifyField(tablePos, 16 /*GetStickerConditionType*/, 4 /*Plana.FlatData.GetStickerConditionType*/, 4, false)
