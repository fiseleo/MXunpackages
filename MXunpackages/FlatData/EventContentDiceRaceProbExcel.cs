...
public struct EventContentDiceRaceProbExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceProbExcel> CreateEventContentDiceRaceProbExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceProbExcel> EndEventContentDiceRaceProbExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentDiceRaceProbExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceProbExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceProbExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentDiceRaceProbExcel>);
