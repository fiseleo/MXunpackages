...
public struct StoryStrategyExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageTopography StageTopography { get { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  public Plana.FlatData.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(24); return o != 0 ? (Plana.FlatData.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StrategyEnvironment.None; } }
  public Plana.FlatData.ContentType ContentType { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ContentType.None; } }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography) { builder.AddInt(9, (int)stageTopography, 0); }
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, Plana.FlatData.StrategyEnvironment strategyEnvironment) { builder.AddInt(10, (int)strategyEnvironment, 0); }
  public static void AddContentType(FlatBufferBuilder builder, Plana.FlatData.ContentType contentType) { builder.AddInt(11, (int)contentType, 0); }
...
static public class StoryStrategyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*StageTopography*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*StrategyEnvironment*/, 4 /*Plana.FlatData.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*ContentType*/, 4 /*Plana.FlatData.ContentType*/, 4, false)
