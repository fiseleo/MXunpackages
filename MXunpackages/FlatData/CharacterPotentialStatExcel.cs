...
public struct CharacterPotentialStatExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.CharacterPotentialStatExcel> CreateCharacterPotentialStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.CharacterPotentialStatExcel> EndCharacterPotentialStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.CharacterPotentialStatExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.CharacterPotentialStatExcel> Pack(FlatBufferBuilder builder, CharacterPotentialStatExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.CharacterPotentialStatExcel>);
