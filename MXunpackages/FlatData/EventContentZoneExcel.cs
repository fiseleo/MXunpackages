...
public struct EventContentZoneExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Tag Tags(int j) { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(20, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public Plana.FlatData.Tag[] GetTagsArray() { int o = __p.__offset(20); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  public Plana.FlatData.Tag WhiteListTags(int j) { int o = __p.__offset(22); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Tag)0; }
  public int WhiteListTagsLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Tag> GetWhiteListTagsBytes() { return __p.__vector_as_span<Plana.FlatData.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetWhiteListTagsBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public Plana.FlatData.Tag[] GetWhiteListTagsArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Tag[] a = new Plana.FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<Plana.FlatData.EventContentZoneExcel> CreateEventContentZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateWhiteListTagsVector(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, Plana.FlatData.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, ArraySegment<Plana.FlatData.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWhiteListTagsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Plana.FlatData.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartWhiteListTagsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Plana.FlatData.EventContentZoneExcel> EndEventContentZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentZoneExcel>(o);
  }
  ...
  public void UnPackTo(EventContentZoneExcelT _o) {
    ...
    _o.WhiteListTags = new List<Plana.FlatData.Tag>();
  ...
  public static Offset<Plana.FlatData.EventContentZoneExcel> Pack(FlatBufferBuilder builder, EventContentZoneExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentZoneExcel>);
...
public class EventContentZoneExcelT
{
  ...
  public List<Plana.FlatData.Tag> WhiteListTags { get; set; }
...
static public class EventContentZoneExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 20 /*Tags*/, 4 /*Plana.FlatData.Tag*/, false)
      && verifier.VerifyVectorOfData(tablePos, 22 /*WhiteListTags*/, 4 /*Plana.FlatData.Tag*/, false)
