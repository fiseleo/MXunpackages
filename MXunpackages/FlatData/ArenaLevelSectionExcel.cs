...
public struct ArenaLevelSectionExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ArenaLevelSectionExcel> CreateArenaLevelSectionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.ArenaLevelSectionExcel> EndArenaLevelSectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ArenaLevelSectionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ArenaLevelSectionExcel> Pack(FlatBufferBuilder builder, ArenaLevelSectionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ArenaLevelSectionExcel>);
