...
public struct ContentsShortcutExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageDifficulty ConquestMapDifficulty { get { int o = __p.__offset(20); return o != 0 ? (Plana.FlatData.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageDifficulty.None; } }
  ...
  public static Offset<Plana.FlatData.ContentsShortcutExcel> CreateContentsShortcutExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      Plana.FlatData.StageDifficulty ConquestMapDifficulty = Plana.FlatData.StageDifficulty.None,
  ...
  public static void AddConquestMapDifficulty(FlatBufferBuilder builder, Plana.FlatData.StageDifficulty conquestMapDifficulty) { builder.AddInt(8, (int)conquestMapDifficulty, 0); }
  ...
  public static Offset<Plana.FlatData.ContentsShortcutExcel> EndContentsShortcutExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ContentsShortcutExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ContentsShortcutExcel> Pack(FlatBufferBuilder builder, ContentsShortcutExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ContentsShortcutExcel>);
...
public class ContentsShortcutExcelT
{
  ...
  public Plana.FlatData.StageDifficulty ConquestMapDifficulty { get; set; }
  ...
  public ContentsShortcutExcelT() {
    ...
    this.ConquestMapDifficulty = Plana.FlatData.StageDifficulty.None;
...
static public class ContentsShortcutExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ConquestMapDifficulty*/, 4 /*Plana.FlatData.StageDifficulty*/, 4, false)
