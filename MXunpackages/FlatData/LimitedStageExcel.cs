...
public struct LimitedStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageTopography StageTopography_ { get { int o = __p.__offset(48); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  ...
  public Plana.FlatData.StrategyEnvironment StrategyEnvironment_ { get { int o = __p.__offset(54); return o != 0 ? (Plana.FlatData.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StrategyEnvironment.None; } }
  public long GroundID { get { int o = __p.__offset(56); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public Plana.FlatData.ContentType ContentType_ { get { int o = __p.__offset(58); return o != 0 ? (Plana.FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ContentType.None; } }
  ...
  public static Offset<Plana.FlatData.LimitedStageExcel> CreateLimitedStageExcel(FlatBufferBuilder builder,
      long Id = 0,
    ...
    LimitedStageExcel.AddContentType_(builder, ContentType_);
    LimitedStageExcel.AddStrategyEnvironment_(builder, StrategyEnvironment_);
    LimitedStageExcel.AddBgmId(builder, BgmIdOffset);
    LimitedStageExcel.AddRecommandLevel(builder, RecommandLevel);
    LimitedStageExcel.AddStageTopography_(builder, StageTopography_);
    ...
    LimitedStageExcel.AddStageDifficulty_(builder, StageDifficulty_);
  ...
  public static void AddStageTopography_(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography_) { builder.AddInt(22, (int)stageTopography_, 0); }
  ...
  public static void AddStrategyEnvironment_(FlatBufferBuilder builder, Plana.FlatData.StrategyEnvironment strategyEnvironment_) { builder.AddInt(25, (int)strategyEnvironment_, 0); }
  public static void AddGroundID(FlatBufferBuilder builder, long groundID) { builder.AddLong(26, groundID, 0); }
  public static void AddContentType_(FlatBufferBuilder builder, Plana.FlatData.ContentType contentType_) { builder.AddInt(27, (int)contentType_, 0); }
  ...
  public static Offset<Plana.FlatData.LimitedStageExcel> EndLimitedStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.LimitedStageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.LimitedStageExcel> Pack(FlatBufferBuilder builder, LimitedStageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.LimitedStageExcel>);
...
static public class LimitedStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*StageTopography_*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 50 /*RecommandLevel*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 52 /*BgmId*/, false)
      && verifier.VerifyField(tablePos, 54 /*StrategyEnvironment_*/, 4 /*Plana.FlatData.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 56 /*GroundID*/, 8 /*long*/, 8, false)
      && verifier.VerifyField(tablePos, 58 /*ContentType_*/, 4 /*Plana.FlatData.ContentType*/, 4, false)
