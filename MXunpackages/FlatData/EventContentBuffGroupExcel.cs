...
public struct EventContentBuffGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentBuffGroupExcel> CreateEventContentBuffGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentBuffGroupExcel> EndEventContentBuffGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentBuffGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentBuffGroupExcel> Pack(FlatBufferBuilder builder, EventContentBuffGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentBuffGroupExcel>);
