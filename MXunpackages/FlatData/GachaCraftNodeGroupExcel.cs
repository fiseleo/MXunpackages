...
public struct GachaCraftNodeGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.GachaCraftNodeGroupExcel> CreateGachaCraftNodeGroupExcel(FlatBufferBuilder builder,
      long NodeId = 0,
      long GachaGroupId = 0,
      long ProbWeight = 0) {
  ...
  public static Offset<Plana.FlatData.GachaCraftNodeGroupExcel> EndGachaCraftNodeGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GachaCraftNodeGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GachaCraftNodeGroupExcel> Pack(FlatBufferBuilder builder, GachaCraftNodeGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GachaCraftNodeGroupExcel>);
