...
public struct EventContentDiceRaceExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceExcel> CreateEventContentDiceRaceExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceExcel> EndEventContentDiceRaceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentDiceRaceExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentDiceRaceExcel>);
