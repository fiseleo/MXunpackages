...
public struct ShopRefreshExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ShopCategoryType CategoryType { get { int o = __p.__offset(18); return o != 0 ? (Plana.FlatData.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ShopCategoryType.General; } }
  ...
  public Plana.FlatData.ProductDisplayTag DisplayTag { get { int o = __p.__offset(26); return o != 0 ? (Plana.FlatData.ProductDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ProductDisplayTag.None; } }
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, Plana.FlatData.ShopCategoryType categoryType) { builder.AddInt(7, (int)categoryType, 0); }
  ...
  public static void AddDisplayTag(FlatBufferBuilder builder, Plana.FlatData.ProductDisplayTag displayTag) { builder.AddInt(11, (int)displayTag, 0); }
...
static public class ShopRefreshExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 18 /*CategoryType*/, 4 /*Plana.FlatData.ShopCategoryType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 26 /*DisplayTag*/, 4 /*Plana.FlatData.ProductDisplayTag*/, 4, false)
