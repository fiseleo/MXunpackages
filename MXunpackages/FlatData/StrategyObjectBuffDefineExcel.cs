...
public struct StrategyObjectBuffDefineExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.StrategyObjectBuffDefineExcel> CreateStrategyObjectBuffDefineExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.StrategyObjectBuffDefineExcel> EndStrategyObjectBuffDefineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.StrategyObjectBuffDefineExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.StrategyObjectBuffDefineExcel> Pack(FlatBufferBuilder builder, StrategyObjectBuffDefineExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.StrategyObjectBuffDefineExcel>);
