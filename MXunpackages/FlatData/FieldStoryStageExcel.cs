...
public struct FieldStoryStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.FieldStoryStageExcel> CreateFieldStoryStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
  ...
  public static Offset<Plana.FlatData.FieldStoryStageExcel> EndFieldStoryStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.FieldStoryStageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.FieldStoryStageExcel> Pack(FlatBufferBuilder builder, FieldStoryStageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.FieldStoryStageExcel>);
