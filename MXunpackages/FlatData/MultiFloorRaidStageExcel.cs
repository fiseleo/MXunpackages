...
public struct MultiFloorRaidStageExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidStageExcel> CreateMultiFloorRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidStageExcel> EndMultiFloorRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.MultiFloorRaidStageExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.MultiFloorRaidStageExcel> Pack(FlatBufferBuilder builder, MultiFloorRaidStageExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.MultiFloorRaidStageExcel>);
