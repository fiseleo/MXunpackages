...
public struct ScenarioTransitionExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.ScenarioTransitionExcel> CreateScenarioTransitionExcel(FlatBufferBuilder builder,
      uint Name = 0,
  ...
  public static Offset<Plana.FlatData.ScenarioTransitionExcel> EndScenarioTransitionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ScenarioTransitionExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ScenarioTransitionExcel> Pack(FlatBufferBuilder builder, ScenarioTransitionExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ScenarioTransitionExcel>);
