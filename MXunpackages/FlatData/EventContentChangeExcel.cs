...
public struct EventContentChangeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ParcelType ChangeCostType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.EventContentChangeExcel> CreateEventContentChangeExcel(FlatBufferBuilder builder,
      ...
      long RewardId = 0,
      int RewardAmount = 0,
      Plana.FlatData.ParcelType ChangeCostType = Plana.FlatData.ParcelType.None,
      long ChangeCostId = 0,
  ...
  public static void AddChangeCostType(FlatBufferBuilder builder, Plana.FlatData.ParcelType changeCostType) { builder.AddInt(6, (int)changeCostType, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentChangeExcel> EndEventContentChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentChangeExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentChangeExcel> Pack(FlatBufferBuilder builder, EventContentChangeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentChangeExcel>);
...
public class EventContentChangeExcelT
{
  ...
  public Plana.FlatData.ParcelType ChangeCostType { get; set; }
  ...
  public EventContentChangeExcelT() {
    ...
    this.RewardId = 0;
    this.RewardAmount = 0;
    this.ChangeCostType = Plana.FlatData.ParcelType.None;
    this.ChangeCostId = 0;
...
static public class EventContentChangeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*ChangeCostType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
