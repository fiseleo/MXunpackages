...
public struct EventContentBuffExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Tag CharacterTag { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.Tag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.Tag.A; } }
  public Plana.FlatData.EventContentBuffFindRule EnumType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.EventContentBuffFindRule)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentBuffFindRule.None; } }
  ...
  public static Offset<Plana.FlatData.EventContentBuffExcel> CreateEventContentBuffExcel(FlatBufferBuilder builder,
      long EventContentBuffId = 0,
      bool IsBuff = false,
      Plana.FlatData.Tag CharacterTag = Plana.FlatData.Tag.A,
      Plana.FlatData.EventContentBuffFindRule EnumType = Plana.FlatData.EventContentBuffFindRule.None,
  ...
  public static void AddCharacterTag(FlatBufferBuilder builder, Plana.FlatData.Tag characterTag) { builder.AddInt(2, (int)characterTag, 0); }
  public static void AddEnumType(FlatBufferBuilder builder, Plana.FlatData.EventContentBuffFindRule enumType) { builder.AddInt(3, (int)enumType, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentBuffExcel> EndEventContentBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentBuffExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentBuffExcel> Pack(FlatBufferBuilder builder, EventContentBuffExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentBuffExcel>);
...
public class EventContentBuffExcelT
{
  ...
  public Plana.FlatData.Tag CharacterTag { get; set; }
  public Plana.FlatData.EventContentBuffFindRule EnumType { get; set; }
  ...
  public EventContentBuffExcelT() {
    ...
    this.IsBuff = false;
    this.CharacterTag = Plana.FlatData.Tag.A;
    this.EnumType = Plana.FlatData.EventContentBuffFindRule.None;
...
static public class EventContentBuffExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CharacterTag*/, 4 /*Plana.FlatData.Tag*/, 4, false)
      && verifier.VerifyField(tablePos, 10 /*EnumType*/, 4 /*Plana.FlatData.EventContentBuffFindRule*/, 4, false)
