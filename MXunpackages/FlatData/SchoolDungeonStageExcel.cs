...
public struct SchoolDungeonStageExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.StageTopography StageTopography { get { int o = __p.__offset(28); return o != 0 ? (Plana.FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.StageTopography.Street; } }
  ...
  public Plana.FlatData.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(36); return o != 0 ? (Plana.FlatData.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EchelonExtensionType.Base; } }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, Plana.FlatData.StageTopography stageTopography) { builder.AddInt(12, (int)stageTopography, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, Plana.FlatData.EchelonExtensionType echelonExtensionType) { builder.AddInt(16, (int)echelonExtensionType, 0); }
  ...
  public void UnPackTo(SchoolDungeonStageExcelT _o) {
    ...
    _o.DungeonType = this.DungeonType;
    ...
    for (var _j = 0; _j < this.StageEnterCostMinimumAmountLength; ++_j) {_o.StageEnterCostMinimumAmount.Add(this.StageEnterCostMinimumAmount(_j));}
...
static public class SchoolDungeonStageExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*StageTopography*/, 4 /*Plana.FlatData.StageTopography*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*EchelonExtensionType*/, 4 /*Plana.FlatData.EchelonExtensionType*/, 4, false)
