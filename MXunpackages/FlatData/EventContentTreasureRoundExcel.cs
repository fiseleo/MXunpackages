...
public struct EventContentTreasureRoundExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentTreasureRoundExcel> CreateEventContentTreasureRoundExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentTreasureRoundExcel> EndEventContentTreasureRoundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentTreasureRoundExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentTreasureRoundExcel> Pack(FlatBufferBuilder builder, EventContentTreasureRoundExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentTreasureRoundExcel>);
