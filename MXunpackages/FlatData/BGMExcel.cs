...
public struct BGMExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.BGMExcel> CreateBGMExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.BGMExcel> EndBGMExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.BGMExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.BGMExcel> Pack(FlatBufferBuilder builder, BGMExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.BGMExcel>);
