...
public struct VideoExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.Nation Nation_(int j) { int o = __p.__offset(6); return o != 0 ? (Plana.FlatData.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (Plana.FlatData.Nation)0; }
  public int Nation_Length { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<Plana.FlatData.Nation> GetNation_Bytes() { return __p.__vector_as_span<Plana.FlatData.Nation>(6, 4); }
#else
  public ArraySegment<byte>? GetNation_Bytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public Plana.FlatData.Nation[] GetNation_Array() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Plana.FlatData.Nation[] a = new Plana.FlatData.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (Plana.FlatData.Nation)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<Plana.FlatData.VideoExcel> CreateVideoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<Plana.FlatData.VideoExcel> EndVideoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.VideoExcel>(o);
  }
  ...
  public void UnPackTo(VideoExcelT _o) {
    ...
    for (var _j = 0; _j < this.VideoTeenPathLength; ++_j) {_o.VideoTeenPath.Add(TableEncryptionService.Convert(this.VideoTeenPath(_j), key));}
  ...
  public static Offset<Plana.FlatData.VideoExcel> Pack(FlatBufferBuilder builder, VideoExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.VideoExcel>);
    ...
    if (_o.VideoTeenPath != null) {
      ...
      for (var _j = 0; _j < __VideoTeenPath.Length; ++_j) { __VideoTeenPath[_j] = builder.CreateString(_o.VideoTeenPath[_j]); }
...
static public class VideoExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*Nation_*/, 4 /*Plana.FlatData.Nation*/, false)
