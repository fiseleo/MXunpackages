...
public struct EventContentBoxGachaShopExcel : IFlatbufferObject
{
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaShopExcel> CreateEventContentBoxGachaShopExcel(FlatBufferBuilder builder,
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaShopExcel> EndEventContentBoxGachaShopExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentBoxGachaShopExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentBoxGachaShopExcel> Pack(FlatBufferBuilder builder, EventContentBoxGachaShopExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentBoxGachaShopExcel>);
