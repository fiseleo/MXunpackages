...
public struct SchoolDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RewardTag RewardTag { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RewardTag.Default; } }
  ...
  public static Offset<Plana.FlatData.SchoolDungeonRewardExcel> CreateSchoolDungeonRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      Plana.FlatData.SchoolDungeonType DungeonType = Plana.FlatData.SchoolDungeonType.SchoolA,
      Plana.FlatData.RewardTag RewardTag = Plana.FlatData.RewardTag.Default,
  ...
  public static void AddRewardTag(FlatBufferBuilder builder, Plana.FlatData.RewardTag rewardTag) { builder.AddInt(2, (int)rewardTag, 0); }
  ...
  public static Offset<Plana.FlatData.SchoolDungeonRewardExcel> EndSchoolDungeonRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.SchoolDungeonRewardExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.SchoolDungeonRewardExcel> Pack(FlatBufferBuilder builder, SchoolDungeonRewardExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.SchoolDungeonRewardExcel>);
		byte[] key = { 0 };
...
public class SchoolDungeonRewardExcelT
{
  ...
  public Plana.FlatData.RewardTag RewardTag { get; set; }
  ...
  public SchoolDungeonRewardExcelT() {
    ...
    this.RewardTag = Plana.FlatData.RewardTag.Default;
...
static public class SchoolDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*RewardTag*/, 4 /*Plana.FlatData.RewardTag*/, 4, false)
