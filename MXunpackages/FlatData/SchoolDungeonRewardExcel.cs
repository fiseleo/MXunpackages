...
public struct SchoolDungeonRewardExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.RewardTag RewardTag_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.RewardTag.Default; } }
  ...
  public static Offset<Plana.FlatData.SchoolDungeonRewardExcel> CreateSchoolDungeonRewardExcel(FlatBufferBuilder builder,
    ...
    SchoolDungeonRewardExcel.AddRewardTag_(builder, RewardTag_);
  ...
  public static void AddRewardTag_(FlatBufferBuilder builder, Plana.FlatData.RewardTag rewardTag_) { builder.AddInt(2, (int)rewardTag_, 0); }
...
static public class SchoolDungeonRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*RewardTag_*/, 4 /*Plana.FlatData.RewardTag*/, 4, false)
