...
public struct ConquestObjectExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.ConquestObjectType ConquestObjectType_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.ConquestObjectType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ConquestObjectType.None; } }
  ...
  public Plana.FlatData.ParcelType ConquestRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (Plana.FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.ParcelType.None; } }
  ...
  public static Offset<Plana.FlatData.ConquestObjectExcel> CreateConquestObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      Plana.FlatData.ConquestObjectType ConquestObjectType_ = Plana.FlatData.ConquestObjectType.None,
      uint Key = 0,
      StringOffset NameOffset = default(StringOffset),
      StringOffset PrefabNameOffset = default(StringOffset),
      Plana.FlatData.ParcelType ConquestRewardParcelType = Plana.FlatData.ParcelType.None,
  ...
  public static void AddConquestObjectType_(FlatBufferBuilder builder, Plana.FlatData.ConquestObjectType conquestObjectType_) { builder.AddInt(2, (int)conquestObjectType_, 0); }
  ...
  public static void AddConquestRewardParcelType(FlatBufferBuilder builder, Plana.FlatData.ParcelType conquestRewardParcelType) { builder.AddInt(6, (int)conquestRewardParcelType, 0); }
  ...
  public static Offset<Plana.FlatData.ConquestObjectExcel> EndConquestObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.ConquestObjectExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.ConquestObjectExcel> Pack(FlatBufferBuilder builder, ConquestObjectExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.ConquestObjectExcel>);
...
public class ConquestObjectExcelT
{
  ...
  public Plana.FlatData.ConquestObjectType ConquestObjectType_ { get; set; }
  public uint Key { get; set; }
  public string Name { get; set; }
  public string PrefabName { get; set; }
  public Plana.FlatData.ParcelType ConquestRewardParcelType { get; set; }
  ...
  public ConquestObjectExcelT() {
    ...
    this.ConquestObjectType_ = Plana.FlatData.ConquestObjectType.None;
    this.Key = 0;
    this.Name = null;
    this.PrefabName = null;
    this.ConquestRewardParcelType = Plana.FlatData.ParcelType.None;
...
static public class ConquestObjectExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ConquestObjectType_*/, 4 /*Plana.FlatData.ConquestObjectType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 16 /*ConquestRewardParcelType*/, 4 /*Plana.FlatData.ParcelType*/, 4, false)
