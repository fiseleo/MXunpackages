...
public struct EventContentDiceRaceNodeExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.EventContentDiceRaceNodeType EventContentDiceRaceNodeType_ { get { int o = __p.__offset(8); return o != 0 ? (Plana.FlatData.EventContentDiceRaceNodeType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.EventContentDiceRaceNodeType.StartNode; } }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceNodeExcel> CreateEventContentDiceRaceNodeExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long NodeId = 0,
      Plana.FlatData.EventContentDiceRaceNodeType EventContentDiceRaceNodeType_ = Plana.FlatData.EventContentDiceRaceNodeType.StartNode,
  ...
  public static void AddEventContentDiceRaceNodeType_(FlatBufferBuilder builder, Plana.FlatData.EventContentDiceRaceNodeType eventContentDiceRaceNodeType_) { builder.AddInt(2, (int)eventContentDiceRaceNodeType_, 0); }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceNodeExcel> EndEventContentDiceRaceNodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.EventContentDiceRaceNodeExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.EventContentDiceRaceNodeExcel> Pack(FlatBufferBuilder builder, EventContentDiceRaceNodeExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.EventContentDiceRaceNodeExcel>);
...
public class EventContentDiceRaceNodeExcelT
{
  ...
  public Plana.FlatData.EventContentDiceRaceNodeType EventContentDiceRaceNodeType_ { get; set; }
  ...
  public EventContentDiceRaceNodeExcelT() {
    ...
    this.NodeId = 0;
    this.EventContentDiceRaceNodeType_ = Plana.FlatData.EventContentDiceRaceNodeType.StartNode;
...
static public class EventContentDiceRaceNodeExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*EventContentDiceRaceNodeType_*/, 4 /*Plana.FlatData.EventContentDiceRaceNodeType*/, 4, false)
