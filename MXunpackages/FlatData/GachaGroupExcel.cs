...
public struct GachaGroupExcel : IFlatbufferObject
{
  ...
  public Plana.FlatData.GachaGroupType GroupType { get { int o = __p.__offset(10); return o != 0 ? (Plana.FlatData.GachaGroupType)__p.bb.GetInt(o + __p.bb_pos) : Plana.FlatData.GachaGroupType.None; } }

  public static Offset<Plana.FlatData.GachaGroupExcel> CreateGachaGroupExcel(FlatBufferBuilder builder,
      long ID = 0,
      StringOffset NameKrOffset = default(StringOffset),
      bool IsRecursive = false,
      Plana.FlatData.GachaGroupType GroupType = Plana.FlatData.GachaGroupType.None) {
  ...
  public static void AddGroupType(FlatBufferBuilder builder, Plana.FlatData.GachaGroupType groupType) { builder.AddInt(3, (int)groupType, 0); }
  public static Offset<Plana.FlatData.GachaGroupExcel> EndGachaGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Plana.FlatData.GachaGroupExcel>(o);
  }
  ...
  public static Offset<Plana.FlatData.GachaGroupExcel> Pack(FlatBufferBuilder builder, GachaGroupExcelT _o) {
    if (_o == null) return default(Offset<Plana.FlatData.GachaGroupExcel>);
...
public class GachaGroupExcelT
{
  ...
  public Plana.FlatData.GachaGroupType GroupType { get; set; }

  public GachaGroupExcelT() {
    this.ID = 0;
    this.NameKr = null;
    this.IsRecursive = false;
    this.GroupType = Plana.FlatData.GachaGroupType.None;
  }
}
...
static public class GachaGroupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*GroupType*/, 4 /*Plana.FlatData.GachaGroupType*/, 4, false)
